...
`))}return O}finally{c.Bb=null}};c._OrtCreateSession=d(c._OrtCreateSession,()=>c._OrtCreateSession,y=>c._OrtCreateSession=y),c._OrtRun=m(d(c._OrtRun,()=>c._OrtRun,y=>c._OrtRun=y)),c._OrtRunWithBinding=m(d(c._OrtRunWithBinding,()=>c._OrtRunWithBinding,y=>c._OrtRunWithBinding=y)),c._OrtBindInput=d(c._OrtBindInput,()=>c._OrtBindInput,y=>c._OrtBindInput=y),w=void 0};c.jsepInit=(d,m)=>{if(w?.(),d==="webgpu"){[c.Jb,c.Qb,c.Ub,c.Kb,c.Tb,c.gb,c.Vb,c.Xb,c.Rb,c.Sb,c.Wb]=m;let y=c.Jb;c.jsepRegisterBuffer=(x,_,O,R)=>y.registerBuffer(x,_,O,R),c.jsepGetBuffer=x=>y.getBuffer(x),c.jsepCreateDownloader=(x,_,O)=>y.createDownloader(x,_,O),c.jsepOnReleaseSession=x=>{y.onReleaseSession(x)},c.jsepOnRunStart=x=>y.onRunStart(x)}};var v,S,$=Object.assign({},c),P="./this.program",E=(d,m)=>{throw m},N="";(b||h)&&(h?N=self.location.href:typeof document<"u"&&document.currentScript&&(N=document.currentScript.src),Ds&&(N=Ds),N=N.startsWith("blob:")?"":N.substr(0,N.replace(/[?#].*/,"").lastIndexOf("/")+1),h&&(S=d=>{var m=new XMLHttpRequest;return m.open("GET",d,!1),m.responseType="arraybuffer",m.send(null),new Uint8Array(m.response)}),v=(d,m,y)=>{var x=new XMLHttpRequest;x.open("GET",d,!0),x.responseType="arraybuffer",x.onload=()=>{x.status==200||x.status==0&&x.response?m(x.response):y()},x.onerror=y,x.send(null)});var z=console.log.bind(console),q=console.error.bind(console),K=z,F=q;if(Object.assign(c,$),$=null,g){let d=function(m){try{var y=m.data,x=y.cmd;if(x==="load"){let _=[];self.onmessage=O=>_.push(O),self.startWorker=()=>{postMessage({cmd:"loaded"});for(let O of _)d(O);self.onmessage=d};for(let O of y.handlers)c[O]&&!c[O].proxy||(c[O]=(...R)=>{postMessage({Ib:"callHandler",hc:O,args:R})},O=="print"&&(K=c[O]),O=="printErr"&&(F=c[O]));ae=y.wasmMemory,Fe(),_e(y.wasmModule)}else if(x==="run"){ya(y.pthread_ptr,0,0,1,0,0),fa(y.pthread_ptr),N0(),Eu(),$e||(Al(),$e=!0);try{z0(y.start_routine,y.arg)}catch(_){if(_!="unwind")throw _}}else x==="cancel"?an()&&ho(-1):y.target!=="setimmediate"&&(x==="checkMailbox"?$e&&io():x&&(F(`worker: received unknown command ${x}`),F(y)))}catch(_){throw Pl(),_}};var UI=d,_e,$e=!1;F=function(...m){m=m.join(" "),console.error(m)},self.alert=function(...m){postMessage({Ib:"alert",text:m.join(" "),jc:an()})},c.instantiateWasm=(m,y)=>new Promise(x=>{_e=_=>{_=new WebAssembly.Instance(_,Iu()),y(_),x()}}),self.onunhandledrejection=m=>{throw m.reason||m},self.onmessage=d}var ae,qe,Q,ge,Ie,xe,se,pe,ce,ut,V,ie,Te,tt=!1;function Fe(){var d=ae.buffer;c.HEAP8=ge=new Int8Array(d),c.HEAP16=xe=new Int16Array(d),c.HEAPU8=Ie=new Uint8Array(d),c.HEAPU16=se=new Uint16Array(d),c.HEAP32=pe=new Int32Array(d),c.HEAPU32=ce=new Uint32Array(d),c.HEAPF32=ut=new Float32Array(d),c.HEAPF64=Te=new Float64Array(d),c.HEAP64=V=new BigInt64Array(d),c.HEAPU64=ie=new BigUint64Array(d)}if(!g){if(c.wasmMemory)ae=c.wasmMemory;else if(!((ae=new WebAssembly.Memory({initial:256,maximum:65536,shared:!0})).buffer instanceof T))throw F("requested a shared WebAssembly.Memory but the returned buffer is not a SharedArrayBuffer, indicating that while the browser has SharedArrayBuffer it does not have WebAssembly threads support - you may need to set a flag"),Error("bad memory");Fe()}var Ke=[],tn=[],mt=[],rt=0,Kt=null,hr=null;function no(){if(--rt==0&&(Kt!==null&&(clearInterval(Kt),Kt=null),hr)){var d=hr;hr=null,d()}}function An(d){throw F(d="Aborted("+d+")"),tt=!0,Q=1,d=new WebAssembly.RuntimeError(d+". Build with -sASSERTIONS for more info."),f(d),d}var xu,vu=d=>d.startsWith("data:application/octet-stream;base64,"),wu=d=>d.startsWith("file://");function Tu(d){if(S)return S(d);throw"both async and sync fetching of the wasm failed"}function _u(d,m,y){return function(x){if(b||h){if(typeof fetch=="function"&&!wu(x))return fetch(x,{credentials:"same-origin"}).then(_=>{if(!_.ok)throw`failed to load wasm binary file at '${x}'`;return _.arrayBuffer()}).catch(()=>Tu(x));if(v)return new Promise((_,O)=>{v(x,R=>_(new Uint8Array(R)),O)})}return Promise.resolve().then(()=>Tu(x))}(d).then(x=>WebAssembly.instantiate(x,m)).then(y,x=>{F(`failed to asynchronously prepare wasm: ${x}`),An(x)})}function Iu(){return{a:{wa:R0,b:M0,Y:Bu,y:Nu,ma:zu,U:Mu,W:Vu,na:Gu,ka:Uu,da:Wu,ja:Hu,I:qu,V:Ku,S:ju,la:Xu,T:Zu,sa:V0,C:U0,M:W0,L:q0,B:j0,s:X0,p:Z0,D:Y0,x:ox,N:ix,ra:ax,ga:sx,Q:ux,Z:lx,E:cx,fa,pa:fx,u:dx,A:hx,o:gx,k:yx,c:la,n:xx,j:Tx,xa:_x,r:Ix,e:Sx,v:$x,m:Ax,g:Px,l:Ox,h:Ex,i:Cx,f:kx,aa:Dx,ba:Bx,ca:Lx,_:cl,$:fl,P:Rx,d:Nx,K:zx,F:Fx,J:Mx,ta:Vx,oa:Gx,R:Ux,t:pl,w:Wx,O:Hx,va:qx,ua:Kx,ha:gl,ia:bl,X:oa,z:yl,H:xl,ea:vl,G:wl,a:ae,qa:Il,q:Zx}}}var ta={1304868:(d,m,y,x)=>{if(c===void 0||!c.Cb)return 1;if((d=ot(d>>>0)).startsWith("./")&&(d=d.substring(2)),!(d=c.Cb.get(d)))return 2;if(x>>>=0,(m>>>=0)+(y>>>=0)>d.byteLength)return 3;try{return n().set(d.subarray(m,m+y),x>>>0),0}catch{return 4}},1305369:()=>{c.Rb()},1305400:()=>{c.Sb()},1305429:()=>{c.Wb()},1305454:d=>c.Qb(d),1305487:d=>c.Ub(d),1305519:(d,m,y)=>{c.Kb(d,m,y,!0)},1305558:(d,m,y)=>{c.Kb(d,m,y)},1305591:()=>typeof wasmOffsetConverter<"u",1305648:d=>{c.gb("Abs",d,void 0)},1305699:d=>{c.gb("Neg",d,void 0)},1305750:d=>{c.gb("Floor",d,void 0)},1305803:d=>{c.gb("Ceil",d,void 0)},1305855:d=>{c.gb("Reciprocal",d,void 0)},1305913:d=>{c.gb("Sqrt",d,void 0)},1305965:d=>{c.gb("Exp",d,void 0)},1306016:d=>{c.gb("Erf",d,void 0)},1306067:d=>{c.gb("Sigmoid",d,void 0)},1306122:(d,m,y)=>{c.gb("HardSigmoid",d,{alpha:m,beta:y})},1306201:d=>{c.gb("Log",d,void 0)},1306252:d=>{c.gb("Sin",d,void 0)},1306303:d=>{c.gb("Cos",d,void 0)},1306354:d=>{c.gb("Tan",d,void 0)},1306405:d=>{c.gb("Asin",d,void 0)},1306457:d=>{c.gb("Acos",d,void 0)},1306509:d=>{c.gb("Atan",d,void 0)},1306561:d=>{c.gb("Sinh",d,void 0)},1306613:d=>{c.gb("Cosh",d,void 0)},1306665:d=>{c.gb("Asinh",d,void 0)},1306718:d=>{c.gb("Acosh",d,void 0)},1306771:d=>{c.gb("Atanh",d,void 0)},1306824:d=>{c.gb("Tanh",d,void 0)},1306876:d=>{c.gb("Not",d,void 0)},1306927:(d,m,y)=>{c.gb("Clip",d,{min:m,max:y})},1306996:d=>{c.gb("Clip",d,void 0)},1307048:(d,m)=>{c.gb("Elu",d,{alpha:m})},1307106:d=>{c.gb("Relu",d,void 0)},1307158:(d,m)=>{c.gb("LeakyRelu",d,{alpha:m})},1307222:(d,m)=>{c.gb("ThresholdedRelu",d,{alpha:m})},1307292:(d,m)=>{c.gb("Cast",d,{to:m})},1307350:d=>{c.gb("Add",d,void 0)},1307401:d=>{c.gb("Sub",d,void 0)},1307452:d=>{c.gb("Mul",d,void 0)},1307503:d=>{c.gb("Div",d,void 0)},1307554:d=>{c.gb("Pow",d,void 0)},1307605:d=>{c.gb("Equal",d,void 0)},1307658:d=>{c.gb("Greater",d,void 0)},1307713:d=>{c.gb("GreaterOrEqual",d,void 0)},1307775:d=>{c.gb("Less",d,void 0)},1307827:d=>{c.gb("LessOrEqual",d,void 0)},1307886:(d,m,y,x,_)=>{c.gb("ReduceMean",d,{keepDims:!!m,noopWithEmptyAxes:!!y,axes:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},1308045:(d,m,y,x,_)=>{c.gb("ReduceMax",d,{keepDims:!!m,noopWithEmptyAxes:!!y,axes:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},1308203:(d,m,y,x,_)=>{c.gb("ReduceMin",d,{keepDims:!!m,noopWithEmptyAxes:!!y,axes:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},1308361:(d,m,y,x,_)=>{c.gb("ReduceProd",d,{keepDims:!!m,noopWithEmptyAxes:!!y,axes:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},1308520:(d,m,y,x,_)=>{c.gb("ReduceSum",d,{keepDims:!!m,noopWithEmptyAxes:!!y,axes:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},1308678:(d,m,y,x,_)=>{c.gb("ReduceL1",d,{keepDims:!!m,noopWithEmptyAxes:!!y,axes:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},1308835:(d,m,y,x,_)=>{c.gb("ReduceL2",d,{keepDims:!!m,noopWithEmptyAxes:!!y,axes:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},1308992:(d,m,y,x,_)=>{c.gb("ReduceLogSum",d,{keepDims:!!m,noopWithEmptyAxes:!!y,axes:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},1309153:(d,m,y,x,_)=>{c.gb("ReduceSumSquare",d,{keepDims:!!m,noopWithEmptyAxes:!!y,axes:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},1309317:(d,m,y,x,_)=>{c.gb("ReduceLogSumExp",d,{keepDims:!!m,noopWithEmptyAxes:!!y,axes:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},1309481:d=>{c.gb("Where",d,void 0)},1309534:(d,m,y)=>{c.gb("Transpose",d,{perm:m?Array.from(i().subarray(m>>>0,y>>>0)):[]})},1309642:(d,m,y,x)=>{c.gb("DepthToSpace",d,{blocksize:m,mode:ot(y),format:x?"NHWC":"NCHW"})},1309775:(d,m,y,x)=>{c.gb("DepthToSpace",d,{blocksize:m,mode:ot(y),format:x?"NHWC":"NCHW"})},1309908:(d,m,y,x,_,O,R,M,j,Y,ne,Ae,Ce,L,fe)=>{c.gb("ConvTranspose",d,{format:j?"NHWC":"NCHW",autoPad:m,dilations:[y],group:x,kernelShape:[_],pads:[O,R],strides:[M],wIsConst:()=>!!e()[Y>>>0],outputPadding:ne?Array.from(i().subarray(ne>>>0,Ae>>>0)):[],outputShape:Ce?Array.from(i().subarray(Ce>>>0,L>>>0)):[],activation:ot(fe)})},1310309:(d,m,y,x,_,O,R,M,j,Y,ne,Ae,Ce,L)=>{c.gb("ConvTranspose",d,{format:M?"NHWC":"NCHW",autoPad:m,dilations:Array.from(i().subarray(y>>>0,2+(y>>>0)>>>0)),group:x,kernelShape:Array.from(i().subarray(_>>>0,2+(_>>>0)>>>0)),pads:Array.from(i().subarray(O>>>0,4+(O>>>0)>>>0)),strides:Array.from(i().subarray(R>>>0,2+(R>>>0)>>>0)),wIsConst:()=>!!e()[j>>>0],outputPadding:Y?Array.from(i().subarray(Y>>>0,ne>>>0)):[],outputShape:Ae?Array.from(i().subarray(Ae>>>0,Ce>>>0)):[],activation:ot(L)})},1310874:(d,m,y,x,_,O,R,M,j,Y,ne,Ae,Ce,L,fe)=>{c.gb("ConvTranspose",d,{format:j?"NHWC":"NCHW",autoPad:m,dilations:[y],group:x,kernelShape:[_],pads:[O,R],strides:[M],wIsConst:()=>!!e()[Y>>>0],outputPadding:ne?Array.from(i().subarray(ne>>>0,Ae>>>0)):[],outputShape:Ce?Array.from(i().subarray(Ce>>>0,L>>>0)):[],activation:ot(fe)})},1311275:(d,m,y,x,_,O,R,M,j,Y,ne,Ae,Ce,L)=>{c.gb("ConvTranspose",d,{format:M?"NHWC":"NCHW",autoPad:m,dilations:Array.from(i().subarray(y>>>0,2+(y>>>0)>>>0)),group:x,kernelShape:Array.from(i().subarray(_>>>0,2+(_>>>0)>>>0)),pads:Array.from(i().subarray(O>>>0,4+(O>>>0)>>>0)),strides:Array.from(i().subarray(R>>>0,2+(R>>>0)>>>0)),wIsConst:()=>!!e()[j>>>0],outputPadding:Y?Array.from(i().subarray(Y>>>0,ne>>>0)):[],outputShape:Ae?Array.from(i().subarray(Ae>>>0,Ce>>>0)):[],activation:ot(L)})},1311840:(d,m)=>{c.gb("GlobalAveragePool",d,{format:m?"NHWC":"NCHW"})},1311931:(d,m,y,x,_,O,R,M,j,Y,ne,Ae,Ce,L,fe,Le)=>{c.gb("AveragePool",d,{format:Le?"NHWC":"NCHW",auto_pad:m,ceil_mode:y,count_include_pad:x,storage_order:_,dilations:[O,R],kernel_shape:[M,j],pads:[Y,ne,Ae,Ce],strides:[L,fe]})},1312215:(d,m)=>{c.gb("GlobalAveragePool",d,{format:m?"NHWC":"NCHW"})},1312306:(d,m,y,x,_,O,R,M,j,Y,ne,Ae,Ce,L,fe,Le)=>{c.gb("AveragePool",d,{format:Le?"NHWC":"NCHW",auto_pad:m,ceil_mode:y,count_include_pad:x,storage_order:_,dilations:[O,R],kernel_shape:[M,j],pads:[Y,ne,Ae,Ce],strides:[L,fe]})},1312590:(d,m)=>{c.gb("GlobalMaxPool",d,{format:m?"NHWC":"NCHW"})},1312677:(d,m,y,x,_,O,R,M,j,Y,ne,Ae,Ce,L,fe,Le)=>{c.gb("MaxPool",d,{format:Le?"NHWC":"NCHW",auto_pad:m,ceil_mode:y,count_include_pad:x,storage_order:_,dilations:[O,R],kernel_shape:[M,j],pads:[Y,ne,Ae,Ce],strides:[L,fe]})},1312957:(d,m)=>{c.gb("GlobalMaxPool",d,{format:m?"NHWC":"NCHW"})},1313044:(d,m,y,x,_,O,R,M,j,Y,ne,Ae,Ce,L,fe,Le)=>{c.gb("MaxPool",d,{format:Le?"NHWC":"NCHW",auto_pad:m,ceil_mode:y,count_include_pad:x,storage_order:_,dilations:[O,R],kernel_shape:[M,j],pads:[Y,ne,Ae,Ce],strides:[L,fe]})},1313324:(d,m,y,x,_)=>{c.gb("Gemm",d,{alpha:m,beta:y,transA:x,transB:_})},1313428:d=>{c.gb("MatMul",d,void 0)},1313482:(d,m,y,x)=>{c.gb("ArgMax",d,{keepDims:!!m,selectLastIndex:!!y,axis:x})},1313590:(d,m,y,x)=>{c.gb("ArgMin",d,{keepDims:!!m,selectLastIndex:!!y,axis:x})},1313698:(d,m)=>{c.gb("Softmax",d,{axis:m})},1313761:(d,m)=>{c.gb("Concat",d,{axis:m})},1313821:(d,m,y,x,_)=>{c.gb("Split",d,{axis:m,numOutputs:y,splitSizes:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},1313961:d=>{c.gb("Expand",d,void 0)},1314015:(d,m)=>{c.gb("Gather",d,{axis:Number(m)})},1314086:(d,m)=>{c.gb("GatherElements",d,{axis:Number(m)})},1314165:(d,m,y,x,_,O,R,M,j,Y,ne)=>{c.gb("Resize",d,{antialias:m,axes:y?Array.from(i().subarray(y>>>0,x>>>0)):[],coordinateTransformMode:ot(_),cubicCoeffA:O,excludeOutside:R,extrapolationValue:M,keepAspectRatioPolicy:ot(j),mode:ot(Y),nearestMode:ot(ne)})},1314511:(d,m,y,x,_,O,R)=>{c.gb("Slice",d,{starts:m?Array.from(i().subarray(m>>>0,y>>>0)):[],ends:x?Array.from(i().subarray(x>>>0,_>>>0)):[],axes:O?Array.from(i().subarray(O>>>0,R>>>0)):[]})},1314727:d=>{c.gb("Tile",d,void 0)},1314779:(d,m,y)=>{c.gb("InstanceNormalization",d,{epsilon:m,format:y?"NHWC":"NCHW"})},1314893:(d,m,y)=>{c.gb("InstanceNormalization",d,{epsilon:m,format:y?"NHWC":"NCHW"})},1315007:d=>{c.gb("Range",d,void 0)},1315060:(d,m)=>{c.gb("Einsum",d,{equation:ot(m)})},1315141:(d,m,y,x,_)=>{c.gb("Pad",d,{mode:m,value:y,pads:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},1315268:(d,m,y,x,_,O)=>{c.gb("BatchNormalization",d,{epsilon:m,momentum:y,spatial:!!_,trainingMode:!!x,format:O?"NHWC":"NCHW"})},1315437:(d,m,y,x,_,O)=>{c.gb("BatchNormalization",d,{epsilon:m,momentum:y,spatial:!!_,trainingMode:!!x,format:O?"NHWC":"NCHW"})},1315606:(d,m,y)=>{c.gb("CumSum",d,{exclusive:Number(m),reverse:Number(y)})},1315703:(d,m,y,x,_,O,R,M,j)=>{c.gb("Attention",d,{numHeads:m,isUnidirectional:y,maskFilterValue:x,scale:_,doRotary:O,qkvHiddenSizes:R?Array.from(i().subarray(Number(M)>>>0,Number(M)+R>>>0)):[],pastPresentShareBuffer:!!j})},1315975:d=>{c.gb("BiasAdd",d,void 0)},1316030:d=>{c.gb("BiasSplitGelu",d,void 0)},1316091:d=>{c.gb("FastGelu",d,void 0)},1316147:(d,m,y,x,_,O,R,M,j,Y,ne,Ae,Ce,L,fe,Le)=>{c.gb("Conv",d,{format:Ae?"NHWC":"NCHW",auto_pad:m,dilations:y?Array.from(i().subarray(y>>>0,x>>>0)):[],group:_,kernel_shape:O?Array.from(i().subarray(O>>>0,R>>>0)):[],pads:M?Array.from(i().subarray(M>>>0,j>>>0)):[],strides:Y?Array.from(i().subarray(Y>>>0,ne>>>0)):[],w_is_const:()=>!!e()[Ce>>>0],activation:ot(L),activation_params:fe?Array.from(a().subarray(fe>>>0,Le>>>0)):[]})},1316643:d=>{c.gb("Gelu",d,void 0)},1316695:(d,m,y,x)=>{c.gb("GroupQueryAttention",d,{numHeads:m,kvNumHeads:y,scale:x})},1316808:(d,m,y,x)=>{c.gb("LayerNormalization",d,{axis:m,epsilon:y,simplified:!!x})},1316919:(d,m,y,x)=>{c.gb("LayerNormalization",d,{axis:m,epsilon:y,simplified:!!x})},1317030:(d,m,y,x,_,O)=>{c.gb("MatMulNBits",d,{k:m,n:y,accuracyLevel:x,bits:_,blockSize:O})},1317157:(d,m,y,x,_,O)=>{c.gb("MultiHeadAttention",d,{numHeads:m,isUnidirectional:y,maskFilterValue:x,scale:_,doRotary:O})},1317316:(d,m)=>{c.gb("QuickGelu",d,{alpha:m})},1317380:(d,m,y,x,_)=>{c.gb("RotaryEmbedding",d,{interleaved:!!m,numHeads:y,rotaryEmbeddingDim:x,scale:_})},1317519:(d,m,y)=>{c.gb("SkipLayerNormalization",d,{epsilon:m,simplified:!!y})},1317621:d=>{c.Vb(d)},1317655:(d,m)=>c.Xb(d,m,c.Bb.Zb,c.Bb.errors),1317767:(d,m,y)=>{c.gb("SkipLayerNormalization",d,{epsilon:m,simplified:!!y})}};function R0(d,m,y){return il(async()=>{await c.Tb(d,m,y)})}function ra(d){this.name="ExitStatus",this.message=`Program terminated with exit(${d})`,this.status=d}var na=d=>{d.terminate(),d.onmessage=()=>{}},Su=d=>{gr.length==0&&(ku(),Cu(gr[0]));var m=gr.pop();if(!m)return 6;Cr.push(m),jt[d.xb]=m,m.xb=d.xb;var y={cmd:"run",start_routine:d.$b,arg:d.Mb,pthread_ptr:d.xb};return m.postMessage(y,d.ec),0},Er=0,We=(d,m,...y)=>{for(var x=2*y.length,_=wa(),O=va(8*x),R=O>>>3,M=0;M<y.length;M++){var j=y[M];typeof j=="bigint"?(V[R+2*M]=1n,V[R+2*M+1]=j):(V[R+2*M]=0n,u()[R+2*M+1>>>0]=j)}return d=Ol(d,0,x,O,m),go(_),d};function $u(d){if(g)return We(0,1,d);if(Q=d,!(0<Er)){for(var m of Cr)na(m);for(m of gr)na(m);gr=[],Cr=[],jt=[],c.onExit?.(d),tt=!0}E(d,new ra(d))}function Au(d){if(g)return We(1,0,d);oa(d)}var oa=d=>{if(Q=d,g)throw Au(d),"unwind";$u(d)},gr=[],Cr=[],Pu=[],jt={},Ou=d=>{var m=d.xb;delete jt[m],gr.push(d),Cr.splice(Cr.indexOf(d),1),d.xb=0,xa(m)};function Eu(){Pu.forEach(d=>d())}var Cu=d=>new Promise(m=>{d.onmessage=_=>{var O=(_=_.data).cmd;if(_.targetThread&&_.targetThread!=an()){var R=jt[_.targetThread];R?R.postMessage(_,_.transferList):F(`Internal error! Worker sent a message "${O}" to target pthread ${_.targetThread}, but that thread no longer exists!`)}else O==="checkMailbox"?io():O==="spawnThread"?Su(_):O==="cleanupThread"?Ou(jt[_.thread]):O==="killThread"?(_=_.thread,O=jt[_],delete jt[_],na(O),xa(_),Cr.splice(Cr.indexOf(O),1),O.xb=0):O==="cancelThread"?jt[_.thread].postMessage({cmd:"cancel"}):O==="loaded"?(d.loaded=!0,m(d)):O==="alert"?alert(`Thread ${_.threadId}: ${_.text}`):_.target==="setimmediate"?d.postMessage(_):O==="callHandler"?c[_.handler](..._.args):O&&F(`worker sent an unknown command ${O}`)},d.onerror=_=>{throw F(`worker sent an error! ${_.filename}:${_.lineno}: ${_.message}`),_};var y,x=[];for(y of["onExit"])c.hasOwnProperty(y)&&x.push(y);d.postMessage({cmd:"load",handlers:x,wasmMemory:ae,wasmModule:qe})});function ku(){var d=new Worker(new URL(import.meta.url),{type:"module",workerData:"em-pthread",name:"em-pthread"});gr.push(d)}var oo=d=>{for(;0<d.length;)d.shift()(c)},N0=()=>{var d=an(),m=s()[d+52>>>2>>>0];d=s()[d+56>>>2>>>0],Cl(m,m-d),go(m)},z0=(d,m)=>{Er=0,d=kl(d,m),0<Er?Q=d:ho(d)};class F0{constructor(m){this.Fb=m-24}}function M0(d,m,y){var x=new F0(d>>>=0);throw m>>>=0,y>>>=0,s()[x.Fb+16>>>2>>>0]=0,s()[x.Fb+4>>>2>>>0]=m,s()[x.Fb+8>>>2>>>0]=y,d}function Du(d,m,y,x){return g?We(2,1,d,m,y,x):Bu(d,m,y,x)}function Bu(d,m,y,x){if(d>>>=0,m>>>=0,y>>>=0,x>>>=0,T===void 0)return F("Current environment does not support SharedArrayBuffer, pthreads are not available!"),6;var _=[];return g&&_.length===0?Du(d,m,y,x):(d={$b:y,xb:d,Mb:x,ec:_},g?(d.Ib="spawnThread",postMessage(d,_),0):Su(d))}var Lu=typeof TextDecoder<"u"?new TextDecoder("utf8"):void 0,Ru=(d,m,y)=>{var x=(m>>>=0)+y;for(y=m;d[y]&&!(y>=x);)++y;if(16<y-m&&d.buffer&&Lu)return Lu.decode(d.buffer instanceof T?d.slice(m,y):d.subarray(m,y));for(x="";m<y;){var _=d[m++];if(128&_){var O=63&d[m++];if((224&_)==192)x+=String.fromCharCode((31&_)<<6|O);else{var R=63&d[m++];65536>(_=(240&_)==224?(15&_)<<12|O<<6|R:(7&_)<<18|O<<12|R<<6|63&d[m++])?x+=String.fromCharCode(_):(_-=65536,x+=String.fromCharCode(55296|_>>10,56320|1023&_))}}else x+=String.fromCharCode(_)}return x},ot=(d,m)=>(d>>>=0)?Ru(n(),d,m):"";function Nu(d,m,y){return g?We(3,1,d,m,y):0}function zu(d,m){if(g)return We(4,1,d,m)}var ia=d=>{for(var m=0,y=0;y<d.length;++y){var x=d.charCodeAt(y);127>=x?m++:2047>=x?m+=2:55296<=x&&57343>=x?(m+=4,++y):m+=3}return m},Fu=(d,m,y,x)=>{if(!(0<x))return 0;var _=y>>>=0;x=y+x-1;for(var O=0;O<d.length;++O){var R=d.charCodeAt(O);if(55296<=R&&57343>=R&&(R=65536+((1023&R)<<10)|1023&d.charCodeAt(++O)),127>=R){if(y>=x)break;m[y++>>>0]=R}else{if(2047>=R){if(y+1>=x)break;m[y++>>>0]=192|R>>6}else{if(65535>=R){if(y+2>=x)break;m[y++>>>0]=224|R>>12}else{if(y+3>=x)break;m[y++>>>0]=240|R>>18,m[y++>>>0]=128|R>>12&63}m[y++>>>0]=128|R>>6&63}m[y++>>>0]=128|63&R}}return m[y>>>0]=0,y-_},rn=(d,m,y)=>Fu(d,n(),m,y);function Mu(d,m){if(g)return We(5,1,d,m)}function Vu(d,m,y){if(g)return We(6,1,d,m,y)}function Gu(d,m,y){return g?We(7,1,d,m,y):0}function Uu(d,m){if(g)return We(8,1,d,m)}function Wu(d,m,y){if(g)return We(9,1,d,m,y)}function Hu(d,m,y,x){if(g)return We(10,1,d,m,y,x)}function qu(d,m,y,x){if(g)return We(11,1,d,m,y,x)}function Ku(d,m,y,x){if(g)return We(12,1,d,m,y,x)}function ju(d){if(g)return We(13,1,d)}function Xu(d,m){if(g)return We(14,1,d,m)}function Zu(d,m,y){if(g)return We(15,1,d,m,y)}var Yu,br,V0=()=>{An("")},Xt=d=>{for(var m="";n()[d>>>0];)m+=Yu[n()[d++>>>0]];return m},aa={},sa={},G0={};function lr(d,m,y={}){if(!("argPackAdvance"in m))throw new TypeError("registerType registeredInstance requires argPackAdvance");return function(x,_,O={}){var R=_.name;if(!x)throw new br(`type "${R}" must have a positive integer typeid pointer`);if(sa.hasOwnProperty(x)){if(O.Ob)return;throw new br(`Cannot register type '${R}' twice`)}sa[x]=_,delete G0[x],aa.hasOwnProperty(x)&&(_=aa[x],delete aa[x],_.forEach(M=>M()))}(d,m,y)}var Ju=(d,m,y)=>{switch(m){case 1:return y?x=>e()[x>>>0]:x=>n()[x>>>0];case 2:return y?x=>t()[x>>>1>>>0]:x=>o()[x>>>1>>>0];case 4:return y?x=>i()[x>>>2>>>0]:x=>s()[x>>>2>>>0];case 8:return y?x=>V[x>>>3]:x=>ie[x>>>3];default:throw new TypeError(`invalid integer width (${m}): ${d}`)}};function U0(d,m,y){y>>>=0,lr(d>>>=0,{name:m=Xt(m>>>0),fromWireType:x=>x,toWireType:function(x,_){if(typeof _!="bigint"&&typeof _!="number")throw _=_===null?"null":(x=typeof _)=="object"||x==="array"||x==="function"?_.toString():""+_,new TypeError(`Cannot convert "${_}" to ${this.name}`);return typeof _=="number"&&(_=BigInt(_)),_},argPackAdvance:yr,readValueFromPointer:Ju(m,y,m.indexOf("u")==-1),Ab:null})}var yr=8;function W0(d,m,y,x){lr(d>>>=0,{name:m=Xt(m>>>0),fromWireType:function(_){return!!_},toWireType:function(_,O){return O?y:x},argPackAdvance:yr,readValueFromPointer:function(_){return this.fromWireType(n()[_>>>0])},Ab:null})}var ua=[],cr=[];function la(d){9<(d>>>=0)&&--cr[d+1]==0&&(cr[d]=void 0,ua.push(d))}var $t=d=>{if(!d)throw new br("Cannot use deleted val. handle = "+d);return cr[d]},At=d=>{switch(d){case void 0:return 2;case null:return 4;case!0:return 6;case!1:return 8;default:let m=ua.pop()||cr.length;return cr[m]=d,cr[m+1]=1,m}};function ca(d){return this.fromWireType(s()[d>>>2>>>0])}var H0={name:"emscripten::val",fromWireType:d=>{var m=$t(d);return la(d),m},toWireType:(d,m)=>At(m),argPackAdvance:yr,readValueFromPointer:ca,Ab:null};function q0(d){return lr(d>>>0,H0)}var K0=(d,m)=>{switch(m){case 4:return function(y){return this.fromWireType(a()[y>>>2>>>0])};case 8:return function(y){return this.fromWireType(u()[y>>>3>>>0])};default:throw new TypeError(`invalid float width (${m}): ${d}`)}};function j0(d,m,y){y>>>=0,lr(d>>>=0,{name:m=Xt(m>>>0),fromWireType:x=>x,toWireType:(x,_)=>_,argPackAdvance:yr,readValueFromPointer:K0(m,y),Ab:null})}function X0(d,m,y,x,_){if(d>>>=0,y>>>=0,m=Xt(m>>>0),_===-1&&(_=4294967295),_=M=>M,x===0){var O=32-8*y;_=M=>M<<O>>>O}var R=m.includes("unsigned")?function(M,j){return j>>>0}:function(M,j){return j};lr(d,{name:m,fromWireType:_,toWireType:R,argPackAdvance:yr,readValueFromPointer:Ju(m,y,x!==0),Ab:null})}function Z0(d,m,y){function x(O){var R=s()[O>>>2>>>0];return O=s()[O+4>>>2>>>0],new _(e().buffer,O,R)}var _=[Int8Array,Uint8Array,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array,BigInt64Array,BigUint64Array][m];lr(d>>>=0,{name:y=Xt(y>>>0),fromWireType:x,argPackAdvance:yr,readValueFromPointer:x},{Ob:!0})}function Y0(d,m){d>>>=0;var y=(m=Xt(m>>>0))==="std::string";lr(d,{name:m,fromWireType:function(x){var _=s()[x>>>2>>>0],O=x+4;if(y)for(var R=O,M=0;M<=_;++M){var j=O+M;if(M==_||n()[j>>>0]==0){if(R=ot(R,j-R),Y===void 0)var Y=R;else Y+=String.fromCharCode(0),Y+=R;R=j+1}}else{for(Y=Array(_),M=0;M<_;++M)Y[M]=String.fromCharCode(n()[O+M>>>0]);Y=Y.join("")}return Yt(x),Y},toWireType:function(x,_){_ instanceof ArrayBuffer&&(_=new Uint8Array(_));var O=typeof _=="string";if(!(O||_ instanceof Uint8Array||_ instanceof Uint8ClampedArray||_ instanceof Int8Array))throw new br("Cannot pass non-string to std::string");var R=y&&O?ia(_):_.length,M=mo(4+R+1),j=M+4;if(s()[M>>>2>>>0]=R,y&&O)rn(_,j,R+1);else if(O)for(O=0;O<R;++O){var Y=_.charCodeAt(O);if(255<Y)throw Yt(j),new br("String has UTF-16 code units that do not fit in 8 bits");n()[j+O>>>0]=Y}else for(O=0;O<R;++O)n()[j+O>>>0]=_[O];return x!==null&&x.push(Yt,M),M},argPackAdvance:yr,readValueFromPointer:ca,Ab(x){Yt(x)}})}var Qu=typeof TextDecoder<"u"?new TextDecoder("utf-16le"):void 0,J0=(d,m)=>{for(var y=d>>1,x=y+m/2;!(y>=x)&&o()[y>>>0];)++y;if(32<(y<<=1)-d&&Qu)return Qu.decode(n().slice(d,y));for(y="",x=0;!(x>=m/2);++x){var _=t()[d+2*x>>>1>>>0];if(_==0)break;y+=String.fromCharCode(_)}return y},Q0=(d,m,y)=>{if(y??=2147483647,2>y)return 0;var x=m;y=(y-=2)<2*d.length?y/2:d.length;for(var _=0;_<y;++_){var O=d.charCodeAt(_);t()[m>>>1>>>0]=O,m+=2}return t()[m>>>1>>>0]=0,m-x},ex=d=>2*d.length,tx=(d,m)=>{for(var y=0,x="";!(y>=m/4);){var _=i()[d+4*y>>>2>>>0];if(_==0)break;++y,65536<=_?(_-=65536,x+=String.fromCharCode(55296|_>>10,56320|1023&_)):x+=String.fromCharCode(_)}return x},rx=(d,m,y)=>{if(m>>>=0,y??=2147483647,4>y)return 0;var x=m;y=x+y-4;for(var _=0;_<d.length;++_){var O=d.charCodeAt(_);if(55296<=O&&57343>=O&&(O=65536+((1023&O)<<10)|1023&d.charCodeAt(++_)),i()[m>>>2>>>0]=O,(m+=4)+4>y)break}return i()[m>>>2>>>0]=0,m-x},nx=d=>{for(var m=0,y=0;y<d.length;++y){var x=d.charCodeAt(y);55296<=x&&57343>=x&&++y,m+=4}return m};function ox(d,m,y){if(d>>>=0,m>>>=0,y=Xt(y>>>=0),m===2)var x=J0,_=Q0,O=ex,R=M=>o()[M>>>1>>>0];else m===4&&(x=tx,_=rx,O=nx,R=M=>s()[M>>>2>>>0]);lr(d,{name:y,fromWireType:M=>{for(var j,Y=s()[M>>>2>>>0],ne=M+4,Ae=0;Ae<=Y;++Ae){var Ce=M+4+Ae*m;Ae!=Y&&R(Ce)!=0||(ne=x(ne,Ce-ne),j===void 0?j=ne:(j+=String.fromCharCode(0),j+=ne),ne=Ce+m)}return Yt(M),j},toWireType:(M,j)=>{if(typeof j!="string")throw new br(`Cannot pass non-string to C++ string type ${y}`);var Y=O(j),ne=mo(4+Y+m);return s()[ne>>>2>>>0]=Y/m,_(j,ne+4,Y+m),M!==null&&M.push(Yt,ne),ne},argPackAdvance:yr,readValueFromPointer:ca,Ab(M){Yt(M)}})}function ix(d,m){lr(d>>>=0,{Pb:!0,name:m=Xt(m>>>0),argPackAdvance:0,fromWireType:()=>{},toWireType:()=>{}})}var ax=()=>1;function sx(d){ya(d>>>0,!h,1,!b,131072,!1),Eu()}var el=d=>{if(!tt)try{if(d(),!(0<Er))try{g?ho(Q):oa(Q)}catch(m){m instanceof ra||m=="unwind"||E(1,m)}}catch(m){m instanceof ra||m=="unwind"||E(1,m)}};function fa(d){d>>>=0,typeof Atomics.fc=="function"&&(Atomics.fc(i(),d>>>2,d).value.then(io),d+=128,Atomics.store(i(),d>>>2,1))}var io=()=>{var d=an();d&&(fa(d),el(El))};function ux(d,m){(d>>>=0)==m>>>0?setTimeout(io):g?postMessage({targetThread:d,cmd:"checkMailbox"}):(d=jt[d])&&d.postMessage({cmd:"checkMailbox"})}var da=[];function lx(d,m,y,x,_){for(m>>>=0,x/=2,da.length=x,y=_>>>0>>>3,_=0;_<x;_++)da[_]=V[y+2*_]?V[y+2*_+1]:u()[y+2*_+1>>>0];return(m?ta[m]:Yx[d])(...da)}function cx(d){d>>>=0,g?postMessage({cmd:"cleanupThread",thread:d}):Ou(jt[d])}function fx(d){}var pa=(d,m)=>{var y=sa[d];if(y===void 0)throw d=$l(d),y=Xt(d),Yt(d),new br(`${m} has unknown type ${y}`);return y},tl=(d,m,y)=>{var x=[];return d=d.toWireType(x,y),x.length&&(s()[m>>>2>>>0]=At(x)),d};function dx(d,m,y){return m>>>=0,y>>>=0,d=$t(d>>>0),m=pa(m,"emval::as"),tl(m,y,d)}var ao=d=>{try{d()}catch(m){An(m)}},xr=0,Zt=null,rl=0,so=[],nl={},ol={},px=0,ma=null,mx=[];function il(d){return function(m){if(!tt){if(xr===0){var y=!1,x=!1;m((_=0)=>{if(!tt&&(rl=_,y=!0,x)){xr=2,ao(()=>Ll(Zt)),typeof Browser<"u"&&Browser.Gb.Nb&&Browser.Gb.resume(),_=!1;try{var O=function(){var j=i()[Zt+8>>>2>>>0];return j=te[ol[j]],--Er,j()}()}catch(j){O=j,_=!0}var R=!1;if(!Zt){var M=ma;M&&(ma=null,(_?M.reject:M.resolve)(O),R=!0)}if(_&&!R)throw O}}),x=!0,y||(xr=1,Zt=function(){var _=mo(65548),O=_+12;s()[_>>>2>>>0]=O,s()[_+4>>>2>>>0]=O+65536,O=so[0];var R=nl[O];return R===void 0&&(R=px++,nl[O]=R,ol[R]=O),O=R,i()[_+8>>>2>>>0]=O,_}(),typeof Browser<"u"&&Browser.Gb.Nb&&Browser.Gb.pause(),ao(()=>Dl(Zt)))}else xr===2?(xr=0,ao(Rl),Yt(Zt),Zt=null,mx.forEach(el)):An(`invalid state: ${xr}`);return rl}}(m=>{d().then(m)})}function hx(d){return d>>>=0,il(()=>(d=$t(d)).then(At))}var uo=[];function gx(d,m,y,x){return y>>>=0,x>>>=0,(d=uo[d>>>0])(null,m=$t(m>>>0),y,x)}var bx={},lo=d=>{var m=bx[d];return m===void 0?Xt(d):m};function yx(d,m,y,x,_){return y>>>=0,x>>>=0,_>>>=0,(d=uo[d>>>0])(m=$t(m>>>0),m[y=lo(y)],x,_)}var al=()=>typeof globalThis=="object"?globalThis:Function("return this")();function xx(d){return(d>>>=0)==0?At(al()):(d=lo(d),At(al()[d]))}var vx=d=>{var m=uo.length;return uo.push(d),m},wx=(d,m)=>{for(var y=Array(d),x=0;x<d;++x)y[x]=pa(s()[m+4*x>>>2>>>0],"parameter "+x);return y},sl=(d,m)=>Object.defineProperty(m,"name",{value:d});function Tx(d,m,y){var x=(m=wx(d,m>>>0)).shift();d--;var _=`return function (obj, func, destructorsRef, args) {
...
`}
      ...
      }`;return{name:"Softmax",shaderCache:{hint:`${u}`,inputDependencies:["type"]},getRunData:()=>({outputs:[{dims:n,dataType:r.dataType}],dispatchGroup:{x:a},programUniforms:[{type:6,data:l}]}),getShaderSource:g}},l0=(r,e)=>{II(r.inputs),r.compute(SI(r.inputs[0],e))},c0=r=>de({axis:r.axis})});var $I,AI,PI,OI,EI,d0,p0,m0=C(()=>{"use strict";ue();ye();et();he();$I=r=>{if(!r||r.length<1)throw new Error("too few inputs")},AI=(r,e)=>{let n=[],t=e.numOutputs;return r[1].dims[0]>0&&(r[1].getBigInt64Array().forEach(o=>n.push(Number(o))),t=n.length),de({numOutputs:t,axis:e.axis,splitSizes:n})},PI=r=>`
...
`)}
  ...
  }`;return{name:"Split",shaderCache:{hint:e.cacheKey,inputDependencies:["rank"]},getShaderSource:b,getRunData:()=>({outputs:l,dispatchGroup:{x:Math.ceil(t/64)},programUniforms:p})}},d0=(r,e)=>{$I(r.inputs);let n=r.inputs.length===1?e:AI(r.inputs,e);r.compute(EI(r.inputs,n),{inputs:[0]})},p0=r=>{let e=r.axis,n=r.splitSizes,t=r.numOutputs<0?n.length:r.numOutputs;if(t!==n.length)throw new Error("numOutputs and splitSizes lengh must be equal");return de({axis:e,numOutputs:t,splitSizes:n})}});var CI,kI,h0,g0=C(()=>{"use strict";ue();ye();he();CI=(r,e,n,t,o)=>{let i=G("output_data",o,n.length,4),s=D("a_data",e[1].dataType,e[1].dims.length,4),a=D("b_data",e[2].dataType,e[2].dims.length,4),u=D("c_data",e[0].dataType,e[0].dims.length,4),l,f=(c,p,b)=>`select(${p}, ${c}, ${b})`;if(!t)l=i.setByOffset("global_idx",f(s.getByOffset("global_idx"),a.getByOffset("global_idx"),u.getByOffset("global_idx")));else{let c=(p,b,h="")=>{let g=`a_data[index_a${b}][component_a${b}]`,T=`b_data[index_b${b}][component_b${b}]`,w=`bool(c_data[index_c${b}] & (0xffu << (component_c${b} * 8)))`;return`
