...
`)},type:m,offsetToIndices:E,indicesToOffset:H,broadcastedIndicesToOffset:j,indices:N,indicesGet:G,indicesSet:re,set:(...F)=>{if(F.length!==u+1)throw new Error(`indices length must be ${u}`);let de=F[u];if(typeof de!="string")throw new Error("value must be string");let me=F.slice(0,u).map(b).join(",");return u===0?pe("0u",de):u===1?pe(me[0],de):(w.set=!0,w.setByIndices=!0,w.indicesToOffset=!0,`set_${e}(${me}, ${de})`)},setByOffset:pe,setByIndices:(F,de)=>u<2?pe(F,de):(w.setByIndices=!0,w.indicesToOffset=!0,`set_${e}ByIndices(${F}, ${de});`),get:Se,getByOffset:Q,getByIndices:Ie,usage:a,name:e,strides:x,shape:I,rank:u}},W=(e,t,r,a=1)=>Zn(e,t,r,"input",a),K=(e,t,r,a=1)=>Zn(e,t,r,"output",a),Zi=(e,t,r,a=1)=>Zn(e,t,r,"internal",a),Yn=class{constructor(t){this.normalizedDispatchGroup=t;this.internalVariables=[];this.variables=[];this.uniforms=[];this.variableIndex=0}guardAgainstOutOfBoundsWorkgroupSizes(t){return`if (global_idx >= ${typeof t=="number"?`${t}u`:t}) { return; }`}mainStart(t=hd){let r=typeof t=="number"?t:t[0],a=typeof t=="number"?1:t[1],n=typeof t=="number"?1:t[2],o=this.normalizedDispatchGroup[1]===1&&this.normalizedDispatchGroup[2]===1,u=o?`@builtin(global_invocation_id) global_id : vec3<u32>,
...
`)}},Xi=e=>new Yn(e),Xn=(e,t)=>{let r=e.length,a=[];for(let n=0;n<r;n++){let o=r-1-n,u=e[o]||1;(t[t.length-1-n]||1)>1&&u===1&&a.unshift(o)}return a},Pe=e=>!0});var gd,Ji,yd,bd,it,Qi,eo,Xt=q(()=>{"use strict";ye();Re();be();gd=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},Ji=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,yd=(e,t)=>D.sortBasedOnPerm(e,Ji(e.length,t)),bd=(e,t,r,a)=>{let n=[];n.push(`fn perm(i: ${a.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`);for(let o=0;o<t;++o)n.push(r.indicesSet("a",e[o],`i[${o}]`));return n.push("return a;}"),n.join(`
`)},it=(e,t)=>{let r=e.dataType,a=e.dims.length,n=Ji(a,t),o=Pe(a),u=yd(e.dims,n),l=o?u.length:u,i=o?a:e.dims,c=K("output",r,l),f=W("a",r,i),y=m=>`
...
var best_index : i32 = 0;`,`if (${a.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`;e.compute({name:"AttentionProbsSoftmax",shaderCache:{hint:`${a}`},getShaderSource:y,getRunData:()=>({outputs:[],dispatchGroup:{x:r}})},{inputs:[t],outputs:[]})},Hd=(e,t,r,a,n,o)=>{let u=[n.batchSize,n.numHeads,n.sequenceLength,n.kvSequenceLength+n.pastSequenceLength],l=o.scale===0?1/Math.sqrt(n.headSize):o.scale,i=Te(t.dataType),c=Je(n.headSize),f=W("q",t.dataType,t.dims,c),y=W("key",r.dataType,r.dims,c),m=K("output",t.dataType,u),b=n.headSize/c,w=n.sequenceLength,$=n.totalSequenceLength,I=b,x=12,C={x:Math.ceil(n.totalSequenceLength/x),y:Math.ceil(n.sequenceLength/x),z:n.batchSize*n.numHeads},P=[t,r],E=T=>`
  const M: u32 = ${w}u;
  const N: u32 = ${$}u;
  const K: u32 = ${I}u;
  const alpha: ${i} = ${l};
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${a}_${u}`,inputDependencies:c?["rank","type","type","type","type"]:void 0},getShaderSource:C,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:c?[{type:"uint32",data:i},...Y(o)]:[{type:"uint32",data:i}]})}},jd=e=>J(e),To=(e,t)=>{let{inputs:r,outputCount:a}=e,n=jd({...t,outputCount:a});if(Ae.webgpu.validateInputContent&&Fd(r,n),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(qd(r,n))}});var Kd,Yd,ko,Ro=q(()=>{"use strict";ye();be();Kd=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Yd=e=>{let t=e[0].dims,r=e[0].dims[2],a=D.size(t)/4,n=e[0].dataType,o=W("input",n,t,4),u=W("bias",n,[r],4),l=W("residual",n,t,4),i=K("output",n,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)}}),getShaderSource:f=>`
  ...
  ${f.mainStart()}
    ...
    ${i.setByOffset("global_idx","value")}
  }`}},ko=e=>{Kd(e.inputs),e.compute(Yd(e.inputs))}});var Zd,Oe,Po,Bo,Mo,zo,Do,Wo,Uo,No,Vo,Xd,Ho,Lo,Go,Fo,un,qo,ln,jo,Ko,Yo,Zo,Xo,Jo,Qo,es,ts,rs,ns,as,is,os,ss,us,ls,ta=q(()=>{"use strict";De();ye();Re();be();Zd=(e,t,r,a,n,o)=>{let u=Math.ceil(t/4),l="";typeof n=="string"?l=`${n}(a)`:l=n("a");let i=W("inputData",r,[u],4),c=K("outputData",a,[u],4);return`
  ...
  }`},Oe=(e,t,r,a,n,o=e.dataType)=>({name:t,shaderCache:{hint:n,inputDependencies:["type"]},getShaderSource:u=>Zd(u,D.size(e.dims),e.dataType,o,r,a),getRunData:u=>({outputs:[{dims:e.dims,dataType:o}],dispatchGroup:{x:Math.ceil(D.size(u[0].dims)/64/4)},programUniforms:[{type:"uint32",data:Math.ceil(D.size(e.dims)/4)}]})}),Po=e=>{e.compute(Oe(e.inputs[0],"Abs","abs"))},Bo=e=>{e.compute(Oe(e.inputs[0],"Acos","acos"))},Mo=e=>{e.compute(Oe(e.inputs[0],"Acosh","acosh"))},zo=e=>{e.compute(Oe(e.inputs[0],"Asin","asin"))},Do=e=>{e.compute(Oe(e.inputs[0],"Asinh","asinh"))},Wo=e=>{e.compute(Oe(e.inputs[0],"Atan","atan"))},Uo=e=>{e.compute(Oe(e.inputs[0],"Atanh","atanh"))},No=e=>J(e),Vo=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(Oe(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},Xd=e=>{let t=e.length>=2?e[1].getFloat32Array()[0]:rn,r=e.length>=3?e[2].getFloat32Array()[0]:nn;return J({min:t,max:r})},Ho=(e,t)=>{let r=e.inputs.length===1?t:Xd(e.inputs),a=Te(e.inputs[0].dataType);e.compute(Oe(e.inputs[0],"Clip",n=>`clamp(${n}, clip_min_, clip_max_)`,`
    const clip_min_: vec4<${a}> = vec4(${a}(${r.min}));
    const clip_max_: vec4<${a}> = vec4(${a}(${r.max}));
`,r.cacheKey),{inputs:[0]})},Lo=e=>{e.compute(Oe(e.inputs[0],"Ceil","ceil"))},Go=e=>{e.compute(Oe(e.inputs[0],"Cos","cos"))},Fo=e=>{e.compute(Oe(e.inputs[0],"Cosh","cosh"))},un=e=>J(e),qo=(e,t)=>{e.compute(Oe(e.inputs[0],"Elu",r=>`elu_vf32(${r})`,`
...
fn erf_vf32(v: ${e}) -> ${e} {
...
}`,jo=e=>{let t=Te(e.inputs[0].dataType);e.compute(Oe(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,ln(`vec4<${t}>`,t)))},Ko=e=>{e.compute(Oe(e.inputs[0],"Exp","exp"))},Yo=e=>{e.compute(Oe(e.inputs[0],"Floor","floor"))},Zo=e=>{let t=Te(e.inputs[0].dataType);e.compute(Oe(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,ln(`vec4<${t}>`,t)))},Xo=(e,t)=>{e.compute(Oe(e.inputs[0],"LeakyRelu",r=>`select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<f32>(0.0))`,`const leaky_relu_alpha_: f32 = f32(${t.alpha});`,t.cacheKey))},Jo=e=>{e.compute(Oe(e.inputs[0],"Not",t=>`!${t}`))},Qo=e=>{e.compute(Oe(e.inputs[0],"Neg",t=>`-${t}`))},es=e=>{e.compute(Oe(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},ts=e=>{e.compute(Oe(e.inputs[0],"Relu",t=>`select(vec4<f32>(0.0), ${t}, ${t} > vec4<f32>(0.0))`))},rs=e=>{e.compute(Oe(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},ns=e=>{e.compute(Oe(e.inputs[0],"Sin","sin"))},as=e=>{e.compute(Oe(e.inputs[0],"Sinh","sinh"))},is=e=>{e.compute(Oe(e.inputs[0],"Sqrt","sqrt"))},os=e=>{e.compute(Oe(e.inputs[0],"Tan","tan"))},ss=e=>{e.compute(Oe(e.inputs[0],"Tanh","tanh"))},us=(e,t)=>(e.compute(Oe(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<f32>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_: vec4<f32> = vec4<f32>(${t.alpha});`,t.cacheKey)),0),ls=e=>{e.compute(Oe(e.inputs[0],"Log","log"))}});var Qd,ec,ds,cs=q(()=>{"use strict";ye();be();ta();Qd=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},ec=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=W("input",e[0].dataType,e[0].dims,4),a=W("bias",e[0].dataType,[e[0].dims[2]],4),n=K("output",e[0].dataType,t,4),o=D.size(t)/4,u=Te(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)}}),getShaderSource:i=>`
  ...
  ${i.mainStart()}
    ...
    ${n.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${z}
      }`},rc=(e,t,r,a,n,o,u=r.dataType)=>{let l=!D.areEqual(r.dims,a.dims),i=r.dims,c=D.size(r.dims),f=!1,y=!1,m=[l];if(l){let w=ct.calcShape(r.dims,a.dims,!1);if(!w)throw new Error("Can't perform binary op on the given tensors");i=w,c=D.size(i);let $=D.size(r.dims)===1,I=D.size(a.dims)===1,x=r.dims.length>0&&r.dims[r.dims.length-1]%4===0,C=a.dims.length>0&&a.dims[a.dims.length-1]%4===0;m.push($),m.push(I),m.push(x),m.push(C);let P=1;for(let E=1;E<i.length;E++){let z=r.dims[r.dims.length-E]??1,T=a.dims[a.dims.length-E]??1;if(z===T)P*=z;else break}P%4===0?(y=!0,f=!0):($||I||x||C)&&(f=!0)}else f=!0;m.push(f);let b=Pe(r.dims.length)&&Pe(a.dims.length)&&Pe(i.length);return{name:e,shaderCache:{hint:t+m.map(w=>w.toString()).join("_"),inputDependencies:b?["rank","rank"]:["dims","dims"]},getShaderSource:w=>tc(w,r.dims,a.dims,i,f,l,y,n,r.dataType,a.dataType,u,b,o),getRunData:()=>({outputs:[{dims:i,dataType:u}],dispatchGroup:{x:Math.ceil(c/64/4)},programUniforms:b?[{type:"uint32",data:Math.ceil(D.size(i)/4)},...Y(r.dims),...Y(a.dims),...Y(i)]:[{type:"uint32",data:Math.ceil(D.size(i)/4)}]})}},gt=(e,t,r,a,n,o)=>{e.compute(rc(t,n??"",e.inputs[0],e.inputs[1],r,a,o))},ps=e=>{gt(e,"Add",(t,r)=>`${t}+${r}`)},fs=e=>{gt(e,"Div",(t,r)=>`${t}/${r}`)},ms=e=>{gt(e,"Equal",{scalar:(t,r)=>`u32(${t}==${r})`,vector:(t,r)=>`vec4<u32>(${t}==${r})`},void 0,void 0,9)},hs=e=>{gt(e,"Mul",(t,r)=>`${t}*${r}`)},gs=e=>{let t=W("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;gt(e,"Pow",{scalar:(a,n)=>`pow_custom(${a},${n})`,vector:(a,n)=>`pow_vector_custom(${a},${n})`},`
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},ys=e=>{gt(e,"Sub",(t,r)=>`${t}-${r}`)},bs=e=>{gt(e,"Greater",{scalar:(t,r)=>`u32(${t}>${r})`,vector:(t,r)=>`vec4<u32>(${t}>${r})`},void 0,void 0,9)},ws=e=>{gt(e,"Less",{scalar:(t,r)=>`u32(${t}<${r})`,vector:(t,r)=>`vec4<u32>(${t}<${r})`},void 0,void 0,9)},vs=e=>{gt(e,"GreaterOrEqual",{scalar:(t,r)=>`u32(${t}>=${r})`,vector:(t,r)=>`vec4<u32>(${t}>=${r})`},void 0,void 0,9)},$s=e=>{gt(e,"LessOrEqual",{scalar:(t,r)=>`u32(${t}<=${r})`,vector:(t,r)=>`vec4<u32>(${t}<=${r})`},void 0,void 0,9)}});var ac,ic,oc,sc,xs,_s,Cs=q(()=>{"use strict";ye();Re();be();ac=e=>{if(!e||e.length<1)throw new Error("too few inputs");let t=e[0].dataType,r=e[0].dims.length;for(let a of e){if(a.dataType!==t)throw new Error("input tensors should be one type");if(a.dims.length!==r)throw new Error("input tensors should have the same shape")}},ic=(e,t)=>`
...
`});var uc,lc,wr,Is,dc,vr,cc,mn,$r=q(()=>{"use strict";ye();be();Vt();pn();uc=(e,t)=>e?`
...
`},cc=(e,t,r,a,n,o=!1)=>{let[u,l,i]=n,[c,f,y,m]=a,b=Xn(u,i),w=Xn(l,i),$=Te(a[0].type.tensor),I=()=>{let P=f.rank,E=c.rank,z=`var aIndices: ${f.type.indices};`;for(let T=P-2-1,H=E-1;T>=0;T--,H--)z+=`
...
bIndices[${P-2}] = u32(row);
  ...
  ${x?wr(C,P,z,m):vr(C,P,z,m)}
    ...
    return ${Ve(u,c)}(0.0);`,E=`${y(l)}`,z=Ve(i,c),T=e?Ve(u,c):Ve(l,c),H=e?Ve(l,c):Ve(u,c),{activationFunction:N,applyActivation:G}=At(o,z);return`
    ${N}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${z}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${w?`vec4<${j}>`:j}) {
        ...
        ${pc(i,N,G,re,u,t,B[0],B[1],B[2],j)}
            ${w?wr(C,x,j,void 0,!i,H):vr(C,x,j,void 0,!i,H,!1,void 0,l)}`}}});var na,Ts=q(()=>{"use strict";ye();be();ia();Vt();na=(e,t,r)=>{let a=e.length>2,n=a?"value += b[output_channel];":"",o=e[0].dims,u=e[1].dims,l=u[0]/t.group,i=t.format==="NHWC",c=aa(o,u,t.dilations,t.pads,t.strides,i),f=D.size(c),y=K("output",e[0].dataType,c),{activationFunction:m,applyActivation:b}=At(t,y.type.value),w=W("x",e[0].dataType,o),$=W("w",e[1].dataType,u),I=[w,$];a&&I.push(W("b",e[2].dataType,e[2].dims));let x=C=>`
  ...
  ${C.mainStart()}
  ...
  }`;return{name:"GroupedConv",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:r?r(c):c,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(f/64)}}),getShaderSource:x}}});var aa,Os,fc,ks,oa,mc,hc,sa,ia=q(()=>{"use strict";ye();Re();As();$r();Ts();Vt();Xt();aa=(e,t,r,a,n,o)=>{let u=e[0],l=e.slice(o?1:2,o?3:4),i=l.length,c=t[0],y=t.slice(2).map((w,$)=>w+(w-1)*(r[$]-1)),b=l.map((w,$)=>w+a[$]+a[$+i]).map((w,$)=>Math.floor((w-y[$]+n[$])/n[$]));return b.splice(0,0,u),b.splice(o?3:1,0,c),b},Os=[2,3,1,0],fc=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support conv 1D and 2D");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],a=e[1].dims[1]*t.group;if(r!==a)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let n=e[0].dims.length-2;if(t.dilations.length!==n)throw new Error(`dilations should be ${n}D`);if(t.strides.length!==n)throw new Error(`strides should be ${n}D`);if(t.pads.length!==n*2)throw new Error(`pads should be ${n*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},ks=(e,t)=>{let r=e.kernelShape.slice();for(let o=2;o<t[1].dims.length;++o)r[o-2]===0&&(r[o-2]=t[1].dims[o]);let a=e.pads.slice();Nt.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,r,a,e.format==="NHWC",e.autoPad);let n=Object.assign({},e);return Object.assign(n,{kernelShape:r,pads:a,cacheKey:e.cacheKey}),n},oa=e=>{let t=dn(e),r=e.format,a=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],n=e.dilations,o=e.group,u=e.kernel_shape,l=e.pads,i=e.strides,c=e.w_is_const();return J({autoPad:a,format:r,dilations:n,group:o,kernelShape:u,pads:l,strides:i,wIsConst:c,...t})},mc=(e,t,r)=>{let a=ks(r,t);if(r.group!==1){e.compute(na(t,a));return}let n=r.format==="NHWC",o=t.length===3,u=t[0].dims[n?1:2],l=t[0].dims[n?2:3],i=t[0].dims[n?3:1],c=t[1].dims[2],f=t[1].dims[3],y=aa(t[0].dims,t[1].dims,r.dilations,a.pads,r.strides,n),m=y[n?1:2],b=y[n?2:3],w=y[n?3:1],$=n&&c===u&&f===l&&r.pads[0]===0&&r.pads[1]===0;if($||c===1&&f===1&&r.dilations[0]===1&&r.dilations[1]===1&&r.strides[0]===1&&r.strides[1]===1&&r.pads[0]===0&&r.pads[1]===0){let T=y[0],H,N,G,re=[];if(n){let B=e.kernelCustomData.wT??e.compute(it(t[1],Os),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];if(r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=B),$){let j=u*l*i;H=t[0].reshape([1,T,j]),N=B.reshape([1,j,w]),G=[1,T,w]}else H=t[0].reshape([T,u*l,i]),N=B.reshape([1,i,w]),G=[T,m*b,w];re.push(H),re.push(N)}else H=t[0].reshape([T,i,u*l]),N=t[1].reshape([1,w,i]),G=[T,w,m*b],re.push(N),re.push(H);o&&re.push(t[2]),e.compute(mn(re,a,y,G,n),{inputs:re});return}let I=!0,x=e.kernelCustomData.wT??e.compute(it(t[1],Os),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=x);let C=[t[0],x];o&&C.push(t[2]);let P=n?m*b:w,E=n?w:m*b,z=c*f*i;e.compute(Es(C,a,y,P,E,z,o,I),{inputs:C})},hc=(e,t)=>{let r=t.format==="NHWC",a=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&a.push(e.inputs[2]);let n=[0,t.pads[0],0,t.pads[1]],o=[1].concat(t.strides),u=[1].concat(t.dilations),l=[1].concat(t.kernelShape),i=ks({...t,pads:n,strides:o,dilations:u,kernelShape:l},a);e.compute(na(a,i,c=>r?[c[0],c[2],c[3]]:[]))},sa=(e,t)=>{fc(e.inputs,t),e.inputs[0].dims.length===3?hc(e,t):mc(e,e.inputs,t)}});var gc,Rs,Ps=q(()=>{"use strict";Et();be();Vt();pn();ra();$r();gc=(e,t=!1,r,a=4)=>{let n=Ve(a,"f32"),o=C=>{switch(C){case 1:return"return w[getIndexFromCoords4D(coord, vec4<i32>(uniforms.w_shape))];";case 4:return`
    ...
    `,i=e?"outBackprop[1]":"outBackprop[2]",c=e?"outBackprop[2]":"outBackprop[3]",f=e?"row":"col",y=e?"col":"row",m=`
      ...
      return ${n}(0.0);
      `,{activationFunction:$,applyActivation:I}=At(r,n);return`
      ${$}
  ...
  fn mm_write(batch: i32, row : i32, colIn : i32, valueInput : ${n}) {
    ...
    if (row < uniforms.dimAOuter && col < uniforms.dimBOuter) {
      ...
      result[getIndexFromCoords4D(coords, vec4<i32>(uniforms.result_shape))/${a}] = value;
        ...
        ${j}
        ${gc(i,u,t,E)}
        ${w?wr(C,x,"f32",void 0,!i,z):vr(C,x,"f32",void 0,!i,z,!1,void 0,l)}`}}});var yc,ua,Bs=q(()=>{"use strict";Et();ye();be();yc=(e,t,r,a,n,o,u=!1,l)=>{let i=r.format==="NHWC",c=i?1:2,f=i?2:3,y=i?3:1,m=D.size(a),b=u?2:1,w=r.group,$=t[1].dims,I=$[0]/w,x=$[1],C=`
...
`)};
          ...
          }`};return{name:"Einsum",shaderCache:{hint:a.equation,inputDependencies:e.map(b=>b?"rank":"dims")},getRunData:()=>{let b=y.filter($=>a.symbolToInfo.has($)).map($=>({type:"uint32",data:a.symbolToInfo.get($)?.dimValue||0}));b.push({type:"uint32",data:l});let w=t.filter(($,I)=>e[I]).map(($,I)=>[...Y($)]).reduce(($,I)=>$.concat(I),b);return i&&w.push(...Y(n)),{outputs:[{dims:n,dataType:r}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:w}},getShaderSource:m}},Gs=(e,t)=>{let r=new ca(e.inputs,t.equation),a=e.inputs.map((u,l)=>Pe(u.dims.length)),n=r.outputDims,o=e.inputs.map((u,l)=>u.dims);e.compute(Ac(a,o,e.inputs[0].dataType,r,n))},Fs=e=>{let t=e.equation.replace(/\s+/g,"");return J({equation:t})}});var Tc,js,Oc,kc,Ks,Ys=q(()=>{"use strict";De();ye();be();Tc=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),a=r.length<t.length?0:r.length-t.length,n=t.length<r.length?0:t.length-r.length;for(;a<r.length&&n<t.length;++a,++n)if(r[a]!==t[n]&&r[a]!==1&&t[n]!==1)throw new Error("Expand requires shape to be broadcastable to input")},js=(e,t)=>{let r=e.length-t.length,a=[];for(let n=0;n<r;++n)a.push(e[n]);for(let n=0;n<t.length;++n)a.push(t[n]===1?e[n+r]:t[n]);return a},Oc=(e,t)=>e.length>t.length?js(e,t):js(t,e),kc=e=>{let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),a=Oc(t,r),n=e[0].dataType,o=n===9?4:1,u=D.size(a)/o,l=Pe(t.length),i=Pe(a.length),c=y=>{let m=l?t.length:t,b=i?a.length:a,w=W("input",n,m,o),$=K("output",n,b,o),I;if(n===9){let x=(C,P,E="")=>`
    ...
    ${I}`},f=[{type:"uint32",data:u}];return l&&f.push(...Y(t)),i&&f.push(...Y(a)),{name:"Expand",shaderCache:{hint:`${a.length}`,inputDependencies:[l?"rank":"dims"]},getShaderSource:c,getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:f})}},Ks=e=>{Tc(e.inputs),e.compute(kc(e.inputs),{inputs:[0]})}});var Rc,Pc,Zs,Xs,Js=q(()=>{"use strict";De();ye();Re();be();Rc=e=>{if(!e||e.length!==2)throw new Error("Gather requires 2 inputs.")},Pc=(e,t)=>{let r=e[0].dims,a=e[1].dims,n=r.length,o=D.normalizeAxis(t.axis,n),u=r.slice(0);u.splice(o,1,...a);let l=r[o],i=e[0].dataType===9?4:1,c=D.size(u)/i,f=Pe(e[0].dims.length),y=f?e[0].dims.length:e[0].dims,m=Pe(e[1].dims.length),b=m?e[1].dims.length:e[1].dims,w=Pe(u.length),$=w?u.length:u,I=[{type:"uint32",data:c},{type:"int32",data:l},{type:"uint32",data:o}];f&&I.push(...Y(e[0].dims)),m&&I.push(...Y(e[1].dims)),w&&I.push(...Y(u));let x=[];x.push(f?"rank":"dims"),x.push(m?"rank":"dims");let C=P=>{let E=W("data",e[0].dataType,y,i),z=W("inputIndices",e[1].dataType,b),T=K("output",e[0].dataType,$,i),H=G=>{let re=a.length,B=`var indicesIndices${G}  = ${z.type.indices}(0);`;for(let j=0;j<re;j++)B+=`${re>1?`indicesIndices${G}[${j}]`:`indicesIndices${G}`} = ${u.length>1?`outputIndices${G}[uniforms.axis + ${j}]`:`outputIndices${G}`};`;B+=`
      ...
      ${P.mainStart()}
        ${P.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        ${N}
      }`};return{name:"Gather",shaderCache:{hint:t.cacheKey,inputDependencies:x},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:I}),getShaderSource:C}},Zs=e=>J({axis:e.axis}),Xs=(e,t)=>{let r=e.inputs;Rc(r),e.compute(Pc(e.inputs,t))}});var Bc,Mc,Qs,eu,tu=q(()=>{"use strict";ye();Re();be();Bc=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
  ...
  }`}},Qs=e=>J({axis:e.axis}),eu=(e,t)=>{let r=e.inputs;Bc(r),e.compute(Mc(e.inputs,t))}});var zc,Dc,Wc,ru,nu,au=q(()=>{"use strict";ye();Re();be();zc=e=>{if(!e)throw new Error("Input is missing");if(e.length<2||e.length>3)throw new Error("Invaid input number.");if(e.length===3&&e[2].dims.length>2)throw new Error("Invalid input shape of C");if(e[0].dataType!==e[1].dataType||e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("Input types are mismatched")},Dc=(e,t,r)=>{if(r.length===0)return"0u";let a=r.length===1&&e!==1||r.length===2&&r[0]!==e,n=r[r.length-1]!==t,o="0u";return a||(o+=`+ m * ${r[r.length-1]}u`),n||(o+="+n"),o},Wc=(e,t)=>{let r=e[0].dims.slice(),a=e[1].dims.slice(),[n,o,u]=tn.getShapeOfGemmResult(r,t.transA,a,t.transB,e.length===3?e[2].dims:void 0),l=[n,o];if(!l)throw new Error("Can't use gemm on the given tensors");let i=D.size(l),c="";t.transA&&t.transB?c="value += a[k * M + m] * b[n * K + k];":t.transA&&!t.transB?c="value += a[k * M + m] * b[k * N + n];":!t.transA&&t.transB?c="value += a[m * K + k] * b[n * K + k];":!t.transA&&!t.transB&&(c="value += a[m * K + k] * b[k * N + n];");let f=Te(e[0].dataType),y=t.alpha===1?"":"value *= alpha;",m=e.length===3?`value += beta * c[${Dc(n,o,e[2].dims)}];`:"",b=[`@group(0) @binding(0) var<storage, read> a : array<${f}>;`,`@group(0) @binding(1) var<storage, read> b : array<${f}>;`];e.length===3&&b.push(`@group(0) @binding(2) var<storage, read> c : array<${f}>;`);let w=$=>`
  const M: u32 = ${n}u;
  const N: u32 = ${o}u;
  const K: u32 = ${u}u;
...
`)}
  ...
  }`;return{name:"Gemm",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:l,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)}}),getShaderSource:w}},ru=(e,t)=>{zc(e.inputs),e.compute(Wc(e.inputs,t))},nu=e=>J(e)});var Uc,Nc,Vc,Hc,iu,ou,su=q(()=>{"use strict";De();ye();Re();be();Uc={name:"InstanceNormalization"},Nc=(e,t)=>{let r=e[0].dims,a=r,n=2,o=D.sizeToDimension(r,n),u=D.sizeFromDimension(r,n),l=r[1],i=W("x",e[0].dataType,[r[0],r[1],u]),c=W("scale",e[1].dataType,e[1].dims),f=W("bias",e[2].dataType,e[2].dims),y=K("output",e[0].dataType,[r[0],r[1],u]),m=[i,c,f,y],b=i.type.value,w=64,$=I=>`
  ...
  }`;e.compute({name:"InstanceNormalization",shaderCache:{hint:`${r.cacheKey}`},getRunData:()=>({outputs:[{dims:n,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)}}),getShaderSource:I},{inputs:[t[0],$]})},iu=e=>J({epsilon:e.epsilon,format:e.format}),ou=(e,t)=>{t.format==="NHWC"?Hc(e,e.inputs,t):e.compute(Nc(e.inputs,t))}});var Lc,Gc,uu,lu,du=q(()=>{"use strict";De();ye();Re();be();Lc=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},Gc=(e,t,r)=>{let a=e[0].dims,n=e[1],o=e[2],u=a,l=D.normalizeAxis(t.axis,a.length),i=D.sizeToDimension(a,l),c=D.sizeFromDimension(a,l),f=D.size(n.dims),y=o?D.size(o.dims):0;if(f!==c||o&&y!==c)throw new Error(`Size of X.shape()[axis:] == ${c}.
       Size of scale and bias (if provided) must match this.
       Got scale size of ${f} and bias size of ${y}`);let m=[];for(let E=0;E<a.length;++E)E<l?m.push(a[E]):m.push(1);let b=Je(c),w=Te(e[0].dataType),$=[W("x",e[0].dataType,e[0].dims,b),W("scale",n.dataType,n.dims,b)];o&&$.push(W("bias",o.dataType,o.dims,b)),$.push(K("output",e[0].dataType,u,b));let I=r>1,x=r>2;I&&$.push(K("meanDataOutput",1,m)),x&&$.push(K("invStdOutput",1,m));let C=E=>`
  ...
  }`;return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{hint:JSON.stringify({batchSize:a,sequenceLength:n,hiddenSize:o,biasOffset:u})},getRunData:()=>({outputs:[{dims:l,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(i/64)}}),getShaderSource:f},{inputs:[t,r],outputs:[-1]})[0]},pa=(e,t,r,a,n,o,u,l)=>{let i=o;if(u){if(a===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return i=jc(e,o,u,t,a,r*n,l),i=i.reshape([t,a,r,n]),e.compute(it(i,fu.perm),{inputs:[i],outputs:[-1]})[0]}else return o.dims.length===3&&(i=o.reshape([t,a,r,n])),e.compute(it(i,fu.perm),{inputs:[i],outputs:[-1]})[0]},hu=(e,t)=>{let r=qc(e.inputs,t);if(e.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(e.inputs[1]?.dims.length===5)throw new Error("Packed KV is not implemented");let a=e.inputs[1]&&e.inputs[2]&&e.inputs[1].dims.length===4&&e.inputs[2].dims.length===4,n=pa(e,r.batchSize,r.numHeads,r.sequenceLength,r.headSize,e.inputs[0],e.inputs[3],0);if(a)return sn(e,n,e.inputs[1],e.inputs[2],e.inputs[4],void 0,void 0,void 0,e.inputs[5],r,t);let o=pa(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.headSize,e.inputs[1],e.inputs[3],r.hiddenSize),u=pa(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.vHeadSize,e.inputs[2],e.inputs[3],2*r.hiddenSize);sn(e,n,o,u,e.inputs[4],void 0,e.inputs[6],e.inputs[7],e.inputs[5],r,t)}});var Kc,Yc,Zc,Xc,Jc,Qc,ep,tp,rp,yu,bu,wu=q(()=>{"use strict";De();ye();Re();be();Kc=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1)throw new Error("Input type must be float.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},Yc=(e,t,r,a,n,o)=>{let u=t.length,l="";for(let i=u-1;i>=0;--i)l+=`
...
`);case"half_pixel":return"return ((xResized + 0.5) / xScale) - 0.5;";default:throw new Error(`Coordinate transform mode ${e} is not supported`)}})()+"}",dp=(e,t,r)=>`fn getNearestPixelFromOriginal(xOriginal: ${r}, isDownSample: bool) -> ${r} {`+(()=>{switch(e){case"round_prefer_ceil":return"if (fract(xOriginal) == 0.5) {             return ceil(xOriginal);           } else {             return round(xOriginal);           }";case"floor":return"return floor(xOriginal);";case"ceil":return"return ceil(xOriginal);";case"round_prefer_floor":return"if (fract(xOriginal) == 0.5) {                     return floor(xOriginal);                   } else {                     return round(xOriginal);                   }";case"simple":default:if(t<11)return"if (isDownSample)                     {                       return ceil(xOriginal);                     } else {                       return xOriginal;                     }";throw new Error(`Nearest mode ${e} is not supported`)}})()+"}",cp=(e,t,r)=>{let a=new Array(r).fill(0).concat(new Array(r).fill(1)),n=e.length===0?a:e.slice();return t.length>0?(t.forEach((o,u)=>{a[o]=n[u],a[u+r]=n[t.length+u]}),a):n},pp=(e,t,r,a)=>{let n=[];if(r.length>0)if(a.length>0){if(e.forEach(o=>n.push(o)),Math.max(...a)>e.length)throw new Error("axes is out of bound");a.forEach((o,u)=>n[o]=r[u])}else r.forEach(o=>n.push(o));else{if(t.length===0)throw new Error("Resize requires either scales or sizes.");n=e.map((o,u)=>Math.round(o*t[u]))}return n},fp=(e,t,r)=>{let a=(()=>{switch(r.keepAspectRatioPolicy){case"not_larger":return r.axes.length>0?Math.min(...r.axes.map(o=>t[o]),Number.MAX_VALUE):Math.min(...t,Number.MAX_VALUE);case"not_smaller":return r.axes.length>0?Math.max(...r.axes.map(o=>t[o]),Number.MIN_VALUE):Math.max(...t,Number.MIN_VALUE);default:throw new Error(`Keep aspect ratio policy ${r.keepAspectRatioPolicy} is not supported`)}})();t.fill(1,0,t.length);let n=e.slice();return r.axes.length>0?(r.axes.forEach(o=>t[o]=a),r.axes.forEach(o=>n[o]=Math.round(e[o]*t[o]))):(t.fill(a,0,t.length),n.forEach((o,u)=>n[u]=Math.round(o*t[u]))),n},mp=(e,t,r,a,n)=>`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${m} {
    ...
    `},wp=(e,t,r,a,n,o)=>{let u=e.dims,l=cp(o,t.axes,u.length),i=pp(u,a,n,t.axes),c=a.slice();a.length===0&&(c=u.map((x,C)=>x===0?1:i[C]/x),t.keepAspectRatioPolicy!=="stretch"&&(i=fp(u,c,t)));let f=K("output",e.dataType,i.length),y=W("input",e.dataType,u.length),m=D.size(i),b=u.length===i.length&&u.every((x,C)=>x===i[C]),w=t.coordinateTransformMode==="tf_crop_and_resize",$=y.type.value,I=x=>`
      ...
      }`,P=[{dims:u,dataType:e[0].dataType}];return r>1&&P.push({dims:c,dataType:1}),r>2&&P.push({dims:c,dataType:1}),r>3&&P.push({dims:n,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:t.cacheKey},getShaderSource:C,getRunData:()=>({outputs:P,dispatchGroup:{x:Math.ceil(l/i/64)}})}},Vu=(e,t)=>{$p(e.inputs);let a=[0];e.outputCount>1&&a.push(-3),e.outputCount>2&&a.push(-3),e.outputCount>3&&a.push(3),e.compute(Sp(e.inputs,t,e.outputCount,!1),{outputs:a})},Hu=e=>{let t=e.epsilon;return J({epsilon:t})}});var xp,yn,_p,Gu,Cp,Ip,Fu,qu,ju=q(()=>{"use strict";De();ye();Re();be();xp=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,a)=>{if(e[a+1].dataType!==6&&e[a+1].dataType!==7)throw new Error(`Input ${a} must be an array of int32 or int64`)})},yn=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(a=>r.push(Number(a)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(a=>r.push(Number(a)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},_p=(e,t)=>{if(e.length>1){let r=yn(e,1),a=yn(e,2),n=yn(e,3);return n.length===0&&(n=[...Array(e[0].dims.length).keys()]),J({starts:r,ends:a,axes:n})}else return t},Gu=(e,t,r,a,n)=>{let o=e;return e<0&&(o+=r[a[t]]),n[t]<0?Math.max(0,Math.min(o,r[a[t]]-1)):Math.max(0,Math.min(o,r[a[t]]))},Cp=(e,t,r)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${i.length}_${u.length}_${o.length}`,inputDependencies:["rank"]},getShaderSource:I,getRunData:()=>({outputs:[f],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:$})}},Fu=(e,t)=>{xp(e.inputs,t);let r=_p(e.inputs,t);e.compute(Ip(e.inputs,r),{inputs:[0]})},qu=e=>{let t=e.starts,r=e.ends,a=e.axes;return J({starts:t,ends:r,axes:a})}});var Ep,Ap,Ku,Yu,Zu=q(()=>{"use strict";ye();Re();be();Ep=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},Ap=(e,t)=>{let r=e.dims,a=D.size(r),n=64,o=t.axis;if(o<0&&(o=r.length+o),o<r.length-1)throw new Error("softmax only supports last axis for now.");let u=r[o],l=a/u,i=Je(u),c=u/i,f=(I,x)=>x===4?`max(max(${I}.x, ${I}.y), max(${I}.z, ${I}.w))`:x===2?`max(${I}.x, ${I}.y)`:x===3?`max(max(${I}.x, ${I}.y), ${I}.z)`:I,y=W("x",e.dataType,e.dims,i),m=K("result",e.dataType,e.dims,i),b=y.type.value,w=Te(e.dataType)==="f32"?`var threadMax = ${b}(-3.402823e+38f);`:`var threadMax = ${b}(-65504.0h);`,$=I=>`
      ...
      }`;return{name:"Softmax",shaderCache:{hint:`${i}`,inputDependencies:["type"]},getRunData:()=>({outputs:[{dims:r,dataType:e.dataType}],dispatchGroup:{x:l},programUniforms:[{type:"uint32",data:c}]}),getShaderSource:$}},Ku=(e,t)=>{Ep(e.inputs),e.compute(Ap(e.inputs[0],t))},Yu=e=>J({axis:e.axis})});var Tp,Op,kp,Rp,Pp,Xu,Ju,Qu=q(()=>{"use strict";ye();Re();be();Tp=e=>{if(!e||e.length<1)throw new Error("too few inputs")},Op=(e,t)=>{let r=[],a=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(n=>r.push(Number(n))),a=r.length),J({numOutputs:a,axis:t.axis,splitSizes:r})},kp=e=>`
...
`)}
  ...
  }`;return{name:"Split",shaderCache:{hint:t.cacheKey,inputDependencies:["rank"]},getShaderSource:b,getRunData:()=>({outputs:c,dispatchGroup:{x:Math.ceil(a/64)},programUniforms:m})}},Xu=(e,t)=>{Tp(e.inputs);let r=e.inputs.length===1?t:Op(e.inputs,t);e.compute(Pp(e.inputs,r),{inputs:[0]})},Ju=e=>{let t=e.axis,r=e.splitSizes,a=e.numOutputs<0?r.length:e.numOutputs;if(a!==r.length)throw new Error("numOutputs and splitSizes lengh must be equal");return J({axis:t,numOutputs:a,splitSizes:r})}});var el,Bp,Mp,zp,tl,rl=q(()=>{"use strict";De();ye();be();el=e=>Array.from(e.getBigInt64Array(),Number),Bp=e=>{if(!e||e.length!==2)throw new Error("Tile requires 2 inputs.");if(e[0].dataType!==1&&e[0].dataType!==6&&e[0].dataType!==12)throw new Error("Tile only support float, int32, and uint32 data types");if(e[1].dataType!==7)throw new Error("Tile `repeats` input should be of int64 data type");if(e[1].dims.length!==1)throw new Error("Tile `repeats` input should be 1-D");if(el(e[1]).length!==e[0].dims.length)throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor")},Mp=(e,t)=>{let r=[];for(let a=0;a<e.length;++a)r.push(e[a]*t[a]);return r},zp=e=>{let t=e[0].dims,r=el(e[1]),a=Mp(t,r),n=D.size(a),o=e[0].dataType,u=W("input",o,t.length),l=K("output",o,a.length),i=c=>`
