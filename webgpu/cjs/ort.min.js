...
`}var Zd,Qd,Hu,ju=D(()=>{"use strict";fe();xe();ae();Tr();Zd=a=>({name:"Reshape (packed)",inputTypes:[2],inputNames:["A"],cacheHint:`${a}`}),Qd=(a,t,o,e)=>{let r=t.dims,n=e,s="";for(let l=0;l<4;l++){let f="";switch(l){case 0:f="outputCoords = rc;";break;case 1:f="outputCoords = ivec3(rc.x, rc.y+1, rc.z);";break;case 2:f="outputCoords = ivec3(rc.x, rc.y, rc.z+1);";break;case 3:f="outputCoords = ivec3(rc.x, rc.y+1, rc.z+1);";break;default:throw new Error}s+=`
  ...
  `,name:t,type:0}}var ct,vh,al,sl,ul,ll,fl,cl,pl,dl,hl,ml,bl,gl,yl=D(()=>{"use strict";fe();Ht();xe();ae();ct=(a,t,o,e=t[0].type,r)=>{let n=a.session.pack?2:0;return{name:o.name,inputNames:["A","B"],inputTypes:[n,n],cacheHint:r,get:()=>vh(a,t,o,e)}},vh=(a,t,o,e=t[0].type)=>{let r=a.session.pack?2:0,n=!U.areEqual(t[0].dims,t[1].dims),s=t[0].dims,i=a.session.pack;if(n){let f=Xe.calcShape(t[0].dims,t[1].dims,!1);if(!f)throw new Error("Can't perform binary op on the given tensors");s=f;let p=s.length,d=t[0].dims.length!==0?t[0].dims.length:1,T=t[1].dims.length!==0?t[1].dims.length:1,v=t[0].dims.length!==0?"bcastIndices_A(indices, aindices);":"aindices[0] = 0;",w=t[1].dims.length!==0?"bcastIndices_B(indices, bindices);":"bindices[0] = 0;",I=q(a.session.backend.glContext.version),L=i?`
    ...
    `;return{name:o.name,inputNames:["A","B"],inputTypes:[r,r],output:{dims:t[0].dims,type:e,textureType:r},shaderSource:l,hasMain:!0}},al=(a,t)=>[a.run(ct(a,t,lh()),t)],sl=(a,t)=>[a.run(ct(a,t,bh(),"bool"),t)],ul=(a,t)=>[a.run(ct(a,t,fh()),t)],ll=(a,t)=>[a.run(ct(a,t,dh(),"bool"),t)],fl=(a,t)=>[a.run(ct(a,t,hh(),"bool"),t)],cl=(a,t)=>[a.run(ct(a,t,mh(),"bool"),t)],pl=(a,t)=>[a.run(ct(a,t,ch()),t)],dl=(a,t)=>[a.run(ct(a,t,gh(),"bool"),t)],hl=(a,t)=>[a.run(ct(a,t,Th()),t)],ml=(a,t)=>[a.run(ct(a,t,xh()),t)],bl=(a,t)=>[a.run(ct(a,t,ph()),t)],gl=(a,t)=>[a.run(ct(a,t,yh(),"bool"),t)]});var Tl,xl,Oh,wl=D(()=>{"use strict";fe();Tl=(a,t,o)=>(Oh(t),[a.cast(t[0],o)]),xl=a=>Ve.tensorDataTypeFromProto(a.attributes.getInt("to")),Oh=a=>{if(!a||a.length!==1)throw new Error("Cast requires 1 input.");if(a[0].type==="string")throw new Error("Invalid input type.")}});var Ih,Sh,vl,ro,_l=D(()=>{"use strict";xe();ae();kt();Tr();Ih=(a,t)=>({name:"Concat (packed)",inputNames:Array.from({length:a},(o,e)=>`X${e}`),inputTypes:Array(a).fill(2),cacheHint:t}),Sh=(a,t,o,e)=>{let r=o[0].dims.slice();if(e>=r.length||e<-1*r.length)throw new Error("axis specified for concat doesn't match input dimensionality");e<0&&(e=r.length+e);let n=r.slice(0);for(let j=1;j<o.length;j++){let M=o[j].dims.slice();for(let ie=0;ie<r.length;ie++)if(ie===e)n[e]+=M[ie];else if(r[ie]!==M[ie])throw new Error("non concat dimensions must match")}let s=n.length,i=Rr("coords",s),u=Ke(s),l=Bt(),f=o.map(j=>j.dims),p=Ot(s),d=new Array(f.length-1);d[0]=f[0][e];for(let j=1;j<d.length;j++)d[j]=d[j-1]+f[j][e];let T=p[e],v=p.slice(-2),w=p.join(),I=`if (${T} < ${d[0]}) {
        ...
        `;return{...t,output:{dims:n,type:o[0].type,textureType:2},shaderSource:Y,hasMain:!0}},vl=(a,t,o)=>{let e=Ih(t.length,o.cacheKey);return{...e,get:()=>Sh(a,e,t,o.axis)}},ro=(a,t,o)=>{let e=a.indexOf(t);return a.map((n,s)=>s===e?`${n} - ${o}`:n).join()}});var Ol,Ah,Ph,Eh,Il,Dh,Lh,Fh,Sl,Ch,Al=D(()=>{"use strict";Ge();ae();_l();Ol=(a,t,o)=>(Ch(t),a.session.pack&&t[0].dims.length>1?[a.run(vl(a,t,o),t)]:[a.run(Eh(a,t,o),t)]),Ah=(a,t)=>({name:"Concat",inputNames:Array.from({length:a},(o,e)=>`X${e}`),inputTypes:Array(a).fill(0),cacheHint:t}),Ph=(a,t,o,e)=>{let r=o[0].dims.slice();if(e>=r.length||e<-1*r.length)throw new Error("axis specified for concat doesn't match input dimensionality");e<0&&(e=r.length+e);let n=r.slice(0);for(let T=1;T<o.length;T++){let v=o[T].dims.slice();for(let w=0;w<r.length;w++)if(w===e)n[e]+=v[w];else if(r[w]!==v[w])throw new Error("non concat dimensions must match")}let s=n.length,i=new Array(o.length),u=0;for(let T=0;T<i.length;++T)u+=o[T].dims[e],i[T]=u;let l="";o.length<5?l=Il(i):l=Dh(i);let f=Lh(o.length,s),p=Fh(i),d=`
        ${f}
        ${p}
        ${l}
...
`)},Sl=a=>ee({axis:a.attributes.getInt("axis")}),Ch=a=>{if(!a||a.length<1)throw new Error("too few inputs");let t=a[0].type,o=a[0].dims.length;if(t==="string")throw new Error("string tensor is not supported yet");for(let e of a){if(e.type!==t)throw new Error("input tensors should be one type");if(e.dims.length!==o)throw new Error("input tensors should have the same shape")}}});function $h(){return pt("abs")}function kh(){return pt("acos")}function Bh(){return pt("asin")}function Nh(){return pt("atan")}function Rh(){return pt("ceil")}function Mh(){return pt("cos")}function Gh(a){let t="elu";return{body:`
  ...
  `,name:a,type:0}}var Zh,De,Pl,El,Dl,Ll,Si,Fl,Cl,Qh,$l,kl,Bl,Nl,Rl,Ml,Ai,Gl,Ul,zl,Vl,Wl,Hl,ql,jl,Yl,Xl,Kl,Pi=D(()=>{"use strict";Ge();fe();Ht();xe();ae();Zh=(a,t,o,e)=>{let r=a.session.pack?2:0,n=q(a.session.backend.glContext.version);return{...t,output:{dims:o.dims,type:o.type,textureType:r},shaderSource:`
     ${e.body}
     void main() {
...
}`}var tf,rf,im,sm,oo=D(()=>{"use strict";fe();ae();kt();xr();Li();tf=(a,t,o)=>(sm(t),a.session.pack?[a.run(io(a,t,o),t)]:[a.run(Ei(t,o),t)]),rf=a=>Mr(a.attributes),im=(a,t)=>({name:"MatMul",inputNames:a?["A","B","Bias"]:["A","B"],inputTypes:a?[0,0,0]:[0,0],cacheHint:t});sm=a=>{if(!a||a.length!==2)throw new Error("MatMul requires 2 inputs.");if(a[0].dims[a[0].dims.length-1]!==a[1].dims[a[1].dims.length-2])throw new Error("shared dimension does not match.");if(a[0].type!=="float32"&&a[0].type!=="float64"||a[1].type!=="float32"&&a[1].type!=="float64")throw new Error("inputs should be float type");if(a[0].type!==a[1].type)throw new Error("inputs types should match")}});function fm(a,t,o,e){let r=[],n=[],s=o[0].dims,i=o[1].dims,u=s.length,l=i.length,f=e.length,p=f-u,d=f-l;r=s.map((F,Y)=>`coords.${t[Y+p]}`),r[u-1]="i*2",r.join(", "),n=i.map((F,Y)=>`coords.${t[Y+d]}`),n[l-2]="i*2",n.join(", ");let T=Xe.getBroadcastDims(s,e),v=Xe.getBroadcastDims(i,e),w=T.map(F=>`coords.${t[F+p]} = 0;`).join(`
  ...
  return outputValue;
      ...
      `,We=`
            ...
            void main() {
              ...
              ${F}
              ${v.output} = value;
            }`;return{...t,output:{dims:u,type:o[0].type,textureType:2},shaderSource:We,hasMain:!0}},io=(a,t,o)=>{let e=um(t.length>2,o.activationCacheKey);return{...e,get:()=>lm(a,e,t,o)}}});var nf,of=D(()=>{"use strict";no();ef();Li();nf=(a,t,o)=>{let e=t[0].dims,r=t[1].dims,n=Gr(e,r,o.dilations,o.pads,o.strides),s=a.run(Ql(a,t[0],t[1],n,o),[t[0]]),i=a.reshapePacked(t[1],[r[0],r[1]*r[2]*r[3]]),u=t.length===3?[i,s,t[2]]:[i,s],l=a.run(io(a,u,o),u);return a.reshapePacked(l,n)}});var dm,hm,af,Fi,Ci=D(()=>{"use strict";ae();dm=a=>({name:"Im2Col",inputNames:["X"],inputTypes:[0],cacheHint:a}),hm=(a,t,o,e,r,n)=>{let s=o.dims,i=e.dims,u=r.length,l=Fi(s,i,r,4),f=`
        const int XC = ${s[1]};
        const int XH = ${s[2]};
        const int XW = ${s[3]};
        ...
        `;return{...t,output:{dims:l,type:o.type,textureType:4},shaderSource:f}},af=(a,t,o,e,r)=>{let n=dm(r.cacheKey);return{...n,get:()=>hm(a,n,t,o,e,r)}},Fi=(a,t,o,e=4)=>[o[0],o[2],o[3],Math.ceil(a[1]*t[2]*t[3]/e)]});var mm,bm,sf,uf=D(()=>{"use strict";fe();xe();ae();xr();Ci();mm=(a,t)=>({name:"ConvDotProduct",inputNames:a?["Im2Col","K","B"]:["Im2Col","K"],inputTypes:a?[0,4,0]:[0,4],cacheKey:t.activationCacheKey}),bm=(a,t,o,e,r)=>{let n=o[0].dims,s=o[1].dims,i=[s[0],Math.ceil(n[1]*s[2]*s[3]/4)],u=Fi(n,s,e),[l,f]=a.calculateTextureWidthAndHeight(i,4),p=U.computeStrides(u),[d,T]=a.calculateTextureWidthAndHeight(u,4),v=e.length,w=o.length<3?"0.0":"_B(b)",I=Math.ceil(n[1]*s[2]*s[3]/4),{activationFunction:L,applyActivation:C}=Nt(r),F=q(a.session.backend.glContext.version),Y=`
${L}
...
`;return{...o,output:{dims:f,type:t[0].type,textureType:0},shaderSource:v,hasMain:!0}},Pm=(a,t,o)=>{let e=Sm(t.length>2,o.cacheKey);return{...e,get:()=>Am(a,t,e,o)}},Em=(a,t,o)=>a.run(Pm(a,t,o),t),Dm=(a,t)=>{let o=a.kernelShape.slice();if(a.kernelShape.length===0)for(let i=2;i<t[1].dims.length;++i)o.push(t[1].dims[i]);let e=a.pads.slice(),r=a.outputShape.slice(),n=t[0].dims;Om(n,o,a.dilations,a.autoPad,e,a.strides,a.outputPadding,r);let s=Object.assign({},a);return Object.assign(s,{kernelShape:o,pads:e,outputShape:r,cacheKey:a.cacheKey}),s},ff=a=>{let t=a.attributes,o=Mr(t),e=t.getString("auto_pad","NOTSET"),r=t.getInts("dilations",[1,1]),n=t.getInt("group",1),s=t.getInts("kernel_shape",[]),i=t.getInts("output_padding",[0,0]),u=t.getInts("output_shape",[]),l=t.getInts("pads",[0,0,0,0]),f=t.getInts("strides",[1,1]);return ee({autoPad:e,dilations:r,group:n,kernelShape:s,outputPadding:i,outputShape:u,pads:l,strides:f,...o})},Lm=(a,t)=>{if(!a||a.length!==2&&a.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(a[0].dims.length!==4||a[1].dims.length!==4)throw new Error("currently only support 2-dimensional conv");let o=a[0].dims[1],e=a[1].dims[0];if(o!==e)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let r=a[1].dims[1]*t.group;if(a.length===3&&(a[2].dims.length!==1||a[2].dims[0]!==r))throw new Error("invalid bias");let n=a[0].dims.length-2;if(t.dilations.length!==n)throw new Error(`dilations should be ${n}D`);if(t.strides.length!==n)throw new Error(`strides should be ${n}D`);if(t.pads.length!==n*2)throw new Error(`pads should be ${n*2}D`);if(t.outputPadding.length!==n)throw new Error(`output_padding should be ${n}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==a[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==a[0].dims.length-2)throw new Error("invalid output shape");if(a[0].type!=="float32"||a[1].type!=="float32")throw new Error("ConvTranspose input(X,W) should be float tensor");if(a.length===3&&a[2].type!=="float32")throw new Error("ConvTranspose input(bias) should be float tensor")}});var pf,wr,df,Fm,hf,Cm,$m,km,ao=D(()=>{"use strict";Ge();fe();ae();pf={name:"Transpose",inputNames:["A"],inputTypes:[0]},wr=(a,t,o)=>(km(t),[a.run({...pf,cacheHint:o.cacheKey,get:()=>Fm(a,t[0],o.perm)},t)]),df=a=>ee({perm:a.attributes.getInts("perm",[])}),Fm=(a,t,o)=>{let e=t.dims;o=hf(e,o);let r=Cm(e,o),n=e.length,s=`
      ${$m("perm",o,n)}
      float process(int indices[${n}]) {
        int a[${n}];
        perm(a, indices);
        return _A(a);
      }`;return{...pf,output:{dims:r,type:t.type,textureType:0},shaderSource:s}},hf=(a,t)=>(t&&t.length!==a.length&&(t=[...a.keys()].reverse()),t),Cm=(a,t)=>(t=hf(a,t),U.sortBasedOnPerm(a,t)),$m=(a,t,o)=>{let e=[];e.push(`void ${a}(out int a[${o}], int src[${o}]) {`);for(let r=0;r<o;++r)e.push(`	a[${t[r]}]=src[${r}];`);return e.push("	}"),e.join(`
`)},km=a=>{if(!a||a.length!==1)throw new Error("Transpose requires 1 input.");if(a[0].type!=="float32"&&a[0].type!=="float64")throw new Error("input should be float tensor")}});var mf,bf,Bm,gf=D(()=>{"use strict";ao();mf=(a,t,o)=>{Bm(t);let e=o.blocksize,r=e*e,n=o.mode==="DCR"?[0,3,4,1,5,2]:[0,1,4,2,5,3],s=o.mode==="DCR"?[t[0].dims[0],e,e,t[0].dims[1]/r,t[0].dims[2],t[0].dims[3]]:[t[0].dims[0],t[0].dims[1]/r,e,e,t[0].dims[2],t[0].dims[3]],i=a.reshapeUnpacked(t[0],s),u={perm:n,cacheKey:`${n}`},[l]=wr(a,[i],u),f=[t[0].dims[0],t[0].dims[1]/r,t[0].dims[2]*e,t[0].dims[3]*e];return[a.reshapeUnpacked(l,f)]},bf=a=>{let t=a.attributes.getInt("blocksize");if(t<1)throw new Error(`blocksize must be >= 1, but got : ${t} for DepthToSpace`);let o=a.attributes.getString("mode","DCR");if(o!=="DCR"&&o!=="CRD")throw new Error(`unrecognized mode: ${o} for DepthToSpace`);return{mode:o,blocksize:t}},Bm=a=>{if(a.length!==1)throw new Error(`DepthToSpace expect 1 inputs, but got ${a.length}`);if(a[0].type==="string"||a[0].dims.length!==4)throw new TypeError("DepthToSpace input should be a 4-D numeric tensor")}});var yf,Tf,Nm,xf=D(()=>{"use strict";fe();yf=(a,t,o)=>{Nm(t,o);let e=U.flattenShape(t[0].dims,o);return[a.reshapeUnpacked(t[0],e)]},Tf=a=>a.attributes.getInt("axis",1),Nm=(a,t)=>{if(!a||a.length!==1)throw new Error("Flatten requires 1 input.");let o=a[0].dims.length;if(o===0)throw new Error("scalar tensor is not supported.");if(t<-o||t>o)throw new Error("Invalid axis");if(a[0].type==="string")throw new Error("string tensor is not supported.")}});var er,hn=D(()=>{"use strict";er=["float32","float64","int32","int16","int8","uint16","uint32","uint8"]});var wf,vf,Rm,Mm,Gm,Um,_f=D(()=>{"use strict";Ge();hn();fe();ae();wf=(a,t,o)=>(Um(t,o.axis),[a.run(Gm(a,t,o),t)]),vf=a=>ee({axis:a.attributes.getInt("axis",0)}),Rm={name:"Gather",inputNames:["A","B"],inputTypes:[0,0]},Mm=(a,t,o,e)=>{let r=o[0].dims.slice(),n=o[1].dims.slice(),s=new Array(r.length+n.length-1);e=U.normalizeAxis(e,r.length);let i=[];for(let d=0;d<s.length;d++)d<e?(s[d]=r[d],i.push(`inputIdx[${d}] = outputIdx[${d}];`)):d<e+n.length?(s[d]=n[d-e],i.push(`indexDataIdx[${d-e}] = outputIdx[${d}];`)):(s[d]=r[d-n.length+1],i.push(`inputIdx[${d-n.length+1}] = outputIdx[${d}];`));let u=s.length||1,l=r.length,f=n.length||1,p=`
...
`)},Xm=a=>{if(!a||a.length!==1)throw new Error("ImageScaler requires 1 input.");if(a[0].dims.length!==4)throw new Error("Invalid input shape.");if(a[0].type!=="float32"&&a[0].type!=="float64")throw new Error("Invalid input type.")}});var Ff,Cf,Lf,Km,Jm,Zm,Qm,eb,tb,$f=D(()=>{"use strict";xe();ae();Ff=(a,t,o)=>{tb(t);let e=a.run(Jm(t[0]),t);return[a.run(eb(a,t[0],o,e.dims),[t[0],e,t[1],t[2]])]},Cf=a=>a.attributes.getFloat("epsilon",1e-5),Lf={name:"InstanceNormalization_MeanAndVariance",inputNames:["X"],inputTypes:[0]},Km=(a,t)=>{let o=t.dims.slice(),e=o[1],r=o[2]*o[3],n=[o[0],e],s=`
...
value = _A(inputIdx);`,"value = min(value, _A(inputIdx));",""]}),ac=(a,t,o)=>vr(a,t,o,"ReduceProd",()=>["value = 1.0;","value *= _A(inputIdx);",""]),sc=(a,t,o)=>vr(a,t,o,"ReduceLogSum",()=>["value = 0.0;","value += _A(inputIdx);","value = log(value);"]),uc=(a,t,o)=>vr(a,t,o,"ReduceLogSumSquare",()=>["float t; value = 0.0;","t = _A(inputIdx); value += t * t;",""])});var fc,cc=D(()=>{"use strict";fe();fc=(a,t)=>{let o=U.calculateReshapedDims(t[0].dims,t[1].integerData);return a.session.pack?[a.reshapePacked(t[0],o)]:[a.reshapeUnpacked(t[0],o)]}});var pc,Ri,dc,hc,mn,yb,Mi,lo,Gi=D(()=>{"use strict";Ge();xe();ae();pc={name:"Upsample",inputNames:["X"],inputTypes:[0]},Ri=(a,t,o)=>(Mi(t,o),[a.run({...pc,cacheHint:o.cacheKey,get:()=>yb(a,t,o)},t)]),dc=a=>mn(a,7),hc=a=>mn(a,9),mn=(a,t)=>{let o=t>=10,e=a.attributes.getString("mode","nearest");if(e!=="nearest"&&e!=="linear"&&(t<11||e!=="cubic"))throw new Error(`unrecognized mode: ${e}`);let r=[];t<9&&(r=a.attributes.getFloats("scales"),lo(r,e,o));let n=a.attributes.getFloat("extrapolation_value",0),s=t>10?a.attributes.getString("coordinate_transformation_mode","half_pixel"):"asymmetric";if(["asymmetric","pytorch_half_pixel","tf_half_pixel_for_nn","align_corners","tf_crop_and_resize","half_pixel"].indexOf(s)===-1)throw new Error(`coordinate_transform_mode '${s}' is not supported`);let i=s==="tf_crop_and_resize",u=i,l=e==="nearest"&&t>=11?a.attributes.getString("nearest_mode","round_prefer_floor"):"";if(["round_prefer_floor","round_prefer_ceil","floor","ceil",""].indexOf(l)===-1)throw new Error(`nearest_mode '${l}' is not supported`);let f=a.attributes.getFloat("cubic_coeff_a",-.75),p=a.attributes.getInt("exclude_outside",0)!==0;if(p&&e!=="cubic")throw new Error("exclude_outside can be set to 1 only when mode is CUBIC.");let d=t<11?!0:e==="nearest"&&s==="asymmetric"&&l==="floor",T=0,v=0,w=0;return t>10?a.inputs.length>2?(T=1,v=2,w=3):(v=1,w=2):t===9&&(v=1),ee({opset:t,isResize:o,mode:e,scales:r,extrapolationValue:n,coordinateTransformMode:s,useExtrapolation:u,needRoiInput:i,nearestMode:l,cubicCoefficientA:f,excludeOutside:p,useNearest2xOptimization:d,roiInputIdx:T,scalesInputIdx:v,sizesInputIdx:w})},yb=(a,t,o)=>{let e=q(a.session.backend.glContext.version),[r,n]=a.calculateTextureWidthAndHeight(t[0].dims,0),s=t[0].dims.map((w,I)=>Math.floor(w*o.scales[I])),[i,u]=a.calculateTextureWidthAndHeight(s,0),l=s.length,f=new Array(l),p=new Array(l),d=`
    ...
    }`;return{...pc,output:{dims:s,type:t[0].type,textureType:0},shaderSource:v,variables:[{name:"scales",type:"int",arrayLength:o.scales.length,data:o.scales.map(w=>Math.ceil(w))}]}},Mi=(a,t)=>{if(!a||t.opset<9&&a.length!==1||t.opset>=9&&t.opset<11&&a.length!==2||t.opset>=11&&a.length<2)throw new Error("invalid inputs.");if(t.scales.length>0&&a[0].dims.length!==t.scales.length)throw new Error("Invalid input shape.");if(a[0].type==="string")throw new Error("Invalid input tensor types.")},lo=(a,t,o)=>{if(o){for(let e of a)if(e<=0)throw new Error("Scale value should be greater than 0.")}else for(let e of a)if(e<1)throw new Error("Scale value should be greater than or equal to 1.");if((t==="linear"||t==="cubic")&&a.length!==2&&(a.length!==4||a[0]!==1||a[1]!==1))throw new Error(`'Linear' mode and 'Cubic' mode only support 2-D inputs ('Bilinear', 'Bicubic')         or 4-D inputs with the corresponding outermost 2 scale values being 1         in the ${o?"Resize":"Upsample"} opeartor.`)}});var Ui,zi,mc,bc,Tb,xb,wb,vb,gc=D(()=>{"use strict";xe();ae();kt();Tr();Gi();Ui={name:"Resize",inputNames:["A"],inputTypes:[2]},zi=(a,t,o)=>(Mi(t,o),[a.run({...Ui,cacheHint:o.cacheKey,get:()=>Tb(a,t,o)},t)]),mc=a=>mn(a,10),bc=a=>mn(a,11),Tb=(a,t,o)=>{let e=q(a.session.backend.glContext.version),[r,n]=xb(t,o);if(r.every(F=>F===1)&&o.coordinateTransformMode!=="tf_crop_and_resize")return{...Ui,output:{dims:n,type:t[0].type,textureType:2},hasMain:!0,shaderSource:`void main() {
    ...
    }`;return{...Ac,output:{dims:t.dims,type:t.type,textureType:0},shaderSource:l}},Cc=a=>{if(!a||a.length!==1)throw new Error("Softmax requires 1 input.");if(a[0].type!=="float32"&&a[0].type!=="float64")throw new Error("Invalid input type")}});var kc,Bc,Nc,Db,Lb,Fb,Rc=D(()=>{"use strict";Ge();fe();ae();kc={name:"Split",inputNames:["A"],inputTypes:[0]},Bc=(a,t,o)=>{Fb(t);let e=U.normalizeAxis(o.axis,t[0].dims.length),r=Db(a,t,e,o),n=[];for(let s=0;s<r;++s)n.push(a.run({...kc,cacheHint:`${o.cacheKey};${s}`,get:()=>Lb(a,t[0],o,e,s)},t));return n},Nc=a=>{let t=a.attributes.getInt("axis",0),o=a.attributes.getInts("split",[]),e=a.outputs.length;return ee({axis:t,split:o,numOutputs:e})},Db=(a,t,o,e)=>{let[,r]=un.splitShape(t[0].dims,o,e.split,e.numOutputs);return r.length},Lb=(a,t,o,e,r)=>{let[n,s]=un.splitShape(t.dims,e,o.split,o.numOutputs),i=s[r],u=n[r],f=`
      float process(int indices[${u.length}]) {
        indices[${e}] += ${i};
        return _A(indices);
      }
    `;return{...kc,cacheHint:`${o.cacheKey}:${r}`,output:{dims:u,type:t.type,textureType:0},shaderSource:f}},Fb=a=>{if(!a||a.length!==1)throw new Error("Split requires one input.");if(a[0].type!=="int8"&&a[0].type!=="uint8"&&a[0].type!=="int16"&&a[0].type!=="uint16"&&a[0].type!=="int32"&&a[0].type!=="uint32"&&a[0].type!=="float32"&&a[0].type!=="float64"&&a[0].type!=="bool")throw new Error("Invalid input type.")}});var Wi,Mc,Gc,Cb,$b,Uc=D(()=>{"use strict";fe();Wi=(a,t,o)=>{Cb(t);let e=U.squeezeShape(t[0].dims,o);return[a.reshapeUnpacked(t[0],e)]},Mc=(a,t)=>($b(t),Wi(a,[t[0]],Array.from(t[1].integerData))),Gc=a=>a.attributes.getInts("axes"),Cb=a=>{if(!a||a.length!==1)throw new Error("Squeeze requires 1 input.");if(a[0].type==="string")throw new Error("invalid input tensor types.")},$b=a=>{if(!a||a.length!==2)throw new Error("Squeeze requires 2 inputs.");if(a[1].type!=="int32")throw new Error("Invalid input type.")}});var zc,kb,Bb,Vc=D(()=>{"use strict";xe();ae();zc=(a,t)=>{Bb(t);let o={name:"Sum",inputNames:t.map((r,n)=>`X${n}`),inputTypes:new Array(t.length).fill(0)};return[a.run({...o,get:()=>kb(a,t,o)},t)]},kb=(a,t,o)=>{let e=q(a.session.backend.glContext.version),r=t[0].dims.slice(),s=`
      void main() {
...
`)}
    ...
    `;return{...o,output:{dims:r,type:t[0].type,textureType:0},shaderSource:i}},Rb=a=>{if(!a||a.length!==2)throw new Error("Tile requires 2 input.");if(a[1].dims.length!==1)throw new Error("The second input shape must 1 dimension.");if(a[1].dims[0]!==a[0].dims.length)throw new Error("Invalid input shape.");if(er.indexOf(a[0].type)===-1)throw new Error("Invalid input type.");if(a[1].type!=="int32"&&a[1].type!=="int16")throw new Error("Invalid repeat type.")}});var Hi,qc,jc,Mb,Gb,Yc=D(()=>{"use strict";fe();Hi=(a,t,o)=>{Mb(t);let e=U.unsqueezeShape(t[0].dims,o);return[a.reshapeUnpacked(t[0],e)]},qc=(a,t)=>(Gb(t),Hi(a,[t[0]],Array.from(t[1].integerData))),jc=a=>a.attributes.getInts("axes"),Mb=a=>{if(!a||a.length!==1)throw new Error("Unsqueeze requires 1 input.");if(a[0].type==="string")throw new Error("invalid input tensor types.")},Gb=a=>{if(!a||a.length!==2)throw new Error("Unsqueeze requires 2 inputs.");if(a[1].type!=="int32")throw new Error("Invalid input type.")}});var Xc,Kc=D(()=>{"use strict";il();yl();wl();Al();no();cf();gf();xf();_f();Af();Df();$f();Rf();oo();zf();tc();lc();cc();gc();Tc();Oc();$c();Rc();Uc();Vc();Hc();ao();Pi();Yc();Gi();Xc=[["Abs","","6+",Pl],["Acos","","7+",El],["Add","","7+",al],["And","","7+",sl],["Asin","","7+",Dl],["Atan","","7+",Ll],["AveragePool","","7+",Wf,Hf],["BatchNormalization","","7+",nl,ol],["Cast","","6+",Tl,xl],["Ceil","","6+",$l],["Clip","","6-10",Si,Fl],["Clip","","11+",Cl],["Concat","","4+",Ol,Sl],["Conv","","1+",$i,ki],["ConvTranspose","","1+",lf,ff],["Cos","","7+",kl],["Div","","7+",ul],["Dropout","","7+",Ai],["DepthToSpace","","1+",mf,bf],["Equal","","7+",ll],["Elu","","6+",Bl,Nl],["Exp","","6+",Rl],["Flatten","","1+",yf,Tf],["Floor","","6+",Ml],["FusedConv","com.microsoft","1+",$i,ki],["Gather","","1+",wf,vf],["Gemm","","7-10",Bi,If],["Gemm","","11+",Bi,Sf],["GlobalAveragePool","","1+",jf,Yf],["GlobalMaxPool","","1+",Qf],["Greater","","7+",fl],["Identity","","1+",Ai],["ImageScaler","","1+",Pf,Ef],["InstanceNormalization","","6+",Ff,Cf],["LeakyRelu","","6+",Gl,Ul],["Less","","7+",cl],["LRN","","1+",kf,Bf],["Log","","6+",zl],["MatMul","","1+",tf,rf],["MaxPool","","1+",Xf,Kf],["Mul","","7+",pl],["Neg","","6+",Vl],["Not","","1+",Wl],["Or","","7+",dl],["Pad","","2-10",Ni,Mf],["Pad","","11+",Gf,Uf],["Pow","","7+",hl],["PRelu","","7+",ml],["ReduceLogSum","","1+",sc,tr],["ReduceMax","","1+",oc,tr],["ReduceMean","","1+",nc,tr],["ReduceMin","","1+",ic,tr],["ReduceProd","","1+",ac,tr],["ReduceSum","","1-12",rc,tr],["ReduceSumSquare","","1+",uc,tr],["Relu","","6+",Hl],["Reshape","","5+",fc],["Resize","","10",zi,mc],["Resize","","11+",zi,bc],["Shape","","1+",yc],["Sigmoid","","6+",ql],["Sin","","7+",jl],["Slice","","10+",_c],["Slice","","1-9",xc,wc],["Softmax","","1-12",Pc,Ec],["Softmax","","13+",Lc,Dc],["Split","","2-12",Bc,Nc],["Sqrt","","6+",Yl],["Squeeze","","1-12",Wi,Gc],["Squeeze","","13+",Mc],["Sub","","7+",bl],["Sum","","6+",zc],["Tan","","7+",Xl],["Tanh","","6+",Kl],["Tile","","6+",Wc],["Transpose","","1+",wr,df],["Upsample","","7-8",Ri,dc],["Upsample","","9",Ri,hc],["Unsqueeze","","1-12",Hi,jc],["Unsqueeze","","13+",qc],["Xor","","7+",gl]]});function Zc(a){let t={},o;for(;(o=Jc.exec(a))!==null;){let e=o[3].split(",").map(r=>{let n=r.trim().split(" ");return n&&n.length===2?{type:n[0],name:n[1]}:null}).filter(r=>r!==null);t[o[2]]={params:e,body:o[4]}}for(let e in t){let r=Ub.replace("__FUNC__",e),n=new RegExp(r,"gm");for(;(o=n.exec(a))!==null;){let s=o[1],i=o[2],u=o[3].split(","),l=s?`${s} ${i};`:"",f=t[e].body,p="";t[e].params.forEach((T,v)=>{T&&(p+=`${T.type} ${T.name} = ${u[v]};
`)}),f=`${p}
 ${f}`,f=f.replace("return",`${i} = `);let d=`
    ...
    `),e="packedUVfrom1D",o[e]=new R(`
      ...
      `),e="sampleTexture";let r=q(this.context.glContext.version);return o[e]=new R(`
        ...
        }`),o}getInputsSamplingSnippets(){let o={},e=this.context.outputTextureLayout;return this.context.programInfo.inputNames.forEach((r,n)=>{let s=this.context.inputTextureLayouts[n],i=Kn(r);s.isPacked?o[i]=this.getPackedSamplerFromInput(i,r,s):o[i]=this.getUnpackedSamplerFromInput(i,r,s);let u=Uu(r);s.unpackedShape.length<=e.unpackedShape.length&&(s.isPacked?o[u]=this.getPackedSamplerAtOutputCoords(u,s,e,r):o[u]=this.getUnpackedSamplerAtOutputCoords(u,s,e,r))}),o}getPackedSamplerAtOutputCoords(o,e,r,n){let s=e.unpackedShape,i=r.unpackedShape,l=Kn(n),f=s.length,p=i.length,d=Xe.getBroadcastDims(s,i),T=Ke(p),v=p-f,w,I=Ot();f===0?w="":p<2&&d.length>=1?w="coords = 0;":w=d.map(We=>`coords.${I[We+v]} = 0;`).join(`
