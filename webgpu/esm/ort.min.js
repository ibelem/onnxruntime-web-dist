...
`)},Ol=a=>ee({axis:a.attributes.getInt("axis")}),Fh=a=>{if(!a||a.length<1)throw new Error("too few inputs");let t=a[0].type,o=a[0].dims.length;if(t==="string")throw new Error("string tensor is not supported yet");for(let e of a){if(e.type!==t)throw new Error("input tensors should be one type");if(e.dims.length!==o)throw new Error("input tensors should have the same shape")}}});function $h(){return pt("abs")}function kh(){return pt("acos")}function Bh(){return pt("asin")}function Nh(){return pt("atan")}function Rh(){return pt("ceil")}function Mh(){return pt("cos")}function Gh(a){let t="elu";return{body:`
  ...
  `,name:t,type:0}}function Uh(){return pt("exp")}function zh(){return pt("floor")}function wi(a,t){let o="clip";return{body:`
  ...
  `,name:a,type:0}}var Zh,De,Sl,Al,Pl,El,Ii,Dl,Ll,Qh,Cl,Fl,$l,kl,Bl,Nl,Si,Rl,Ml,Gl,Ul,zl,Vl,Wl,Hl,ql,jl,Yl,Ai=D(()=>{"use strict";Ge();fe();Ht();xe();ae();Zh=(a,t,o,e)=>{let r=a.session.pack?2:0,n=q(a.session.backend.glContext.version);return{...t,output:{dims:o.dims,type:o.type,textureType:r},shaderSource:`
     ${e.body}
     void main() {
     ...
     `,hasMain:!0}},De=(a,t,o,e)=>{let r=a.session.pack?2:0,n={name:o.name,inputTypes:[r],inputNames:["A"],cacheHint:e};return{...n,get:()=>Zh(a,n,t,o)}},Sl=(a,t)=>[a.run(De(a,t[0],$h()),t)],Al=(a,t)=>[a.run(De(a,t[0],kh()),t)],Pl=(a,t)=>[a.run(De(a,t[0],Bh()),t)],El=(a,t)=>[a.run(De(a,t[0],Nh()),t)],Ii=(a,t,o)=>[a.run(De(a,t[0],wi(o.min,o.max),o.cacheKey),t)],Dl=a=>ee({min:a.attributes.getFloat("min",hr),max:a.attributes.getFloat("max",mr)}),Ll=(a,t)=>{let o=Qh(a,t);return Ii(a,[t[0]],o)},Qh=(a,t)=>{if(t.length>=3&&(!a.session.isInitializer(t[1].dataId)||!a.session.isInitializer(t[2].dataId)))throw new Error("dynamic clip attributes are not allowed");let o=t.length>=3?t[1].numberData[0]:hr,e=t.length>=3?t[2].numberData[0]:mr;return ee({min:o,max:e})},Cl=(a,t)=>[a.run(De(a,t[0],Rh()),t)],Fl=(a,t)=>[a.run(De(a,t[0],Mh()),t)],$l=(a,t,o)=>[a.run(De(a,t[0],Gh(o.alpha),o.cacheKey),t)],kl=a=>ee({alpha:a.attributes.getFloat("alpha",1)}),Bl=(a,t)=>[a.run(De(a,t[0],Uh()),t)],Nl=(a,t)=>[a.run(De(a,t[0],zh()),t)],Si=(a,t)=>[a.run(De(a,t[0],Vh()),t)],Rl=(a,t,o)=>[a.run(De(a,t[0],Wh(o.alpha),o.cacheKey),t)],Ml=a=>ee({alpha:a.attributes.getFloat("alpha",.01)}),Gl=(a,t)=>[a.run(De(a,t[0],Hh()),t)],Ul=(a,t)=>[a.run(De(a,t[0],qh()),t)],zl=(a,t)=>[a.run(De(a,t[0],jh()),t)],Vl=(a,t)=>[a.run(De(a,t[0],_i()),t)],Wl=(a,t)=>[a.run(De(a,t[0],Oi()),t)],Hl=(a,t)=>[a.run(De(a,t[0],Yh()),t)],ql=(a,t)=>[a.run(De(a,t[0],Xh()),t)],jl=(a,t)=>[a.run(De(a,t[0],Kh()),t)],Yl=(a,t)=>[a.run(De(a,t[0],Jh()),t)]});function Nt(a){let t;switch(a.activation){case"Relu":t=_i();break;case"Sigmoid":t=Oi();break;case"Clip":t=wi(a.clipMin,a.clipMax);break;default:return{activationFunction:"",applyActivation:""}}let o=t.name,e=t.body,r=`value = ${o}_(value);`;return{activationFunction:e,applyActivation:r}}var Mr,yr=D(()=>{"use strict";fe();Ai();Mr=a=>{let t=a.getString("activation","");if(t==="Clip"){let[o,e]=a.getFloats("activation_params",[hr,mr]);return{activation:t,clipMax:e,clipMin:o,activationCacheKey:`${t}:${o},${e}`}}return{activation:t,activationCacheKey:t}}});var tm,rm,Xl,Kl=D(()=>{"use strict";at();xe();ae();no();yr();tm=(a,t)=>({name:"GroupedConv",inputNames:a?["X","W","Bias"]:["X","W"],inputTypes:a?[0,0,0]:[0,0],cacheHint:t}),rm=(a,t,o,e)=>{let n=t.length>2?"value += getBias(output_channel);":"",s=t[0].dims.slice(),i=t[1].dims.slice(),u=i[0]/e.group;ce.verbose("GroupedConv",`autpPad:${e.autoPad}, dilations:${e.dilations}, group:${e.group}, kernelShape:${e.kernelShape}, pads:${e.pads}, strides:${e.strides}`);let l=Gr(s,i,e.dilations,e.pads,e.strides),f=q(a.session.backend.glContext.version),{activationFunction:p,applyActivation:d}=Nt(e),T=`
...
}`}var Ql,ef,im,sm,oo=D(()=>{"use strict";fe();ae();kt();yr();Di();Ql=(a,t,o)=>(sm(t),a.session.pack?[a.run(io(a,t,o),t)]:[a.run(Pi(t,o),t)]),ef=a=>Mr(a.attributes),im=(a,t)=>({name:"MatMul",inputNames:a?["A","B","Bias"]:["A","B"],inputTypes:a?[0,0,0]:[0,0],cacheHint:t});sm=a=>{if(!a||a.length!==2)throw new Error("MatMul requires 2 inputs.");if(a[0].dims[a[0].dims.length-1]!==a[1].dims[a[1].dims.length-2])throw new Error("shared dimension does not match.");if(a[0].type!=="float32"&&a[0].type!=="float64"||a[1].type!=="float32"&&a[1].type!=="float64")throw new Error("inputs should be float type");if(a[0].type!==a[1].type)throw new Error("inputs types should match")}});function fm(a,t,o,e){let r=[],n=[],s=o[0].dims,i=o[1].dims,u=s.length,l=i.length,f=e.length,p=f-u,d=f-l;r=s.map((C,Y)=>`coords.${t[Y+p]}`),r[u-1]="i*2",r.join(", "),n=i.map((C,Y)=>`coords.${t[Y+d]}`),n[l-2]="i*2",n.join(", ");let T=Xe.getBroadcastDims(s,e),w=Xe.getBroadcastDims(i,e),v=T.map(C=>`coords.${t[C+p]} = 0;`).join(`
  ...
  return outputValue;
      ...
      `,We=`
            ...
            void main() {
              ...
              ${C}
              ${w.output} = value;
            }`;return{...t,output:{dims:u,type:o[0].type,textureType:2},shaderSource:We,hasMain:!0}},io=(a,t,o)=>{let e=um(t.length>2,o.activationCacheKey);return{...e,get:()=>lm(a,e,t,o)}}});var tf,rf=D(()=>{"use strict";no();Zl();Di();tf=(a,t,o)=>{let e=t[0].dims,r=t[1].dims,n=Gr(e,r,o.dilations,o.pads,o.strides),s=a.run(Jl(a,t[0],t[1],n,o),[t[0]]),i=a.reshapePacked(t[1],[r[0],r[1]*r[2]*r[3]]),u=t.length===3?[i,s,t[2]]:[i,s],l=a.run(io(a,u,o),u);return a.reshapePacked(l,n)}});var dm,hm,nf,Li,Ci=D(()=>{"use strict";ae();dm=a=>({name:"Im2Col",inputNames:["X"],inputTypes:[0],cacheHint:a}),hm=(a,t,o,e,r,n)=>{let s=o.dims,i=e.dims,u=r.length,l=Li(s,i,r,4),f=`
        const int XC = ${s[1]};
        const int XH = ${s[2]};
        const int XW = ${s[3]};
...
value = _A(inputIdx);`,"value = min(value, _A(inputIdx));",""]}),oc=(a,t,o)=>xr(a,t,o,"ReduceProd",()=>["value = 1.0;","value *= _A(inputIdx);",""]),ic=(a,t,o)=>xr(a,t,o,"ReduceLogSum",()=>["value = 0.0;","value += _A(inputIdx);","value = log(value);"]),ac=(a,t,o)=>xr(a,t,o,"ReduceLogSumSquare",()=>["float t; value = 0.0;","t = _A(inputIdx); value += t * t;",""])});var uc,lc=D(()=>{"use strict";fe();uc=(a,t)=>{let o=U.calculateReshapedDims(t[0].dims,t[1].integerData);return a.session.pack?[a.reshapePacked(t[0],o)]:[a.reshapeUnpacked(t[0],o)]}});var fc,Ni,cc,pc,mn,yb,Ri,lo,Mi=D(()=>{"use strict";Ge();xe();ae();fc={name:"Upsample",inputNames:["X"],inputTypes:[0]},Ni=(a,t,o)=>(Ri(t,o),[a.run({...fc,cacheHint:o.cacheKey,get:()=>yb(a,t,o)},t)]),cc=a=>mn(a,7),pc=a=>mn(a,9),mn=(a,t)=>{let o=t>=10,e=a.attributes.getString("mode","nearest");if(e!=="nearest"&&e!=="linear"&&(t<11||e!=="cubic"))throw new Error(`unrecognized mode: ${e}`);let r=[];t<9&&(r=a.attributes.getFloats("scales"),lo(r,e,o));let n=a.attributes.getFloat("extrapolation_value",0),s=t>10?a.attributes.getString("coordinate_transformation_mode","half_pixel"):"asymmetric";if(["asymmetric","pytorch_half_pixel","tf_half_pixel_for_nn","align_corners","tf_crop_and_resize","half_pixel"].indexOf(s)===-1)throw new Error(`coordinate_transform_mode '${s}' is not supported`);let i=s==="tf_crop_and_resize",u=i,l=e==="nearest"&&t>=11?a.attributes.getString("nearest_mode","round_prefer_floor"):"";if(["round_prefer_floor","round_prefer_ceil","floor","ceil",""].indexOf(l)===-1)throw new Error(`nearest_mode '${l}' is not supported`);let f=a.attributes.getFloat("cubic_coeff_a",-.75),p=a.attributes.getInt("exclude_outside",0)!==0;if(p&&e!=="cubic")throw new Error("exclude_outside can be set to 1 only when mode is CUBIC.");let d=t<11?!0:e==="nearest"&&s==="asymmetric"&&l==="floor",T=0,w=0,v=0;return t>10?a.inputs.length>2?(T=1,w=2,v=3):(w=1,v=2):t===9&&(w=1),ee({opset:t,isResize:o,mode:e,scales:r,extrapolationValue:n,coordinateTransformMode:s,useExtrapolation:u,needRoiInput:i,nearestMode:l,cubicCoefficientA:f,excludeOutside:p,useNearest2xOptimization:d,roiInputIdx:T,scalesInputIdx:w,sizesInputIdx:v})},yb=(a,t,o)=>{let e=q(a.session.backend.glContext.version),[r,n]=a.calculateTextureWidthAndHeight(t[0].dims,0),s=t[0].dims.map((v,I)=>Math.floor(v*o.scales[I])),[i,u]=a.calculateTextureWidthAndHeight(s,0),l=s.length,f=new Array(l),p=new Array(l),d=`
    ...
    }`;return{...Ic,output:{dims:t.dims,type:t.type,textureType:0},shaderSource:l}},Lc=a=>{if(!a||a.length!==1)throw new Error("Softmax requires 1 input.");if(a[0].type!=="float32"&&a[0].type!=="float64")throw new Error("Invalid input type")}});var Fc,$c,kc,Db,Lb,Cb,Bc=D(()=>{"use strict";Ge();fe();ae();Fc={name:"Split",inputNames:["A"],inputTypes:[0]},$c=(a,t,o)=>{Cb(t);let e=U.normalizeAxis(o.axis,t[0].dims.length),r=Db(a,t,e,o),n=[];for(let s=0;s<r;++s)n.push(a.run({...Fc,cacheHint:`${o.cacheKey};${s}`,get:()=>Lb(a,t[0],o,e,s)},t));return n},kc=a=>{let t=a.attributes.getInt("axis",0),o=a.attributes.getInts("split",[]),e=a.outputs.length;return ee({axis:t,split:o,numOutputs:e})},Db=(a,t,o,e)=>{let[,r]=un.splitShape(t[0].dims,o,e.split,e.numOutputs);return r.length},Lb=(a,t,o,e,r)=>{let[n,s]=un.splitShape(t.dims,e,o.split,o.numOutputs),i=s[r],u=n[r],f=`
      float process(int indices[${u.length}]) {
        indices[${e}] += ${i};
        return _A(indices);
      }
    `;return{...Fc,cacheHint:`${o.cacheKey}:${r}`,output:{dims:u,type:t.type,textureType:0},shaderSource:f}},Cb=a=>{if(!a||a.length!==1)throw new Error("Split requires one input.");if(a[0].type!=="int8"&&a[0].type!=="uint8"&&a[0].type!=="int16"&&a[0].type!=="uint16"&&a[0].type!=="int32"&&a[0].type!=="uint32"&&a[0].type!=="float32"&&a[0].type!=="float64"&&a[0].type!=="bool")throw new Error("Invalid input type.")}});var Vi,Nc,Rc,Fb,$b,Mc=D(()=>{"use strict";fe();Vi=(a,t,o)=>{Fb(t);let e=U.squeezeShape(t[0].dims,o);return[a.reshapeUnpacked(t[0],e)]},Nc=(a,t)=>($b(t),Vi(a,[t[0]],Array.from(t[1].integerData))),Rc=a=>a.attributes.getInts("axes"),Fb=a=>{if(!a||a.length!==1)throw new Error("Squeeze requires 1 input.");if(a[0].type==="string")throw new Error("invalid input tensor types.")},$b=a=>{if(!a||a.length!==2)throw new Error("Squeeze requires 2 inputs.");if(a[1].type!=="int32")throw new Error("Invalid input type.")}});var Gc,kb,Bb,Uc=D(()=>{"use strict";xe();ae();Gc=(a,t)=>{Bb(t);let o={name:"Sum",inputNames:t.map((r,n)=>`X${n}`),inputTypes:new Array(t.length).fill(0)};return[a.run({...o,get:()=>kb(a,t,o)},t)]},kb=(a,t,o)=>{let e=q(a.session.backend.glContext.version),r=t[0].dims.slice(),s=`
      void main() {
 ...
 ${f}`,f=f.replace("return",`${i} = `);let d=`
    ...
    `),e="packedUVfrom1D",o[e]=new R(`
      ...
      `),e="sampleTexture";let r=q(this.context.glContext.version);return o[e]=new R(`
        ...
        }`),o}getInputsSamplingSnippets(){let o={},e=this.context.outputTextureLayout;return this.context.programInfo.inputNames.forEach((r,n)=>{let s=this.context.inputTextureLayouts[n],i=Kn(r);s.isPacked?o[i]=this.getPackedSamplerFromInput(i,r,s):o[i]=this.getUnpackedSamplerFromInput(i,r,s);let u=Mu(r);s.unpackedShape.length<=e.unpackedShape.length&&(s.isPacked?o[u]=this.getPackedSamplerAtOutputCoords(u,s,e,r):o[u]=this.getUnpackedSamplerAtOutputCoords(u,s,e,r))}),o}getPackedSamplerAtOutputCoords(o,e,r,n){let s=e.unpackedShape,i=r.unpackedShape,l=Kn(n),f=s.length,p=i.length,d=Xe.getBroadcastDims(s,i),T=Ke(p),w=p-f,v,I=Ot();f===0?v="":p<2&&d.length>=1?v="coords = 0;":v=d.map(We=>`coords.${I[We+w]} = 0;`).join(`
...
`);let F="";l<2&&u>0?F="coords":F=e.unpackedShape.map((Y,j)=>`coords.${L[j+v]}`).join(", ");let C=`
    ...
    }`;return new R(l,["coordinates.packedUVfrom1D"])}getPackedSampler2D(o,e,r){let n=r.unpackedShape,s=[r.width,r.height],i=q(this.context.glContext.version),u=s[0],l=s[1];if(s!=null&&pr.arraysEqual(n,s)){let w=`vec4 ${o}(int row, int col) {
      ...
      `;return new R(i,["coordinates.uvFromFlat","coordinates.sampleTexture"])}getUnpackedSampler2D(o,e,r){let n=r.unpackedShape,s=[r.height,r.width];if(s!=null&&pr.arraysEqual(n,s)){let T=s[1],w=s[0],v=`
