...
`)},type:m,offsetToIndices:E,indicesToOffset:W,broadcastedIndicesToOffset:q,indices:N,indicesGet:F,indicesSet:te,set:(...G)=>{if(G.length!==u+1)throw new Error(`indices length must be ${u}`);let de=G[u];if(typeof de!="string")throw new Error("value must be string");let me=G.slice(0,u).map(w).join(",");return u===0?pe("0u",de):u===1?pe(me[0],de):(b.set=!0,b.setByIndices=!0,b.indicesToOffset=!0,`set_${e}(${me}, ${de})`)},setByOffset:pe,setByIndices:(G,de)=>u<2?pe(G,de):(b.setByIndices=!0,b.indicesToOffset=!0,`set_${e}ByIndices(${G}, ${de});`),get:Se,getByOffset:X,getByIndices:Ce,usage:a,name:e,strides:x,shape:I,rank:u}},V=(e,t,r,a=1)=>Qn(e,t,r,"input",a),K=(e,t,r,a=1)=>Qn(e,t,r,"output",a),Zo=(e,t,r,a=1)=>Qn(e,t,r,"internal",a),Zn=class{constructor(t){this.normalizedDispatchGroup=t;this.internalVariables=[];this.variables=[];this.uniforms=[];this.variableIndex=0}guardAgainstOutOfBoundsWorkgroupSizes(t){return`if (global_idx >= ${typeof t=="number"?`${t}u`:t}) { return; }`}mainStart(t=gd){let r=typeof t=="number"?t:t[0],a=typeof t=="number"?1:t[1],n=typeof t=="number"?1:t[2],i=this.normalizedDispatchGroup[1]===1&&this.normalizedDispatchGroup[2]===1,u=i?`@builtin(global_invocation_id) global_id : vec3<u32>,
...
`)}},Qo=e=>new Zn(e),Xn=(e,t)=>{let r=e.length,a=[];for(let n=0;n<r;n++){let i=r-1-n,u=e[i]||1;(t[t.length-1-n]||1)>1&&u===1&&a.unshift(i)}return a},Re=e=>!0});var yd,Xo,bd,wd,ot,Jo,ei,Qt=j(()=>{"use strict";ye();ke();be();yd=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},Xo=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,bd=(e,t)=>z.sortBasedOnPerm(e,Xo(e.length,t)),wd=(e,t,r,a)=>{let n=[];n.push(`fn perm(i: ${a.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`);for(let i=0;i<t;++i)n.push(r.indicesSet("a",e[i],`i[${i}]`));return n.push("return a;}"),n.join(`
`)},ot=(e,t)=>{let r=e.dataType,a=e.dims.length,n=Xo(a,t),i=Re(a),u=bd(e.dims,n),l=i?u.length:u,o=i?a:e.dims,c=K("output",r,l),f=V("a",r,o),y=m=>`
...
var bestIndex : i32 = 0;`,`if (${a.getByOffset("inputOffset")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`;e.compute({name:"AttentionProbsSoftmax",shaderCache:{hint:`${a}`},getShaderSource:y,getRunData:()=>({outputs:[],dispatchGroup:{x:r}})},{inputs:[t],outputs:[]})},Ld=(e,t,r,a,n,i)=>{let u=[n.batchSize,n.numHeads,n.sequenceLength,n.kvSequenceLength+n.pastSequenceLength],l=i.scale===0?1/Math.sqrt(n.headSize):i.scale,o=Ae(t.dataType),c=Xe(n.headSize),f=V("q",t.dataType,t.dims,c),y=V("key",r.dataType,r.dims,c),m=K("output",t.dataType,u),w=n.headSize/c,b=n.sequenceLength,$=n.totalSequenceLength,I=w,x=12,_={x:Math.ceil(n.totalSequenceLength/x),y:Math.ceil(n.sequenceLength/x),z:n.batchSize*n.numHeads},R=[t,r],E=P=>`
  const M: u32 = ${b}u;
  const N: u32 = ${$}u;
  const K: u32 = ${I}u;
  const alpha: ${o} = ${l};
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${a}_${u}`,inputDependencies:c?["rank","type","type","type","type"]:void 0},getShaderSource:_,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:c?[{type:"uint32",data:o},...ne(i)]:[{type:"uint32",data:o}]})}},Kd=e=>Q(e),Ei=(e,t)=>{let{inputs:r,outputCount:a}=e,n=Kd({...t,outputCount:a});if(Te.webgpu.validateInputContent&&jd(r,n),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(qd(r,n))}});var Yd,Zd,Oi,ki=j(()=>{"use strict";ye();be();Yd=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Zd=e=>{let t=e[0].dims,r=e[0].dims[2],a=z.size(t)/4,n=e[0].dataType,i=V("input",n,t,4),u=V("bias",n,[r],4),l=V("residual",n,t,4),o=K("output",n,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)}}),getShaderSource:f=>`
  ...
  }`}},Oi=e=>{Yd(e.inputs),e.compute(Zd(e.inputs))}});var Qd,Ee,Ri,Pi,Bi,Mi,zi,Di,Wi,Vi,Ni,Xd,Ui,Hi,Li,Gi,ln,Fi,dn,ji,qi,Ki,Yi,Zi,Qi,Xi,Ji,es,ts,rs,ns,as,os,is,ss,us,ra=j(()=>{"use strict";ze();ye();ke();be();Qd=(e,t,r,a,n,i)=>{let u=Math.ceil(t/4),l="";typeof n=="string"?l=`${n}(a)`:l=n("a");let o=V("inputData",r,[u],4),c=K("outputData",a,[u],4);return`
  ...
  }`},Ee=(e,t,r,a,n,i=e.dataType)=>({name:t,shaderCache:{hint:n,inputDependencies:["type"]},getShaderSource:u=>Qd(u,z.size(e.dims),e.dataType,i,r,a),getRunData:u=>({outputs:[{dims:e.dims,dataType:i}],dispatchGroup:{x:Math.ceil(z.size(u[0].dims)/64/4)},programUniforms:[{type:"uint32",data:Math.ceil(z.size(e.dims)/4)}]})}),Ri=e=>{e.compute(Ee(e.inputs[0],"Abs","abs"))},Pi=e=>{e.compute(Ee(e.inputs[0],"Acos","acos"))},Bi=e=>{e.compute(Ee(e.inputs[0],"Acosh","acosh"))},Mi=e=>{e.compute(Ee(e.inputs[0],"Asin","asin"))},zi=e=>{e.compute(Ee(e.inputs[0],"Asinh","asinh"))},Di=e=>{e.compute(Ee(e.inputs[0],"Atan","atan"))},Wi=e=>{e.compute(Ee(e.inputs[0],"Atanh","atanh"))},Vi=e=>Q(e),Ni=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(Ee(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},Xd=e=>{let t=e.length>=2?e[1].getFloat32Array()[0]:nn,r=e.length>=3?e[2].getFloat32Array()[0]:an;return Q({min:t,max:r})},Ui=(e,t)=>{let r=e.inputs.length===1?t:Xd(e.inputs),a=Ae(e.inputs[0].dataType);e.compute(Ee(e.inputs[0],"Clip",n=>`clamp(${n}, clip_min_, clip_max_)`,`
    const clip_min_: vec4<${a}> = vec4(${a}(${r.min}));
    const clip_max_: vec4<${a}> = vec4(${a}(${r.max}));
`,r.cacheKey),{inputs:[0]})},Hi=e=>{e.compute(Ee(e.inputs[0],"Ceil","ceil"))},Li=e=>{e.compute(Ee(e.inputs[0],"Cos","cos"))},Gi=e=>{e.compute(Ee(e.inputs[0],"Cosh","cosh"))},ln=e=>Q(e),Fi=(e,t)=>{e.compute(Ee(e.inputs[0],"Elu",r=>`elu_vf32(${r})`,`
...
fn erf_vf32(v: ${e}) -> ${e} {
...
}`,ji=e=>{let t=Ae(e.inputs[0].dataType);e.compute(Ee(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,dn(`vec4<${t}>`,t)))},qi=e=>{e.compute(Ee(e.inputs[0],"Exp","exp"))},Ki=e=>{e.compute(Ee(e.inputs[0],"Floor","floor"))},Yi=e=>{let t=Ae(e.inputs[0].dataType);e.compute(Ee(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,dn(`vec4<${t}>`,t)))},Zi=(e,t)=>{e.compute(Ee(e.inputs[0],"LeakyRelu",r=>`select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<f32>(0.0))`,`const leaky_relu_alpha_: f32 = f32(${t.alpha});`,t.cacheKey))},Qi=e=>{e.compute(Ee(e.inputs[0],"Not",t=>`!${t}`))},Xi=e=>{e.compute(Ee(e.inputs[0],"Neg",t=>`-${t}`))},Ji=e=>{e.compute(Ee(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},es=e=>{e.compute(Ee(e.inputs[0],"Relu",t=>`select(vec4<f32>(0.0), ${t}, ${t} > vec4<f32>(0.0))`))},ts=e=>{e.compute(Ee(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},rs=e=>{e.compute(Ee(e.inputs[0],"Sin","sin"))},ns=e=>{e.compute(Ee(e.inputs[0],"Sinh","sinh"))},as=e=>{e.compute(Ee(e.inputs[0],"Sqrt","sqrt"))},os=e=>{e.compute(Ee(e.inputs[0],"Tan","tan"))},is=e=>{e.compute(Ee(e.inputs[0],"Tanh","tanh"))},ss=(e,t)=>(e.compute(Ee(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<f32>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_: vec4<f32> = vec4<f32>(${t.alpha});`,t.cacheKey)),0),us=e=>{e.compute(Ee(e.inputs[0],"Log","log"))}});var ec,tc,ls,ds=j(()=>{"use strict";ye();be();ra();ec=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},tc=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=V("input",e[0].dataType,e[0].dims,4),a=V("bias",e[0].dataType,[e[0].dims[2]],4),n=K("output",e[0].dataType,t,4),i=z.size(t)/4,u=Ae(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)}}),getShaderSource:o=>`
  ...
  ${o.mainStart()}
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},gs=e=>{yt(e,"Sub",(t,r)=>`${t}-${r}`)},ys=e=>{yt(e,"Greater",{scalar:(t,r)=>`u32(${t}>${r})`,vector:(t,r)=>`vec4<u32>(${t}>${r})`},void 0,void 0,9)},bs=e=>{yt(e,"Less",{scalar:(t,r)=>`u32(${t}<${r})`,vector:(t,r)=>`vec4<u32>(${t}<${r})`},void 0,void 0,9)},ws=e=>{yt(e,"GreaterOrEqual",{scalar:(t,r)=>`u32(${t}>=${r})`,vector:(t,r)=>`vec4<u32>(${t}>=${r})`},void 0,void 0,9)},vs=e=>{yt(e,"LessOrEqual",{scalar:(t,r)=>`u32(${t}<=${r})`,vector:(t,r)=>`vec4<u32>(${t}<=${r})`},void 0,void 0,9)}});var oc,ic,sc,uc,Ss,xs,Is=j(()=>{"use strict";ye();ke();be();oc=e=>{if(!e||e.length<1)throw new Error("too few inputs");let t=e[0].dataType,r=e[0].dims.length;for(let a of e){if(a.dataType!==t)throw new Error("input tensors should be one type");if(a.dims.length!==r)throw new Error("input tensors should have the same shape")}},ic=(e,t)=>`
...
`});var lc,dc,vr,Cs,cc,$r,pc,hn,Sr=j(()=>{"use strict";ye();be();Nt();fn();lc=(e,t)=>e?`
...
`},pc=(e,t,r,a,n,i=!1)=>{let[u,l,o]=n,[c,f,y,m]=a,w=Xn(u,o),b=Xn(l,o),$=Ae(a[0].type.tensor),I=()=>{let R=f.rank,E=c.rank,D=`var aIndices: ${f.type.indices};`;for(let P=R-2-1,W=E-1;P>=0;P--,W--)D+=`
...
bIndices[${R-2}] = u32(row);
    ...
    `},hn=(e,t,r,a,n=!1)=>{let i=e[0].dims,u=e[1].dims,l=i.slice(0,-2),o=u.slice(0,-2),c=a?a.slice(0,-2):r.slice(0,-2),f=Re(c.length),y=f?c.length:c,m=Zo("batchDims",e[0].dataType,y,1),w=z.size(c),b=i[i.length-2],$=i[i.length-1],I=u[u.length-1],x=$%4===0&&I%4===0,_=b<=8?[4,1,1]:[4,4,1],R=[8,8,1],E=[Math.ceil(I/R[0]/_[0]),Math.ceil(b/R[1]/_[1]),Math.ceil(w/R[2]/_[2])],D=Ae(e[0].dataType),P=x?4:1,W=[...l,b,$/P],N=Re(W.length),F=N?W.length:W,te=[...o,$,I/P],B=Re(te.length),q=B?te.length:te,pe=[w,b,I/P],X=V("a",e[0].dataType,F,P),$e=V("b",e[1].dataType,q,P),Y=K("result",e[0].dataType,pe.length,P),Se=[X,$e],Ce=[{type:"int32",data:b},{type:"int32",data:I},{type:"int32",data:$}];f&&Ce.push(...ne(c)),N&&Ce.push(...ne(W)),B&&Ce.push(...ne(te));let _e=[];_e.push(N?"rank":"dims"),_e.push(B?"rank":"dims");let he=e.length>2,{activationFunction:st,applyActivation:Le}=Et(t,Y.type.value),je=pc(P,he,Le,[m,X,$e,Y],[l,o,c],n);if(he){let de=n?P:1;Se.push(V("bias",e[2].dataType,e[2].dims.length,de)),Ce.push(...ne(e[2].dims)),_e.push("rank")}Ce.push(...ne(pe));let G=de=>`
  ...
  ${x?vr(_,R,D,m):$r(_,R,D,m)}
    ...
    return ${Ne(u,c)}(0.0);`,E=`${y(l)}`,D=Ne(o,c),P=e?Ne(u,c):Ne(l,c),W=e?Ne(l,c):Ne(u,c),{activationFunction:N,applyActivation:F}=Et(i,D);return`
    ${N}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${D}) {
    ...
    }`},_s=(e,t,r,a,n,i,u,l)=>{let o=t.format==="NHWC",c=o?e[0].dims[3]:e[0].dims[1],f=r[0],y=o?r[2]:r[3],m=o?r[1]:r[2],w=o?r[3]:r[1],b=o&&(c%4===0||c%3===0)&&w%4===0,$=o?w:y*m,I=o?y*m:w,x=[8,8,1],_=a<=8?[4,1,1]:[4,4,1],R=[Math.ceil($/x[0]/_[0]),Math.ceil(I/x[1]/_[1]),Math.ceil(f/x[2]/_[2])];Pe("verbose",()=>`[conv2d_mm_webgpu] dispatch = ${R}`);let E=b?o&&c%4!==0?3:4:1,D=x[1]*_[1],P=x[0]*_[0],W=Math.max(x[0]*E,x[1]),N=a%D===0,F=n%P===0,te=i%W===0,B=b?[E,4,4]:[1,1,1],q=Ae(e[0].dataType),pe=b?4:1,X=[{type:"int32",data:a},{type:"int32",data:n},{type:"int32",data:i}],$e=V("x",e[0].dataType,e[0].dims.length,E===3?1:E),Y=V("w",e[1].dataType,e[1].dims.length,pe),Se=[$e,Y];X.push(...ne(e[0].dims)),X.push(...ne(e[1].dims));let Ce=`
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${b?`vec4<${q}>`:q}) {
        ...
        ${fc(o,N,F,te,u,t,B[0],B[1],B[2],q)}
            ${b?vr(_,x,q,void 0,!o,W):$r(_,x,q,void 0,!o,W,!1,void 0,l)}`}}});var aa,Es=j(()=>{"use strict";ye();be();ia();Nt();aa=(e,t,r)=>{let a=e.length>2,n=a?"value += b[output_channel];":"",i=e[0].dims,u=e[1].dims,l=u[0]/t.group,o=t.format==="NHWC",c=oa(i,u,t.dilations,t.pads,t.strides,o),f=z.size(c),y=K("output",e[0].dataType,c),{activationFunction:m,applyActivation:w}=Et(t,y.type.value),b=V("x",e[0].dataType,i),$=V("w",e[1].dataType,u),I=[b,$];a&&I.push(V("b",e[2].dataType,e[2].dims));let x=_=>`
  ...
  }`;return{name:"GroupedConv",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:r?r(c):c,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(f/64)}}),getShaderSource:x}}});var oa,Ts,mc,Os,sa,hc,gc,ua,ia=j(()=>{"use strict";ye();ke();As();Sr();Es();Nt();Qt();oa=(e,t,r,a,n,i)=>{let u=e[0],l=e.slice(i?1:2,i?3:4),o=l.length,c=t[0],y=t.slice(2).map((b,$)=>b+(b-1)*(r[$]-1)),w=l.map((b,$)=>b+a[$]+a[$+o]).map((b,$)=>Math.floor((b-y[$]+n[$])/n[$]));return w.splice(0,0,u),w.splice(i?3:1,0,c),w},Ts=[2,3,1,0],mc=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support conv 1D and 2D");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],a=e[1].dims[1]*t.group;if(r!==a)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let n=e[0].dims.length-2;if(t.dilations.length!==n)throw new Error(`dilations should be ${n}D`);if(t.strides.length!==n)throw new Error(`strides should be ${n}D`);if(t.pads.length!==n*2)throw new Error(`pads should be ${n*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},Os=(e,t)=>{let r=e.kernelShape.slice();for(let i=2;i<t[1].dims.length;++i)r[i-2]===0&&(r[i-2]=t[1].dims[i]);let a=e.pads.slice();Vt.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,r,a,e.format==="NHWC",e.autoPad);let n=Object.assign({},e);return Object.assign(n,{kernelShape:r,pads:a,cacheKey:e.cacheKey}),n},sa=e=>{let t=cn(e),r=e.format,a=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],n=e.dilations,i=e.group,u=e.kernel_shape,l=e.pads,o=e.strides,c=e.w_is_const();return Q({autoPad:a,format:r,dilations:n,group:i,kernelShape:u,pads:l,strides:o,wIsConst:c,...t})},hc=(e,t,r)=>{let a=Os(r,t);if(r.group!==1){e.compute(aa(t,a));return}let n=r.format==="NHWC",i=t.length===3,u=t[0].dims[n?1:2],l=t[0].dims[n?2:3],o=t[0].dims[n?3:1],c=t[1].dims[2],f=t[1].dims[3],y=oa(t[0].dims,t[1].dims,r.dilations,a.pads,r.strides,n),m=y[n?1:2],w=y[n?2:3],b=y[n?3:1],$=n&&c===u&&f===l&&r.pads[0]===0&&r.pads[1]===0;if($||c===1&&f===1&&r.dilations[0]===1&&r.dilations[1]===1&&r.strides[0]===1&&r.strides[1]===1&&r.pads[0]===0&&r.pads[1]===0){let P=y[0],W,N,F,te=[];if(n){let B=e.kernelCustomData.wT??e.compute(ot(t[1],Ts),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];if(r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=B),$){let q=u*l*o;W=t[0].reshape([1,P,q]),N=B.reshape([1,q,b]),F=[1,P,b]}else W=t[0].reshape([P,u*l,o]),N=B.reshape([1,o,b]),F=[P,m*w,b];te.push(W),te.push(N)}else W=t[0].reshape([P,o,u*l]),N=t[1].reshape([1,b,o]),F=[P,b,m*w],te.push(N),te.push(W);i&&te.push(t[2]),e.compute(hn(te,a,y,F,n),{inputs:te});return}let I=!0,x=e.kernelCustomData.wT??e.compute(ot(t[1],Ts),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=x);let _=[t[0],x];i&&_.push(t[2]);let R=n?m*w:b,E=n?b:m*w,D=c*f*o;e.compute(_s(_,a,y,R,E,D,i,I),{inputs:_})},gc=(e,t)=>{let r=t.format==="NHWC",a=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&a.push(e.inputs[2]);let n=[0,t.pads[0],0,t.pads[1]],i=[1].concat(t.strides),u=[1].concat(t.dilations),l=[1].concat(t.kernelShape),o=Os({...t,pads:n,strides:i,dilations:u,kernelShape:l},a);e.compute(aa(a,o,c=>r?[c[0],c[2],c[3]]:[]))},ua=(e,t)=>{mc(e.inputs,t),e.inputs[0].dims.length===3?gc(e,t):hc(e,e.inputs,t)}});var yc,ks,Rs=j(()=>{"use strict";At();be();Nt();fn();na();Sr();yc=(e,t=!1,r,a=4)=>{let n=Ne(a,"f32"),i=_=>{switch(_){case 1:return"return w[getIndexFromCoords4D(coord, vec4<i32>(uniforms.w_shape))];";case 4:return`
  ...
  fn mm_write(batch: i32, row : i32, colIn : i32, valueInput : ${n}) {
    ...
    if (row < uniforms.dimAOuter && col < uniforms.dimBOuter) {
      ...
      result[getIndexFromCoords4D(coords, vec4<i32>(uniforms.result_shape))/${a}] = value;
        ...
        ${q}
        ${yc(o,u,t,E)}
        ${b?vr(_,x,"f32",void 0,!o,D):$r(_,x,"f32",void 0,!o,D,!1,void 0,l)}`}}});var bc,la,Ps=j(()=>{"use strict";At();ye();be();bc=(e,t,r,a,n,i,u=!1,l)=>{let o=r.format==="NHWC",c=o?1:2,f=o?2:3,y=o?3:1,m=z.size(a),w=u?2:1,b=r.group,$=t[1].dims,I=$[0]/b,x=$[1],_=`
...
`)};
          ...
          }`};return{name:"Einsum",shaderCache:{hint:a.equation,inputDependencies:e.map(w=>w?"rank":"dims")},getRunData:()=>{let w=y.filter($=>a.symbolToInfo.has($)).map($=>({type:"uint32",data:a.symbolToInfo.get($)?.dimValue||0}));w.push({type:"uint32",data:l});let b=t.filter(($,I)=>e[I]).map(($,I)=>[...ne($)]).reduce(($,I)=>$.concat(I),w);return o&&b.push(...ne(n)),{outputs:[{dims:n,dataType:r}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:b}},getShaderSource:m}},Ls=(e,t)=>{let r=new pa(e.inputs,t.equation),a=e.inputs.map((u,l)=>Re(u.dims.length)),n=r.outputDims,i=e.inputs.map((u,l)=>u.dims);e.compute(Tc(a,i,e.inputs[0].dataType,r,n))},Gs=e=>{let t=e.equation.replace(/\s+/g,"");return Q({equation:t})}});var Oc,js,kc,Rc,qs,Ks=j(()=>{"use strict";ze();ye();be();Oc=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),a=r.length<t.length?0:r.length-t.length,n=t.length<r.length?0:t.length-r.length;for(;a<r.length&&n<t.length;++a,++n)if(r[a]!==t[n]&&r[a]!==1&&t[n]!==1)throw new Error("Expand requires shape to be broadcastable to input")},js=(e,t)=>{let r=e.length-t.length,a=[];for(let n=0;n<r;++n)a.push(e[n]);for(let n=0;n<t.length;++n)a.push(t[n]===1?e[n+r]:t[n]);return a},kc=(e,t)=>e.length>t.length?js(e,t):js(t,e),Rc=e=>{let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),a=kc(t,r),n=e[0].dataType,i=n===9?4:1,u=z.size(a)/i,l=Re(t.length),o=Re(a.length),c=y=>{let m=l?t.length:t,w=o?a.length:a,b=V("input",n,m,i),$=K("output",n,w,i),I;if(n===9){let x=(_,R,E="")=>`
    ...
    ${I}`},f=[{type:"uint32",data:u}];return l&&f.push(...ne(t)),o&&f.push(...ne(a)),{name:"Expand",shaderCache:{hint:`${a.length}`,inputDependencies:[l?"rank":"dims"]},getShaderSource:c,getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:f})}},qs=e=>{Oc(e.inputs),e.compute(Rc(e.inputs),{inputs:[0]})}});var Pc,Bc,Ys,Zs,Qs=j(()=>{"use strict";ze();ye();ke();be();Pc=e=>{if(!e||e.length!==2)throw new Error("Gather requires 2 inputs.")},Bc=(e,t)=>{let r=e[0].dims,a=e[1].dims,n=r.length,i=z.normalizeAxis(t.axis,n),u=r.slice(0);u.splice(i,1,...a);let l=r[i],o=e[0].dataType===9?4:1,c=z.size(u)/o,f=Re(e[0].dims.length),y=f?e[0].dims.length:e[0].dims,m=Re(e[1].dims.length),w=m?e[1].dims.length:e[1].dims,b=Re(u.length),$=b?u.length:u,I=[{type:"uint32",data:c},{type:"int32",data:l},{type:"uint32",data:i}];f&&I.push(...ne(e[0].dims)),m&&I.push(...ne(e[1].dims)),b&&I.push(...ne(u));let x=[];x.push(f?"rank":"dims"),x.push(m?"rank":"dims");let _=R=>{let E=V("data",e[0].dataType,y,o),D=V("inputIndices",e[1].dataType,w),P=K("output",e[0].dataType,$,o),W=F=>{let te=a.length,B=`var indicesIndices${F}  = ${D.type.indices}(0);`;for(let q=0;q<te;q++)B+=`${te>1?`indicesIndices${F}[${q}]`:`indicesIndices${F}`} = ${u.length>1?`outputIndices${F}[uniforms.axis + ${q}]`:`outputIndices${F}`};`;B+=`
      ...
      ${R.mainStart()}
        ${R.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        ${N}
      }`};return{name:"Gather",shaderCache:{hint:t.cacheKey,inputDependencies:x},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:I}),getShaderSource:_}},Ys=e=>Q({axis:e.axis}),Zs=(e,t)=>{let r=e.inputs;Pc(r),e.compute(Bc(e.inputs,t))}});var Mc,zc,Xs,Js,eu=j(()=>{"use strict";ye();ke();be();Mc=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
      ...
      ${w.setByOffset("global_idx","value")};
  }`}},Xs=e=>Q({axis:e.axis}),Js=(e,t)=>{let r=e.inputs;Mc(r),e.compute(zc(e.inputs,t))}});var Dc,Wc,Vc,tu,ru,nu=j(()=>{"use strict";ye();ke();be();Dc=e=>{if(!e)throw new Error("Input is missing");if(e.length<2||e.length>3)throw new Error("Invaid input number.");if(e.length===3&&e[2].dims.length>2)throw new Error("Invalid input shape of C");if(e[0].dataType!==e[1].dataType||e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("Input types are mismatched")},Wc=(e,t,r)=>{if(r.length===0)return"0u";let a=r.length===1&&e!==1||r.length===2&&r[0]!==e,n=r[r.length-1]!==t,i="0u";return a||(i+=`+ m * ${r[r.length-1]}u`),n||(i+="+n"),i},Vc=(e,t)=>{let r=e[0].dims.slice(),a=e[1].dims.slice(),[n,i,u]=rn.getShapeOfGemmResult(r,t.transA,a,t.transB,e.length===3?e[2].dims:void 0),l=[n,i];if(!l)throw new Error("Can't use gemm on the given tensors");let o=z.size(l),c="";t.transA&&t.transB?c="value += a[k * M + m] * b[n * K + k];":t.transA&&!t.transB?c="value += a[k * M + m] * b[k * N + n];":!t.transA&&t.transB?c="value += a[m * K + k] * b[n * K + k];":!t.transA&&!t.transB&&(c="value += a[m * K + k] * b[k * N + n];");let f=Ae(e[0].dataType),y=t.alpha===1?"":"value *= alpha;",m=e.length===3?`value += beta * c[${Wc(n,i,e[2].dims)}];`:"",w=[`@group(0) @binding(0) var<storage, read> a : array<${f}>;`,`@group(0) @binding(1) var<storage, read> b : array<${f}>;`];e.length===3&&w.push(`@group(0) @binding(2) var<storage, read> c : array<${f}>;`);let b=$=>`
  const M: u32 = ${n}u;
  const N: u32 = ${i}u;
  const K: u32 = ${u}u;
...
`)}
  ...
  }`;return{name:"Gemm",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:l,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)}}),getShaderSource:b}},tu=(e,t)=>{Dc(e.inputs),e.compute(Vc(e.inputs,t))},ru=e=>Q(e)});var Nc,Uc,Hc,Lc,au,ou,iu=j(()=>{"use strict";ze();ye();ke();be();Nc={name:"InstanceNormalization"},Uc=(e,t)=>{let r=e[0].dims,a=r,n=2,i=z.sizeToDimension(r,n),u=z.sizeFromDimension(r,n),l=r[1],o=V("x",e[0].dataType,[r[0],r[1],u]),c=V("scale",e[1].dataType,e[1].dims),f=V("bias",e[2].dataType,e[2].dims),y=K("output",e[0].dataType,[r[0],r[1],u]),m=[o,c,f,y],w=o.type.value,b=64,$=I=>`
  ...
  }`;return e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:JSON.stringify({components:o,n,h:i,c:u,epsilon:l})},getRunData:()=>({outputs:[{dims:[n,u,2],dataType:1}],dispatchGroup:{x:Math.ceil(I/64)}}),getShaderSource:E},{inputs:[R,r,a],outputs:[-1]})[0]},Lc=(e,t,r)=>{let a=t[0].dims,n=a,i=a[0],u=a[a.length-1],l=z.sizeFromDimension(a,1)/u,o=Xe(u),c=z.size(n)/o,f=V("input",t[0].dataType,t[0].dims,o),y=K("output",t[0].dataType,n,o),m=Ae(t[0].dataType),w=o===1?"vec2f":`mat2x${o}f`,b=o===1?m:`vec${o}<${m}>`,$=Hc(e,t[0],t[1],t[2],i,l,u,r.epsilon),I=x=>`
  const H: u32 = ${l};
  const C: u32 = ${u/o};
  ...
  }`;e.compute({name:"InstanceNormalization",shaderCache:{hint:`${r.cacheKey}`},getRunData:()=>({outputs:[{dims:n,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)}}),getShaderSource:I},{inputs:[t[0],$]})},au=e=>Q({epsilon:e.epsilon,format:e.format}),ou=(e,t)=>{t.format==="NHWC"?Lc(e,e.inputs,t):e.compute(Uc(e.inputs,t))}});var Gc,Fc,su,uu,lu=j(()=>{"use strict";ze();ye();ke();be();Gc=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},Fc=(e,t,r)=>{let a=e[0].dims,n=e[1],i=e[2],u=a,l=z.normalizeAxis(t.axis,a.length),o=z.sizeToDimension(a,l),c=z.sizeFromDimension(a,l),f=z.size(n.dims),y=i?z.size(i.dims):0;if(f!==c||i&&y!==c)throw new Error(`Size of X.shape()[axis:] == ${c}.
       Size of scale and bias (if provided) must match this.
       Got scale size of ${f} and bias size of ${y}`);let m=[];for(let E=0;E<a.length;++E)E<l?m.push(a[E]):m.push(1);let w=Xe(c),b=Ae(e[0].dataType),$=[V("x",e[0].dataType,e[0].dims,w),V("scale",n.dataType,n.dims,w)];i&&$.push(V("bias",i.dataType,i.dims,w)),$.push(K("output",e[0].dataType,u,w));let I=r>1,x=r>2;I&&$.push(K("meanDataOutput",1,m)),x&&$.push(K("invStdOutput",1,m));let _=E=>`
      ...
      `},Qc=(e,t,r,a)=>{let n=t.length,i="";for(let u=n-1;u>=0;--u)i+=`
          ...
          `},ep=(e,t,r,a,n)=>{switch(a.mode){case 0:return Zc(e,t,r,a.pads,n,a.value);case 1:return Qc(e,t,r,a.pads);case 2:return Xc(e,t,r,a.pads);case 3:return Jc(e,t,r,a.pads);default:throw new Error("Invalid mode")}},tp=(e,t,r,a)=>{let n=t[0].dims,i=z.padShape(n.slice(),r.pads),u=z.size(i),l=z.computeStrides(n),o=K("output",t[0].dataType,i),c=V("x",t[0].dataType,n),f=ep(o,n,l,r,a);return`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},Su=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),xu=(e,t,r,a)=>{let[n,i]=wu(t,a,r),u=V("x",t.dataType,t.dims.length),l=u.type.value,o="value += x_val;",c="";n.countIncludePad?c+=`value /= ${l}(uniforms.kernelSize);`:c+=`value /= ${l}(i32(uniforms.kernelSize) - pad);`;let[f,y,m,w,b]=vu(i,n);f.push(...ne(t.dims)),f.push(...ne(i));let $=["rank"];return{name:e,shaderCache:{hint:a.cacheKey+m+w+b+n.countIncludePad,inputDependencies:$},getRunData:()=>({outputs:[{dims:i,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(z.size(i)/64)},programUniforms:f}),getShaderSource:I=>$u(I,u,t.dims.length,i.length,n,o,c,0,y,m,w,b)}},Iu=e=>{let t=e.count_include_pad!==0,r=Su(e);if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");return Q({countIncludePad:t,...r})},Cu=(e,t)=>{yn(e.inputs),e.compute(xu("AveragePool",e.inputs[0],!1,t))},_u={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[],cacheKey:""},Au=e=>{let t=e.format;return{format:t,..._u,cacheKey:t}},Eu=(e,t)=>{yn(e.inputs),e.compute(xu("GlobalAveragePool",e.inputs[0],!0,t))},Tu=(e,t,r,a)=>{let[n,i]=wu(t,a,r),u=`
      value = max(x_val, value);
    `,l="",o=V("x",t.dataType,t.dims.length),c=["rank"],[f,y,m,w,b]=vu(i,n);return f.push(...ne(t.dims)),f.push(...ne(i)),{name:e,shaderCache:{hint:a.cacheKey+m,inputDependencies:c},getRunData:()=>({outputs:[{dims:i,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(z.size(i)/64)},programUniforms:f}),getShaderSource:$=>$u($,o,t.dims.length,i.length,n,u,l,-1e5,y,m,w,b)}},Ou=(e,t)=>{yn(e.inputs),e.compute(Tu("MaxPool",e.inputs[0],!1,t))},ku=e=>{let t=e.storage_order,r=e.dilations,a=Su(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(a.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");return Q({storageOrder:t,dilations:r,...a})},Ru=e=>{let t=e.format;return{format:t,..._u,cacheKey:t}},Pu=(e,t)=>{yn(e.inputs),e.compute(Tu("GlobalMaxPool",e.inputs[0],!0,t))}});var op,ip,Mu,zu=j(()=>{"use strict";ct();ze();be();op=(e,t,r)=>{let a=e===t,n=e<t&&r<0,i=e>t&&r>0;if(a||n||i)throw new Error("Range these inputs' contents are invalid.")},ip=(e,t,r,a)=>{let n=Math.abs(Math.ceil((t-e)/r)),i=[n],u=n,l=K("output",a,i),o=l.type.storage,c=f=>`
        ${f.declareVariables(l)}
        ${f.mainStart()}
        ${f.guardAgainstOutOfBoundsWorkgroupSizes(u)}
        output[global_idx] = ${o}(${e}) + ${o}(global_idx) * ${o}(${r});
      }`;return{name:"Range",shaderCache:{hint:[e,t,r].map(f=>f.toString()).join("_")},getShaderSource:c,getRunData:()=>({outputs:[{dims:i,dataType:a}],dispatchGroup:{x:Math.ceil(u/64)}})}},Mu=e=>{let t=0,r=0,a=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],a=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],a=e.inputs[2].getFloat32Array()[0]),Te.webgpu.validateInputContent&&op(t,r,a),e.compute(ip(t,r,a,e.inputs[0].dataType),{inputs:[]})}});var sp,up,lp,dp,cp,pp,fp,mp,hp,gp,yp,bp,wp,vp,$p,Du,Wu,Vu=j(()=>{"use strict";ye();ke();be();sp=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for linear mode")}else if(t.mode==="cubic"&&!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for cubic mode")}},up=(e,t,r)=>{t.every(n=>n>=0&&n<r||(()=>{throw new Error("Resize requires axes input values to be positive and less than rank")}));let a=new Array(r).fill(1);return t.forEach((n,i)=>a[n]=e[i]),a},lp=(e,t,r,a,n,i)=>{let[u,l,o]=r>10?[1,2,3]:[-1,e.length>1?1:-1,-1],c=e[0].dims.length;if(u>0&&e.length>u&&e[u].dims.length>0)e[u].getFloat32Array().forEach(f=>i.push(f));else if(t.coordinateTransformMode==="tf_crop_and_resize")throw new Error("Resize requires RoI input to be specified when coordinateTransformMode is tfCropAndResize");if(l>0&&e.length>l&&e[l].dims.length>0){if(e[l].getFloat32Array().forEach(f=>a.push(f)),a.length!==0&&a.length!==c&&r>=18&&a.length!==t.axes.length)throw new Error("Resize requires scales input size to be same as input rank or axes size for opset 18 and up");sp(a,t),t.axes.length>0&&up(a,t.axes,c).forEach((f,y)=>a[y]=f)}if(o>0&&e.length>o&&(e[o].getBigInt64Array().forEach(f=>n.push(Number(f))),n.length!==c||r>=18&&n.length===t.axes.length))throw new Error("Resize requires sizes input size to be same as input rank or axes size for opset 18 and up");if(t.axes.length>0){if(a.length!==t.axes.length)throw new Error('Resize requires "scales" input size to be of axes rank when axes attributes is specified');if(n.length!==t.axes.length)throw new Error('Resize requires "sizes" input size to be of rank axes rank when axes attributes is specified')}if(typeof a<"u"&&typeof n<"u"&&a.length>0&&n.length>c)throw new Error("Resize requires only of scales or sizes to be specified")},dp=(e,t)=>`fn getOriginalCoordinateFromResizedCoordinate(xResized: ${t}, xScale: ${t}, lengthResized: ${t},
...
`);case"half_pixel":return"return ((xResized + 0.5) / xScale) - 0.5;";default:throw new Error(`Coordinate transform mode ${e} is not supported`)}})()+"}",cp=(e,t,r)=>`fn getNearestPixelFromOriginal(xOriginal: ${r}, isDownSample: bool) -> ${r} {`+(()=>{switch(e){case"round_prefer_ceil":return"if (fract(xOriginal) == 0.5) {             return ceil(xOriginal);           } else {             return round(xOriginal);           }";case"floor":return"return floor(xOriginal);";case"ceil":return"return ceil(xOriginal);";case"round_prefer_floor":return"if (fract(xOriginal) == 0.5) {                     return floor(xOriginal);                   } else {                     return round(xOriginal);                   }";case"simple":default:if(t<11)return"if (isDownSample)                     {                       return ceil(xOriginal);                     } else {                       return xOriginal;                     }";throw new Error(`Nearest mode ${e} is not supported`)}})()+"}",pp=(e,t,r)=>{let a=new Array(r).fill(0).concat(new Array(r).fill(1)),n=e.length===0?a:e.slice();return t.length>0?(t.forEach((i,u)=>{a[i]=n[u],a[u+r]=n[t.length+u]}),a):n},fp=(e,t,r,a)=>{let n=[];if(r.length>0)if(a.length>0){if(e.forEach(i=>n.push(i)),Math.max(...a)>e.length)throw new Error("axes is out of bound");a.forEach((i,u)=>n[i]=r[u])}else r.forEach(i=>n.push(i));else{if(t.length===0)throw new Error("Resize requires either scales or sizes.");n=e.map((i,u)=>Math.round(i*t[u]))}return n},mp=(e,t,r)=>{let a=(()=>{switch(r.keepAspectRatioPolicy){case"not_larger":return r.axes.length>0?Math.min(...r.axes.map(i=>t[i]),Number.MAX_VALUE):Math.min(...t,Number.MAX_VALUE);case"not_smaller":return r.axes.length>0?Math.max(...r.axes.map(i=>t[i]),Number.MIN_VALUE):Math.max(...t,Number.MIN_VALUE);default:throw new Error(`Keep aspect ratio policy ${r.keepAspectRatioPolicy} is not supported`)}})();t.fill(1,0,t.length);let n=e.slice();return r.axes.length>0?(r.axes.forEach(i=>t[i]=a),r.axes.forEach(i=>n[i]=Math.round(e[i]*t[i]))):(t.fill(a,0,t.length),n.forEach((i,u)=>n[u]=Math.round(i*t[u]))),n},hp=(e,t,r,a,n)=>`
  ...
  fn bicubicInterpolation(outputIndices: ${t.type.indices}) -> ${m} {
    ...
    `},vp=(e,t,r,a,n,i)=>{let u=e.dims,l=pp(i,t.axes,u.length),o=fp(u,a,n,t.axes),c=a.slice();a.length===0&&(c=u.map((x,_)=>x===0?1:o[_]/x),t.keepAspectRatioPolicy!=="stretch"&&(o=mp(u,c,t)));let f=K("output",e.dataType,o),y=V("input",e.dataType,u),m=z.size(o),w=u.length===o.length&&u.every((x,_)=>x===o[_]),b=t.coordinateTransformMode==="tf_crop_and_resize",$=y.type.value,I=x=>`
      ...
      }`,R=[{dims:u,dataType:e[0].dataType}];return r>1&&R.push({dims:c,dataType:1}),r>2&&R.push({dims:c,dataType:1}),r>3&&R.push({dims:n,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:t.cacheKey},getShaderSource:_,getRunData:()=>({outputs:R,dispatchGroup:{x:Math.ceil(l/o/64)}})}},Nu=(e,t)=>{Sp(e.inputs);let a=[0];e.outputCount>1&&a.push(-3),e.outputCount>2&&a.push(-3),e.outputCount>3&&a.push(3),e.compute(xp(e.inputs,t,e.outputCount,!1),{outputs:a})},Uu=e=>{let t=e.epsilon;return Q({epsilon:t})}});var Ip,bn,Cp,Lu,_p,Ap,Gu,Fu,ju=j(()=>{"use strict";ze();ye();ke();be();Ip=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,a)=>{if(e[a+1].dataType!==6&&e[a+1].dataType!==7)throw new Error(`Input ${a} must be an array of int32 or int64`)})},bn=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(a=>r.push(Number(a)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(a=>r.push(Number(a)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},Cp=(e,t)=>{if(e.length>1){let r=bn(e,1),a=bn(e,2),n=bn(e,3);return n.length===0&&(n=[...Array(e[0].dims.length).keys()]),Q({starts:r,ends:a,axes:n})}else return t},Lu=(e,t,r,a,n)=>{let i=e;return e<0&&(i+=r[a[t]]),n[t]<0?Math.max(0,Math.min(i,r[a[t]]-1)):Math.max(0,Math.min(i,r[a[t]]))},_p=(e,t,r,a)=>`fn calculateInputIndices(outputIndices: ${t.type.indices}) -> ${e.type.indices} {
          var inputIndices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${o.length}_${u.length}_${i.length}`,inputDependencies:["rank"]},getShaderSource:I,getRunData:()=>({outputs:[f],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:$})}},Gu=(e,t)=>{Ip(e.inputs,t);let r=Cp(e.inputs,t);e.compute(Ap(e.inputs,r),{inputs:[0]})},Fu=e=>{let t=e.starts,r=e.ends,a=e.axes;return Q({starts:t,ends:r,axes:a})}});var Ep,Tp,qu,Ku,Yu=j(()=>{"use strict";ye();ke();be();Ep=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},Tp=(e,t)=>{let r=e.dims,a=z.size(r),n=64,i=t.axis;if(i<0&&(i=r.length+i),i<r.length-1)throw new Error("softmax only supports last axis for now.");let u=r[i],l=a/u,o=Xe(u),c=u/o,f=(I,x)=>x===4?`max(max(${I}.x, ${I}.y), max(${I}.z, ${I}.w))`:x===2?`max(${I}.x, ${I}.y)`:x===3?`max(max(${I}.x, ${I}.y), ${I}.z)`:I,y=V("x",e.dataType,e.dims,o),m=K("result",e.dataType,e.dims,o),w=y.type.value,b=Ae(e.dataType)==="f32"?`var threadMax = ${w}(-3.402823e+38f);`:`var threadMax = ${w}(-65504.0h);`,$=I=>`
      ...
      }`;return{name:"Softmax",shaderCache:{hint:`${o}`,inputDependencies:["type"]},getRunData:()=>({outputs:[{dims:r,dataType:e.dataType}],dispatchGroup:{x:l},programUniforms:[{type:"uint32",data:c}]}),getShaderSource:$}},qu=(e,t)=>{Ep(e.inputs),e.compute(Tp(e.inputs[0],t))},Ku=e=>Q({axis:e.axis})});var Op,kp,Rp,Pp,Bp,Zu,Qu,Xu=j(()=>{"use strict";ye();ke();be();Op=e=>{if(!e||e.length<1)throw new Error("too few inputs")},kp=(e,t)=>{let r=[],a=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(n=>r.push(Number(n))),a=r.length),Q({numOutputs:a,axis:t.axis,splitSizes:r})},Rp=e=>`
...
`)}
  ...
  ${I.mainStart()}
  ...
  }`;return{name:"Split",shaderCache:{hint:t.cacheKey},getShaderSource:$,getRunData:()=>({outputs:y,dispatchGroup:{x:Math.ceil(a/64)}})}},Zu=(e,t)=>{Op(e.inputs);let r=e.inputs.length===1?t:kp(e.inputs,t);e.compute(Bp(e.inputs,r),{inputs:[0]})},Qu=e=>{let t=e.axis,r=e.splitSizes,a=e.numOutputs<0?r.length:e.numOutputs;if(a!==r.length)throw new Error("numOutputs and splitSizes lengh must be equal");return Q({axis:t,numOutputs:a,splitSizes:r})}});var Ju,Mp,zp,Dp,el,tl=j(()=>{"use strict";ze();ye();be();Ju=e=>Array.from(e.getBigInt64Array(),Number),Mp=e=>{if(!e||e.length!==2)throw new Error("Tile requires 2 inputs.");if(e[0].dataType!==1&&e[0].dataType!==6&&e[0].dataType!==12)throw new Error("Tile only support float, int32, and uint32 data types");if(e[1].dataType!==7)throw new Error("Tile `repeats` input should be of int64 data type");if(e[1].dims.length!==1)throw new Error("Tile `repeats` input should be 1-D");if(Ju(e[1]).length!==e[0].dims.length)throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor")},zp=(e,t)=>{let r=[];for(let a=0;a<e.length;++a)r.push(e[a]*t[a]);return r},Dp=e=>{let t=e[0].dims,r=Ju(e[1]),a=zp(t,r),n=z.size(a),i=e[0].dataType,u=V("input",i,t),l=K("output",i,a),o=c=>`
    ...
    }`;return{name:"Tile",shaderCache:{hint:`${r}`},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}}),getShaderSource:o}},el=e=>{Mp(e.inputs),e.compute(Dp(e.inputs),{inputs:[0]})}});var Wp,Vp,rl,nl=j(()=>{"use strict";ze();ye();be();Wp=(e,t,r,a,n)=>{let i=z.size(r),u=Math.ceil(i/4),l=K("outputData",n,r,4),o=V("aData",t[1].dataType,t[1].dims,4),c=V("bData",t[2].dataType,t[2].dims,4),f=V("cData",t[0].dataType,t[0].dims,4),y,m=(w,b,$)=>`select(${b}, ${w}, ${$})`;if(!a)y=l.setByOffset("global_idx",m(o.getByOffset("global_idx"),c.getByOffset("global_idx"),f.getByOffset("global_idx")));else{let w=(b,$,I="")=>{let x=`aData[indexA${$}][componentA${$}]`,_=`bData[indexB${$}][componentB${$}]`,R=`bool(cData[indexC${$}] & ${4278190080>>>(3-$)*8}u)`;return`
