...
`)}},Yo=e=>new Ka(e),xr=(e,t)=>{let r=e.length,n=[];for(let i=0;i<r;i++){let u=r-1-i,o=e[u]||1;(t[t.length-1-i]||1)>1&&o===1&&n.unshift(u)}return n}});var ic,Zo,oc,sc,Tt,Xo,Jo,Cr=j(()=>{"use strict";ge();Ee();tt();Ae();ic=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},Zo=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,oc=(e,t)=>N.sortBasedOnPerm(e,Zo(e.length,t)),sc=(e,t,r,n)=>{let i=[];i.push(`fn perm(i: ${n.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`);for(let u=0;u<t;++u)i.push(r.indicesSet("a",e[u],`i[${u}]`));return i.push("return a;}"),i.join(`
`)},Tt=(e,t)=>{let r=e.dataType,n=e.dims.length,i=Zo(n,t),u=oc(e.dims,i),o=Y("output",r,u.length),c=W("a",r,n),p=m=>`
...
var best_index : i32 = 0;`,`if (${n.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${n}_${o}`,inputDependencies:m?["rank","type","type","type","type"]:void 0},getShaderSource:S,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:m?[{type:12,data:p},...L(u)]:[{type:12,data:p}]})}},Mc=e=>Te(e),Cs=(e,t)=>{let{inputs:r,outputCount:n}=e,i=Mc({...t,outputCount:n});if(Pe.webgpu.validateInputContent&&Bc(r,i),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(Dc(r,i))}});var zc,Uc,As,Ts=j(()=>{"use strict";Ee();Ae();zc=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Uc=e=>{let t=e[0].dims,r=e[0].dims[2],n=N.size(t)/4,i=e[0].dataType,u=W("input",i,t,4),o=W("bias",i,[r],4),c=W("residual",i,t,4),p=Y("output",i,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}}),getShaderSource:l=>`
  ...
  }`}},As=e=>{zc(e.inputs),e.compute(Uc(e.inputs))}});var Wc,Be,Es,Os,ks,Ps,Rs,Bs,Ds,Ms,zs,Nc,Us,Ws,Ns,Vs,Qn,Hs,ea,Ls,Gs,Fs,qs,js,Ks,Ys,Zs,Xs,Js,Qs,eu,tu,ru,nu,au,iu,ou,su,ei=j(()=>{"use strict";ge();Ee();tt();Ae();Wc=(e,t,r,n,i,u)=>{let o=Math.ceil(t/4),c="";typeof i=="string"?c=`${i}(a)`:c=i("a");let p=W("inputData",r,[o],4),m=Y("outputData",n,[o],4);return`
  ...
  }`},Be=(e,t,r,n,i,u=e.dataType)=>({name:t,shaderCache:{hint:i,inputDependencies:["type"]},getShaderSource:o=>Wc(o,N.size(e.dims),e.dataType,u,r,n),getRunData:o=>({outputs:[{dims:e.dims,dataType:u}],dispatchGroup:{x:Math.ceil(N.size(o[0].dims)/64/4)},programUniforms:[{type:12,data:Math.ceil(N.size(e.dims)/4)}]})}),Es=e=>{e.compute(Be(e.inputs[0],"Abs","abs"))},Os=e=>{e.compute(Be(e.inputs[0],"Acos","acos"))},ks=e=>{e.compute(Be(e.inputs[0],"Acosh","acosh"))},Ps=e=>{e.compute(Be(e.inputs[0],"Asin","asin"))},Rs=e=>{e.compute(Be(e.inputs[0],"Asinh","asinh"))},Bs=e=>{e.compute(Be(e.inputs[0],"Atan","atan"))},Ds=e=>{e.compute(Be(e.inputs[0],"Atanh","atanh"))},Ms=e=>Te(e),zs=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(Be(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},Nc=e=>{let t=e.length>=2&&e[1].data!==0?e[1].getFloat32Array()[0]:jn,r=e.length>=3&&e[2].data!==0?e[2].getFloat32Array()[0]:Kn;return Te({min:t,max:r})},Us=(e,t)=>{let r=e.inputs.length===1?t:Nc(e.inputs),n=It(e.inputs[0].dataType);e.compute(Be(e.inputs[0],"Clip",i=>`clamp(${i}, clip_min_, clip_max_)`,`
    const clip_min_: vec4<${n}> = vec4(${n}(${r.min}));
    const clip_max_: vec4<${n}> = vec4(${n}(${r.max}));
`,r.cacheKey),{inputs:[0]})},Ws=e=>{e.compute(Be(e.inputs[0],"Ceil","ceil"))},Ns=e=>{e.compute(Be(e.inputs[0],"Cos","cos"))},Vs=e=>{e.compute(Be(e.inputs[0],"Cosh","cosh"))},Qn=e=>Te(e),Hs=(e,t)=>{let r=It(e.inputs[0].dataType);e.compute(Be(e.inputs[0],"Elu",n=>`elu_vf32(${n})`,`
...
fn erf_vf32(v: ${e}) -> ${e} {
...
}`,Ls=e=>{let t=It(e.inputs[0].dataType);e.compute(Be(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,ea(`vec4<${t}>`,t)))},Gs=e=>{e.compute(Be(e.inputs[0],"Exp","exp"))},Fs=e=>{e.compute(Be(e.inputs[0],"Floor","floor"))},qs=e=>{let t=It(e.inputs[0].dataType);e.compute(Be(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,ea(`vec4<${t}>`,t)))},js=(e,t)=>{let r=It(e.inputs[0].dataType);e.compute(Be(e.inputs[0],"LeakyRelu",n=>`select(leaky_relu_alpha_ * ${n}, ${n}, ${n} >= vec4<${r}>(0.0))`,`const leaky_relu_alpha_ = ${r}(${t.alpha});`,t.cacheKey))},Ks=e=>{e.compute(Be(e.inputs[0],"Not",t=>`!${t}`))},Ys=e=>{e.compute(Be(e.inputs[0],"Neg",t=>`-${t}`))},Zs=e=>{e.compute(Be(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},Xs=e=>{let t=It(e.inputs[0].dataType);e.compute(Be(e.inputs[0],"Relu",r=>`select(vec4<${t}>(0.0), ${r}, ${r} > vec4<${t}>(0.0))`))},Js=e=>{e.compute(Be(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},Qs=e=>Te(e),eu=(e,t)=>{let r=It(e.inputs[0].dataType);e.compute(Be(e.inputs[0],"HardSigmoid",n=>`max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${t.alpha} * ${n} + vec4<${r}>(${t.beta})))`,void 0,t.cacheKey))},tu=e=>{e.compute(Be(e.inputs[0],"Sin","sin"))},ru=e=>{e.compute(Be(e.inputs[0],"Sinh","sinh"))},nu=e=>{e.compute(Be(e.inputs[0],"Sqrt","sqrt"))},au=e=>{e.compute(Be(e.inputs[0],"Tan","tan"))},iu=e=>{e.compute(Be(e.inputs[0],"Tanh",t=>`sign(${t}) * (1 - exp(-2 * abs(${t}))) / (1 + exp(-2 * abs(${t})))`))},ou=(e,t)=>{let r=It(e.inputs[0].dataType);return e.compute(Be(e.inputs[0],"ThresholdedRelu",n=>`select(vec4<${r}>(0.0), ${n}, ${n} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${r}>(${t.alpha});`,t.cacheKey)),0},su=e=>{e.compute(Be(e.inputs[0],"Log","log"))}});var Hc,Lc,uu,lu=j(()=>{"use strict";Ee();Ae();ei();Hc=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Lc=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=W("input",e[0].dataType,e[0].dims,4),n=W("bias",e[0].dataType,[e[0].dims[2]],4),i=Y("output",e[0].dataType,t,4),u=N.size(t)/4,o=Ge(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)}}),getShaderSource:p=>`
  ...
  ${p.mainStart()}
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},hu=e=>{Mt(e,"Sub",(t,r)=>`${t}-${r}`)},gu=e=>{Mt(e,"Greater",{scalar:(t,r)=>`u32(${t}>${r})`,vector:(t,r)=>`vec4<u32>(${t}>${r})`},void 0,void 0,9)},yu=e=>{Mt(e,"Less",{scalar:(t,r)=>`u32(${t}<${r})`,vector:(t,r)=>`vec4<u32>(${t}<${r})`},void 0,void 0,9)},bu=e=>{Mt(e,"GreaterOrEqual",{scalar:(t,r)=>`u32(${t}>=${r})`,vector:(t,r)=>`vec4<u32>(${t}>=${r})`},void 0,void 0,9)},vu=e=>{Mt(e,"LessOrEqual",{scalar:(t,r)=>`u32(${t}<=${r})`,vector:(t,r)=>`vec4<u32>(${t}<=${r})`},void 0,void 0,9)}});var jc,Kc,Yc,Zc,$u,_u,Su=j(()=>{"use strict";ge();Ee();tt();Ae();jc=e=>{if(!e||e.length<1)throw new Error("too few inputs");let t=e[0].dataType,r=e[0].dims.length;for(let n of e){if(n.dataType!==t)throw new Error("input tensors should be one type");if(n.dims.length!==r)throw new Error("input tensors should have the same shape")}},Kc=(e,t)=>`
...
`});var Xc,Jc,en,xu,Qc,tn,ep,ia,rn=j(()=>{"use strict";ge();Ee();Ae();Zt();na();Xc=(e,t)=>e?`
        ...
        }`,en=(e,t,r="f32",n,i=!1,u=32,o=!1,c=32)=>{let p=t[1]*e[1],m=t[0]*e[0],l=i?p:u,g=i?u:p,b=l/t[0],$=u/t[1];if(!((i&&b===4&&e[1]===4||!i&&(b===3||b===4))&&l%t[0]===0&&u%t[1]===0&&e[0]===4))throw new Error(`If transposeA ${i} is true, innerElementSize ${b} and workPerThread[1] ${e[1]} must be 4.
...
`}return ae};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${l};${g};${b};${i}`,inputDependencies:v?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil($/64)},programUniforms:S}),getShaderSource:A}},rp=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},Tu=e=>{rp(e.inputs);let t=kt.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let r=t[t.length-1],n=e.inputs[0].dims[e.inputs[0].dims.length-1];r<8&&n<8?e.compute(ii(e.inputs,{activation:""},t)):e.compute(ia(e.inputs,{activation:""},t))}});var ni,Eu,np,Ou,si,ap,ip,ui,ai=j(()=>{"use strict";Ee();Iu();rn();Au();Zt();oi();Cr();ni=(e,t,r,n,i,u)=>{let o=e[0],c=e.slice(u?1:2,u?3:4),p=c.length,m=t[0],g=t.slice(2).map((v,x)=>v+(v-1)*(r[x]-1)),$=c.map((v,x)=>v+n[x]+n[x+p]).map((v,x)=>Math.floor((v-g[x]+i[x])/i[x]));return $.splice(0,0,o),$.splice(u?3:1,0,m),$},Eu=[2,3,1,0],np=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support conv 1D and 2D");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],n=e[1].dims[1]*t.group;if(r!==n)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let i=e[0].dims.length-2;if(t.dilations.length!==i)throw new Error(`dilations should be ${i}D`);if(t.strides.length!==i)throw new Error(`strides should be ${i}D`);if(t.pads.length!==i*2)throw new Error(`pads should be ${i*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},Ou=(e,t)=>{let r=e.kernelShape.slice();for(let u=2;u<t[1].dims.length;++u)r[u-2]===0&&(r[u-2]=t[1].dims[u]);let n=e.pads.slice();lr.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,r,n,e.format==="NHWC",e.autoPad);let i=Object.assign({},e);return Object.assign(i,{kernelShape:r,pads:n}),i},si=e=>{let t=ta(e),r=e.format,n=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],i=e.dilations,u=e.group,o=e.kernel_shape,c=e.pads,p=e.strides,m=e.w_is_const();return{autoPad:n,format:r,dilations:i,group:u,kernelShape:o,pads:c,strides:p,wIsConst:m,...t,cacheKey:`${e.format};${t.activation};`}},ap=(e,t,r)=>{let n=Ou(r,t),i=r.format==="NHWC";if(r.group!==1){e.compute(ri(t,n));return}let u=t.length===3,o=t[0].dims[i?1:2],c=t[0].dims[i?2:3],p=t[0].dims[i?3:1],m=t[1].dims[2],l=t[1].dims[3],g=ni(t[0].dims,t[1].dims,r.dilations,n.pads,r.strides,i),b=g[i?1:2],$=g[i?2:3],v=g[i?3:1],x=i&&m===o&&l===c&&r.pads[0]===0&&r.pads[1]===0;if(x||m===1&&l===1&&r.dilations[0]===1&&r.dilations[1]===1&&r.strides[0]===1&&r.strides[1]===1&&r.pads[0]===0&&r.pads[1]===0){let z=g[0],V,K,ue,P=[];if(i){let We=e.kernelCustomData.wT??e.compute(Tt(t[1],Eu),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];if(r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=We),x){let $e=o*c*p;V=t[0].reshape([1,z,$e]),K=We.reshape([1,$e,v]),ue=[1,z,v]}else V=t[0].reshape([z,o*c,p]),K=We.reshape([1,p,v]),ue=[z,b*$,v];P.push(V),P.push(K)}else V=t[0].reshape([z,p,o*c]),K=t[1].reshape([1,v,p]),ue=[z,v,b*$],P.push(K),P.push(V);u&&P.push(t[2]);let te=ue[2],Me=P[0].dims[P[0].dims.length-1];te<8&&Me<8?e.compute(ii(P,n,g,ue,i),{inputs:P}):e.compute(ia(P,n,g,ue,i),{inputs:P});return}let T=!0,C=e.kernelCustomData.wT??e.compute(Tt(t[1],Eu),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=C);let S=[t[0],C];u&&S.push(t[2]);let A=i?b*$:v,O=i?v:b*$,M=m*l*p;e.compute(Cu(S,n,g,A,O,M,u,T),{inputs:S})},ip=(e,t)=>{let r=t.format==="NHWC",n=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&n.push(e.inputs[2]);let i=[0,t.pads[0],0,t.pads[1]],u=[1].concat(t.strides),o=[1].concat(t.dilations),c=[1].concat(t.kernelShape),p=Ou({...t,pads:i,strides:u,dilations:o,kernelShape:c},n);e.compute(ri(n,p,m=>r?[m[0],m[2],m[3]]:[]))},ui=(e,t)=>{np(e.inputs,t),e.inputs[0].dims.length===3?ip(e,t):ap(e,e.inputs,t)}});var op,ku,Pu=j(()=>{"use strict";ge();Yt();Ae();Zt();na();ti();rn();op=(e,t=!1,r,n=4)=>{let i=Ke(n,"f32"),u=C=>{switch(C){case 1:return"return w[getIndexFromCoords4D(coord, vec4<i32>(uniforms.w_shape))];";case 4:return`
  ...
  fn mm_write(batch: i32, row : i32, colIn : i32, valueInput : ${i}) {
    ...
    if (row < uniforms.dim_a_outer && col < uniforms.dim_b_outer) {
      ...
      result[getIndexFromCoords4D(coords, vec4<i32>(uniforms.result_shape))/${n}] = value;
        ...
        ${xe}
        ${op(p,o,t,O)}
        ${v?en(S,C,"f32",void 0,!p,M):tn(S,C,"f32",void 0,!p,M,!1,void 0,c)}`};return{name:"Conv2DTransposeMatMul",shaderCache:{hint:`${t.cacheKey};${S};${C};${v}`,inputDependencies:te},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:A[0],y:A[1],z:A[2]},programUniforms:P}),getShaderSource:Me}}});var sp,li,Ru=j(()=>{"use strict";ge();Yt();Ee();Ae();sp=(e,t,r,n,i,u=!1,o,c,p=!1)=>{let m=p?1:2,l=p?2:3,g=p?3:1,b=u?2:1,$=`
  ...
  ${u?A:O}}`},li=(e,t,r)=>{let n=e.length>2,i=t.outputShape,u=N.size(i),o=[Math.ceil(u/64),1,1];Ue("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${o}`);let c=t.format==="NHWC",p=["rank","rank"],m=[t.strides[0],t.strides[1]],l=[t.kernelShape[c?1:2],t.kernelShape[c?2:3]],g=[t.dilations[0],t.dilations[1]],b=[l[0]+(t.dilations[0]<=1?0:(t.kernelShape[c?1:2]-1)*(t.dilations[0]-1)),l[1]+(t.dilations[1]<=1?0:(t.kernelShape[c?2:3]-1)*(t.dilations[1]-1))],$=[b[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),b[1]-1-Math.floor(t.pads[1]+t.pads[3])/2],v=!1,x=t.group,T=e[1].dims,C=T[0]/x,S=T[1],A=[{type:6,data:u},{type:12,data:m},{type:12,data:l},{type:12,data:g},{type:12,data:b},{type:6,data:$},{type:12,data:C},{type:12,data:S},...L(e[0].dims),...L(e[1].dims)];n&&(A.push(...L(e[2].dims)),p.push("rank")),A.push(...L(i));let O=o[1]===1&&o[2]===1,M=z=>{let V=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:m.length},{name:"filter_dims",type:"u32",length:l.length},{name:"dilations",type:"u32",length:l.length},{name:"effective_filter_dims",type:"u32",length:b.length},{name:"pads",type:"i32",length:$.length},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],K=Ge(e[0].dataType);return`${sp(z,e,i,n,O,v,K,V,c)}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};`,inputDependencies:p},getRunData:()=>({dispatchGroup:{x:o[0],y:o[1],z:o[2]},outputs:[{dims:r?r(i):i,dataType:e[0].dataType}],programUniforms:A}),getShaderSource:M}}});var up,lp,dp,Bu,Du,cp,pp,fp,mp,Mu,zu=j(()=>{"use strict";Pu();Ru();Zt();Cr();up=(e,t,r,n,i,u)=>(e-1)*t+r+(n-1)*i+1-u,lp=(e,t,r,n,i)=>{let u=Math.floor(e/2);t==="SAME_UPPER"?(r[n]=u,r[i]=e-u):t==="SAME_LOWER"&&(r[n]=e-u,r[i]=u)},dp=(e,t,r,n,i,u,o,c,p,m)=>{let l=e.length-2,g=m.length===0;if(p.length===0)for(let v=0;v<l;++v)p.push(0);let b=e[0],$=t[c?3:1]*i;for(let v=0,x=e.length-l-(c?1:0);v<l;++v,++x){let T=e[x],C=g?T*o[v]:m[v],S=up(T,o[v],u[v],t[x],r[v],C);lp(S,n,u,v,v+l),g&&m.push(o[v]*(T-1)+p[v]+(t[x]-1)*r[v]+1-u[v]-u[v+l])}m.splice(0,0,b),m.splice(c?3:1,0,$)},Bu=(e,t)=>{let r=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((g,b)=>g*b,1)===0){r.length=0;for(let g=2;g<t[1].dims.length;++g)r.push(t[1].dims[g])}let n=e.format==="NHWC";r.splice(0,0,t[1].dims[0]),r.splice(n?3:1,0,t[1].dims[1]);let i=e.pads.slice(),u=e.outputShape.slice(),o=e.outputPadding.slice(),c=t[0].dims,p=e.dilations.slice();if(p.reduce((g,b)=>g+b,0)===0){let g=t[0].dims.length-2;p=new Array(g).fill(1)}let m=e.strides.slice();if(m.reduce((g,b)=>g+b,0)===0){let g=t[0].dims.length-2;m=new Array(g).fill(1)}dp(c,r,p,e.autoPad,e.group,i,m,n,o,u);let l=Object.assign({},e);return Object.assign(l,{kernelShape:r,pads:i,outputPadding:o,outputShape:u,dilations:p,strides:m}),l},Du=e=>{let t=ta(e),r=e.format,n=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],i=e.dilations,u=e.group,o=e.kernelShape,c=e.pads,p=e.strides,m=e.wIsConst(),l=e.outputPadding,g=e.outputShape;return{autoPad:n,format:r,dilations:i,group:u,kernelShape:o,outputPadding:l,outputShape:g,pads:c,strides:p,wIsConst:m,...t,cacheKey:`${e.format};${t.activation};`}},cp=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],n=e[1].dims[0];if(r!==n)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let i=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==i))throw new Error("invalid bias");let u=e[0].dims.length-2;if(t.dilations.reduce((l,g)=>l+g,0)>0&&t.dilations.length!==u)throw new Error(`dilations should be ${u}D`);if(t.strides.reduce((l,g)=>l+g,0)>0&&t.strides.length!==u)throw new Error(`strides should be ${u}D`);if(t.pads.reduce((l,g)=>l+g,0)>0&&t.pads.length!==u*2)throw new Error(`pads should be ${u*2}D`);if(t.outputPadding.length!==u&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${u}D`);if(t.kernelShape.reduce((l,g)=>l+g,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},pp=[2,3,1,0],fp=(e,t,r)=>{let n=Bu(r,t),i=r.format==="NHWC",u=n.outputShape,o=u[i?3:1],c=t[0].dims[i?3:1];if(n.group!==1||o===1&&c===1){e.compute(li(t,n));return}let p=u[i?1:2],m=u[i?2:3],l=t[1].dims[2],g=t[1].dims[3],b=i?p*m:o,$=i?o:p*m,v=l*g*c,x=!0,T=e.kernelCustomData.wT??e.compute(Tt(t[1],pp),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=T);let C=[t[0],T],S=t.length===3;S&&(!i&&t[2].dims.length===1?C.push(t[2].reshape([t[2].dims[0],1,1])):C.push(t[2])),e.compute(ku(C,n,u,b,$,v,S,x),{inputs:C})},mp=(e,t)=>{let r=t.format==="NHWC",n=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];n.length===3&&n.push(e.inputs[2]);let i=t.kernelShape;(i.length===0||i[0]===0)&&(i=[e.inputs[1].dims[2]]);let u=t.dilations;(u.length===0||u[0]===0)&&(u=[1]);let o=t.strides;(o.length===0||o[0]===0)&&(o=[1]);let c=t.pads;c.length===0&&(c=[0,0]),c=[0,c[0],0,c[1]],o=[1].concat(o),u=[1].concat(u),i=[1].concat(i);let p=Bu({...t,pads:c,strides:o,dilations:u,kernelShape:i},n);e.compute(li(n,p,m=>r?[m[0],m[2],m[3]]:[m[0],m[1],m[3]]))},Mu=(e,t)=>{cp(e.inputs,t),e.inputs[0].dims.length===3?mp(e,t):fp(e,e.inputs,t)}});var hp,Uu,Wu,Nu=j(()=>{"use strict";ge();Ee();tt();Ae();hp=(e,t,r,n)=>{let i=N.size(t),u=t.length,o=W("input",e,u),c=Y("output",e,u),p=r.dataType===6?r.getInt32Array()[0]:Number(r.getBigInt64Array()[0]),m=N.normalizeAxis(p,u),l=g=>{let b=` i32(${o.indicesGet("inputIndices","uniforms.axis")}) `,$=pe("uniforms.input_shape","uniforms.axis",u),v=n.reverse?b+(n.exclusive?" + 1":""):"0",x=n.reverse?$:b+(n.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:n.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:[{type:12,data:i},{type:6,data:m},...L(t),...L(t)]}),getShaderSource:l}},Uu=(e,t)=>{let r=e.inputs[0].dims,n=e.inputs[0].dataType,i=e.inputs[1];e.compute(hp(n,r,i,t),{inputs:[0]})},Wu=e=>{let t=e.exclusive===1,r=e.reverse===1;return Te({exclusive:t,reverse:r})}});var di,oa,Vu,gp,yp,ci,pi,Hu,bp,Lu,Gu,Fu=j(()=>{"use strict";ge();Ee();tt();Ae();di="[a-zA-Z]|\\.\\.\\.",oa="("+di+")+",Vu="^"+oa+"$",gp="("+oa+",)*"+oa,yp="^"+gp+"$",ci=class{constructor(t=-1){this.symbolToIndices=new Map,this.inputIndex=t}addSymbol(t,r){let n=this.symbolToIndices.get(t);n===void 0?n=[r]:n.push(r),this.symbolToIndices.set(t,n)}},pi=class{constructor(t,r){this.equation=r;this.hasEllipsis=!1,this.symbolToInfo=new Map,this.lhs=new Array,this.outputDims=[];let[n,i]=r.includes("->")?r.split("->",2):[r,""];if(!n.match(RegExp(yp)))throw new Error("Invalid LHS term");if(n.split(",").forEach((c,p)=>{let m=t[p].dims.slice();if(!c.match(RegExp(Vu)))throw new Error("Invalid LHS term");let l=this.processTerm(c,!0,m,p);this.lhs.push(l)}),i==="")i+=[...this.symbolToInfo.entries()].filter(([c,p])=>p.count===1||c==="...").map(([c])=>c).join("");else if(!i.match(RegExp(oa)))throw new Error("Invalid RHS");i.match(RegExp(di,"g"))?.forEach(c=>{if(c==="...")this.outputDims=this.outputDims.concat(this.ellipsisDims);else{let p=this.symbolToInfo.get(c);if(p===void 0)throw new Error("Invalid RHS symbol");this.outputDims.push(p.dimValue)}}),this.rhs=this.processTerm(i,!1,this.outputDims)}addSymbol(t,r,n){let i=this.symbolToInfo.get(t);if(i!==void 0){if(i.dimValue!==r&&i.count!==1)throw new Error("Dimension mismatch");i.count++,i.inputIndices.push(n)}else i={count:1,dimValue:r,inputIndices:[n]};this.symbolToInfo.set(t,i)}processTerm(t,r,n,i=-1){let u=n.length,o=!1,c=[],p=0;if(!t.match(RegExp(Vu))&&!r&&t!=="")throw new Error("Invalid LHS term");let m=t.match(RegExp(di,"g")),l=new ci(i);return m?.forEach((g,b)=>{if(g==="..."){if(o)throw new Error("Only one ellipsis is allowed per input term");o=!0;let $=u-m.length+1;if($<0)throw new Error("Ellipsis out of bounds");if(c=n.slice(p,p+$),this.hasEllipsis){if(this.ellipsisDims.length!==c.length||this.ellipsisDims.toString()!==c.toString())throw new Error("Ellipsis dimensions mismatch")}else if(r)this.hasEllipsis=!0,this.ellipsisDims=c;else throw new Error("Ellipsis must be specified in the LHS");for(let v=0;v<c.length;v++){let x=String.fromCharCode("0".charCodeAt(0)+v);l.addSymbol(x,b+v),this.addSymbol(x,n[p++],i)}}else l.addSymbol(g,b+(this.hasEllipsis?this.ellipsisDims.length-1:0)),this.addSymbol(g,n[p++],i)}),l}},Hu=e=>e+"_max",bp=(e,t,r,n)=>{let u=e.map(l=>l.length).map((l,g)=>W(`input${g}`,t,l)),o=N.size(n),c=Y("output",t,n.length),p=[...r.symbolToInfo.keys()].filter(l=>!r.rhs.symbolToIndices.has(l)),m=l=>{let g=[],b="var prod = 1.0;",$="var sum = 0.0;",v="sum += prod;",x=[],T=[],C=[],S=[],A=r.symbolToInfo.size===r.rhs.symbolToIndices.size;r.symbolToInfo.forEach((M,z)=>{if(r.rhs.symbolToIndices.has(z)){let V=r.rhs.symbolToIndices.get(z)?.[0];V!==void 0&&r.lhs.forEach((K,ue)=>{if(M.inputIndices.includes(ue)){let P=K.symbolToIndices.get(z);if(P===void 0)throw new Error("Invalid symbol error");P.forEach(te=>{g.push(`${u[ue].indicesSet(`input${ue}Indices`,te,c.indicesGet("outputIndices",V))}`)})}})}else r.lhs.forEach((V,K)=>{if(M.inputIndices.includes(K)){let ue=V.symbolToIndices.get(z);if(ue===void 0)throw new Error("Invalid symbol error");ue.forEach(P=>{x.push(`${u[K].indicesSet(`input${K}Indices`,P,`${z}`)}`)}),S.push(`prod *= ${u[K].getByIndices(`input${K}Indices`)};`)}}),T.push(`for(var ${z}: u32 = 0; ${z} < uniforms.${Hu(z)}; ${z}++) {`),C.push("}")});let O=A?[...g,`let sum = ${u.map((M,z)=>M.getByIndices(`input${z}Indices`)).join(" * ")};`]:[...g,$,...T,...x,b,...S,v,...C];return`
            ${l.registerUniforms(p.map(M=>({name:`${Hu(M)}`,type:"u32"}))).registerUniform("outputSize","u32").declareVariables(...u,c)}
...
`)};
            ${c.setByOffset("global_idx","sum")};
          }`};return{name:"Einsum",shaderCache:{hint:r.equation,inputDependencies:e.map(()=>"rank")},getRunData:()=>{let l=p.filter(b=>r.symbolToInfo.has(b)).map(b=>({type:12,data:r.symbolToInfo.get(b)?.dimValue||0}));l.push({type:12,data:o});let g=e.map((b,$)=>[...L(b)]).reduce((b,$)=>b.concat($),l);return g.push(...L(n)),{outputs:[{dims:n,dataType:t}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:g}},getShaderSource:m}},Lu=(e,t)=>{let r=new pi(e.inputs,t.equation),n=r.outputDims,i=e.inputs.map((u,o)=>u.dims);e.compute(bp(i,e.inputs[0].dataType,r,n))},Gu=e=>{let t=e.equation.replace(/\s+/g,"");return Te({equation:t})}});var vp,qu,wp,$p,ju,Ku=j(()=>{"use strict";ge();Ee();Ae();vp=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),n=r.length<t.length?0:r.length-t.length,i=t.length<r.length?0:t.length-r.length;for(;n<r.length&&i<t.length;++n,++i)if(r[n]!==t[i]&&r[n]!==1&&t[i]!==1)throw new Error("Expand requires shape to be broadcastable to input")},qu=(e,t)=>{let r=e.length-t.length,n=[];for(let i=0;i<r;++i)n.push(e[i]);for(let i=0;i<t.length;++i)n.push(t[i]===1?e[i+r]:t[i]);return n},wp=(e,t)=>e.length>t.length?qu(e,t):qu(t,e),$p=e=>{let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),n=wp(t,r),i=e[0].dataType,u=i===9?4:1,o=Math.ceil(N.size(n)/u),c=m=>{let l=W("input",i,t.length,u),g=Y("output",i,n.length,u),b;if(i===9){let $=(v,x,T="")=>`
    ...
    ${b}`},p=[{type:12,data:o},...L(t),...L(n)];return{name:"Expand",shaderCache:{hint:`${n.length}`,inputDependencies:["rank"]},getShaderSource:c,getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:p})}},ju=e=>{vp(e.inputs),e.compute($p(e.inputs),{inputs:[0]})}});var _p,Sp,Yu,Zu,Xu=j(()=>{"use strict";ge();Ee();tt();Ae();_p=e=>{if(!e||e.length!==2)throw new Error("Gather requires 2 inputs.")},Sp=(e,t)=>{let r=e[0].dims,n=e[1].dims,i=r.length,u=N.normalizeAxis(t.axis,i),o=r.slice(0);o.splice(u,1,...n);let c=r[u],p=e[0].dataType===9?4:1,m=Math.ceil(N.size(o)/p),l=[{type:12,data:m},{type:6,data:c},{type:12,data:u},...L(e[0].dims),...L(e[1].dims),...L(o)],g=b=>{let $=W("data",e[0].dataType,e[0].dims.length,p),v=W("inputIndices",e[1].dataType,e[1].dims.length),x=Y("output",e[0].dataType,o.length,p),T=S=>{let A=n.length,O=`var indicesIndices${S}  = ${v.type.indices}(0);`;for(let M=0;M<A;M++)O+=`${A>1?`indicesIndices${S}[${M}]`:`indicesIndices${S}`} = ${o.length>1?`outputIndices${S}[uniforms.axis + ${M}]`:`outputIndices${S}`};`;O+=`
      ...
      ${b.mainStart()}
        ...
        ${C}
      }`};return{name:"Gather",shaderCache:{hint:t.cacheKey,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:l}),getShaderSource:g}},Yu=e=>Te({axis:e.axis}),Zu=(e,t)=>{let r=e.inputs;_p(r),e.compute(Sp(e.inputs,t))}});var xp,Cp,Ju,Qu,el=j(()=>{"use strict";ge();Ee();tt();Ae();xp=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
  ...
  }`};return{name:"Gemm",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:c,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:m}),getShaderSource:g}},tl=e=>{let t=e.transA,r=e.transB,n=e.alpha,i=e.beta;return{transA:t,transB:r,alpha:n,beta:i,cacheKey:`${e.transA};${e.transB};${e.alpha===1}`}},rl=(e,t)=>{Ip(e.inputs),e.compute(Ap(e.inputs,t))}});var Tp,Ep,Op,al,il=j(()=>{"use strict";ge();Ee();Ae();Tp=(e,t)=>{let r=e[0].dims,n=r,i=2,u=N.sizeToDimension(r,i),o=N.sizeFromDimension(r,i),c=Fe(o),p=o/c,m=[r[0],r[1],p],l=["rank","type","type"],g=[{type:12,data:o},{type:12,data:p}];g.push(...L(m),...L(m));let b=$=>{let v=W("x",e[0].dataType,m.length,c),x=W("scale",e[1].dataType,e[1].dims),T=W("bias",e[2].dataType,e[2].dims),C=Y("output",e[0].dataType,m.length,c),S=[v,x,T,C],A=v.type.value,O=c===1?"f32":`vec${c}<f32>`,M=64,z=[{name:"normSize",type:"u32"},{name:"normPackedSize",type:"u32"}];return`
  ...
  ${$.mainStart(M)}
    ...
    if (localIndex == 0) {
      meanShared = ${ft("workgroupShared[0]",c)} / f32(uniforms.normSize);
    }
    workgroupBarrier();
    ...
    if (localIndex == 0) {
      squaredNormShared = ${ft("workgroupShared[0]",c)};
    }
    workgroupBarrier();
  ...
  ${O.mainStart()}
    ...
    let mean = ${ft("meanVector",$)} / uniforms.norm_size;
    let invStdDev =
        inverseSqrt(${ft("meanSquareVector",$)} / uniforms.norm_size - mean * mean + uniforms.epsilon);
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:c,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:m}),getShaderSource:l},{inputs:[t,r],outputs:[-1]})[0]},fi=(e,t,r,n,i,u,o,c)=>{let p=u;if(o){if(n===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return p=Bp(e,u,o,t,n,r*i,c),p=p.reshape([t,n,r,i]),e.compute(Tt(p,ul.perm),{inputs:[p],outputs:[-1]})[0]}else return u.dims.length===3&&(p=u.reshape([t,n,r,i])),e.compute(Tt(p,ul.perm),{inputs:[p],outputs:[-1]})[0]},dl=(e,t)=>{let r=Rp(e.inputs,t);if(e.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(e.inputs[1]?.dims.length===5)throw new Error("Packed KV is not implemented");let n=e.inputs[1]&&e.inputs[2]&&e.inputs[1].dims.length===4&&e.inputs[2].dims.length===4,i=fi(e,r.batchSize,r.numHeads,r.sequenceLength,r.headSize,e.inputs[0],e.inputs[3],0);if(n)return Jn(e,i,e.inputs[1],e.inputs[2],e.inputs[4],void 0,void 0,void 0,e.inputs[5],r,t);let u=fi(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.headSize,e.inputs[1],e.inputs[3],r.hiddenSize),o=fi(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.vHeadSize,e.inputs[2],e.inputs[3],2*r.hiddenSize);Jn(e,i,u,o,e.inputs[4],void 0,e.inputs[6],e.inputs[7],e.inputs[5],r,t)}});var Dp,Mp,zp,Up,Wp,Np,Vp,Hp,pl,fl=j(()=>{"use strict";ge();Ee();Ae();Dp=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},Mp=(e,t,r)=>{let n="";for(let i=t-1;i>=0;--i)n+=`
      ...
      `},zp=(e,t,r)=>{let n="";for(let i=t-1;i>=0;--i)n+=`
          ...
          `},Np=(e,t,r)=>{switch(r.mode){case 0:return Mp(e,t,r.pads.length);case 1:return zp(e,t,r.pads.length);case 2:return Up(e,t,r.pads.length);case 3:return Wp(e,t,r.pads.length);default:throw new Error("Invalid mode")}},Vp=(e,t)=>{let r=N.padShape(e[0].dims.slice(),t.pads),n=e[0].dims,i=N.size(r),u=[{type:12,data:i},{type:12,data:t.pads}];t.mode===0&&u.push({type:e[0].dataType,data:t.value}),u.push(...L(e[0].dims),...L(r));let o=["rank"],c=p=>{let m=Y("output",e[0].dataType,r.length),l=W("x",e[0].dataType,n.length),g=l.type.value,b=Np(m,n.length,t),$=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&$.push({name:"constant_value",type:g}),`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},yl=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,Lp=e=>`${yl(e)};${e.countIncludePad}`,Gp=e=>`${yl(e)};${e.storageOrder};${e.dilations}`,bl=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),vl=(e,t,r,n)=>{let[i,u]=ml(t,n,r),o=W("x",t.dataType,t.dims.length),c=o.type.value,p="value += x_val;",m="";i.countIncludePad?m+=`value /= ${c}(uniforms.kernelSize);`:m+=`value /= ${c}(i32(uniforms.kernelSize) - pad);`;let[l,g,b,$,v]=hl(u,i);l.push(...L(t.dims),...L(u));let x=["rank"];return{name:e,shaderCache:{hint:`${n.cacheKey};${b};${$};${v}`,inputDependencies:x},getRunData:()=>({outputs:[{dims:u,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(N.size(u)/64)},programUniforms:l}),getShaderSource:T=>gl(T,o,t.dims.length,u.length,i,p,m,0,g,b,$,v)}},wl=e=>{let t=e.count_include_pad!==0,r=bl(e);if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");let n={countIncludePad:t,...r,cacheKey:""};return{...n,cacheKey:Lp(n)}},$l=(e,t)=>{sa(e.inputs),e.compute(vl("AveragePool",e.inputs[0],!1,t))},_l={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},Sl=e=>{let t=e.format;return{format:t,..._l,cacheKey:t}},xl=(e,t)=>{sa(e.inputs),e.compute(vl("GlobalAveragePool",e.inputs[0],!0,t))},Cl=(e,t,r,n)=>{let[i,u]=ml(t,n,r),o=`
      value = max(x_val, value);
    `,c="",p=W("x",t.dataType,t.dims.length),m=["rank"],[l,g,b,$,v]=hl(u,i);return l.push(...L(t.dims),...L(u)),{name:e,shaderCache:{hint:`${n.cacheKey};${b};${$};${v}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:u,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(N.size(u)/64)},programUniforms:l}),getShaderSource:x=>gl(x,p,t.dims.length,u.length,i,o,c,-1e5,g,b,$,v)}},Il=(e,t)=>{sa(e.inputs),e.compute(Cl("MaxPool",e.inputs[0],!1,t))},Al=e=>{let t=e.storage_order,r=e.dilations,n=bl(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(n.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let i={storageOrder:t,dilations:r,...n,cacheKey:""};return{...i,cacheKey:Gp(i)}},Tl=e=>{let t=e.format;return{format:t,..._l,cacheKey:t}},El=(e,t)=>{sa(e.inputs),e.compute(Cl("GlobalMaxPool",e.inputs[0],!0,t))}});var qp,jp,kl,Pl=j(()=>{"use strict";wt();ge();Ae();qp=(e,t,r)=>{let n=e===t,i=e<t&&r<0,u=e>t&&r>0;if(n||i||u)throw new Error("Range these inputs' contents are invalid.")},jp=(e,t,r,n)=>{let i=Math.abs(Math.ceil((t-e)/r)),u=[i],o=i,c=[{type:12,data:o},{type:n,data:e},{type:n,data:r},...L(u)],p=m=>{let l=Y("output",n,u.length),g=l.type.value,b=[{name:"outputSize",type:"u32"},{name:"start",type:g},{name:"delta",type:g}];return`
        ${m.registerUniforms(b).declareVariables(l)}
        ${m.mainStart()}
        ${m.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${g}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${n}`},getShaderSource:p,getRunData:()=>({outputs:[{dims:u,dataType:n}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:c})}},kl=e=>{let t=0,r=0,n=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],n=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],n=e.inputs[2].getFloat32Array()[0]),Pe.webgpu.validateInputContent&&qp(t,r,n),e.compute(jp(t,r,n,e.inputs[0].dataType),{inputs:[]})}});var Kp,Yp,Zp,Xp,Jp,Qp,ef,tf,rf,nf,af,Rl,of,sf,uf,lf,df,Bl,Dl,Ml=j(()=>{"use strict";ge();Ee();tt();Ae();Kp=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`}
      ...
      ${A.mainStart()}
        ...
        let inv_std_dev = inverseSqrt(${ft("squareSum",x)} / f32(uniforms.hidden_size) - mean * mean + uniforms.epsilon);
        ${b?"mean_output[global_idx] = mean;":""}
        ${$?"inv_std_output[global_idx] = inv_std_dev;":""}
        for (var i: u32 = 0; i < hidden_size_vectorized; i++) {
          output[offset + i] = (output[offset + i] - ${z}(mean)) * ${z}(inv_std_dev) * gamma[i] + ${l?"beta[i]":"0.0"};
        }
      }`},S=[{dims:o,dataType:e[0].dataType}];return r>1&&S.push({dims:m,dataType:1}),r>2&&S.push({dims:m,dataType:1}),r>3&&S.push({dims:i,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${x};${b};${$};${v}`,inputDependencies:e.map((A,O)=>"type")},getShaderSource:C,getRunData:()=>({outputs:S,dispatchGroup:{x:Math.ceil(c/p/64)},programUniforms:T})}},zl=(e,t)=>{cf(e.inputs);let n=[0];e.outputCount>1&&n.push(-3),e.outputCount>2&&n.push(-3),e.outputCount>3&&n.push(3),e.compute(pf(e.inputs,t,e.outputCount,!1),{outputs:n})}});var ff,ua,mf,Wl,hf,gf,Nl,Vl,Hl=j(()=>{"use strict";ge();Ee();tt();Ae();ff=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,n)=>{if(e[n+1].dataType!==6&&e[n+1].dataType!==7)throw new Error(`Input ${n} must be an array of int32 or int64`)})},ua=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(n=>r.push(Number(n)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(n=>r.push(Number(n)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},mf=(e,t)=>{if(e.length>1){let r=ua(e,1),n=ua(e,2),i=ua(e,3);return i.length===0&&(i=[...Array(e[0].dims.length).keys()]),Te({starts:r,ends:n,axes:i})}else return t},Wl=(e,t,r,n,i)=>{let u=e;return e<0&&(u+=r[n[t]]),i[t]<0?Math.max(0,Math.min(u,r[n[t]]-1)):Math.max(0,Math.min(u,r[n[t]]))},hf=(e,t,r)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${p.length}_${o.length}_${u.length}`,inputDependencies:["rank"]},getShaderSource:T,getRunData:()=>({outputs:[l],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:x})}},Nl=(e,t)=>{ff(e.inputs,t);let r=mf(e.inputs,t);e.compute(gf(e.inputs,r),{inputs:[0]})},Vl=e=>{let t=e.starts,r=e.ends,n=e.axes;return Te({starts:t,ends:r,axes:n})}});var yf,bf,Ll,Gl,Fl=j(()=>{"use strict";ge();Ee();tt();Ae();yf=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},bf=(e,t)=>{let r=e.dims,n=N.size(r),i=64,u=t.axis;if(u<0&&(u=r.length+u),u<r.length-1)throw new Error("softmax only supports last axis for now.");let o=r[u],c=n/o,p=Fe(o),m=o/p,l=(T,C)=>C===4?`max(max(${T}.x, ${T}.y), max(${T}.z, ${T}.w))`:C===2?`max(${T}.x, ${T}.y)`:C===3?`max(max(${T}.x, ${T}.y), ${T}.z)`:T,g=W("x",e.dataType,e.dims,p),b=Y("result",e.dataType,e.dims,p),$=g.type.value,v=Ge(e.dataType)==="f32"?`var threadMax = ${$}(-3.402823e+38f);`:`var threadMax = ${$}(-65504.0h);`,x=T=>`
      ...
      }`;return{name:"Softmax",shaderCache:{hint:`${p}`,inputDependencies:["type"]},getRunData:()=>({outputs:[{dims:r,dataType:e.dataType}],dispatchGroup:{x:c},programUniforms:[{type:12,data:m}]}),getShaderSource:x}},Ll=(e,t)=>{yf(e.inputs),e.compute(bf(e.inputs[0],t))},Gl=e=>Te({axis:e.axis})});var vf,wf,$f,_f,Sf,ql,jl,Kl=j(()=>{"use strict";ge();Ee();tt();Ae();vf=e=>{if(!e||e.length<1)throw new Error("too few inputs")},wf=(e,t)=>{let r=[],n=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(i=>r.push(Number(i))),n=r.length),Te({numOutputs:n,axis:t.axis,splitSizes:r})},$f=e=>`
...
`)}
  ...
  }`;return{name:"Split",shaderCache:{hint:t.cacheKey,inputDependencies:["rank"]},getShaderSource:$,getRunData:()=>({outputs:m,dispatchGroup:{x:Math.ceil(n/64)},programUniforms:b})}},ql=(e,t)=>{vf(e.inputs);let r=e.inputs.length===1?t:wf(e.inputs,t);e.compute(Sf(e.inputs,r),{inputs:[0]})},jl=e=>{let t=e.axis,r=e.splitSizes,n=e.numOutputs<0?r.length:e.numOutputs;if(n!==r.length)throw new Error("numOutputs and splitSizes lengh must be equal");return Te({axis:t,numOutputs:n,splitSizes:r})}});var Yl,xf,Cf,If,Zl,Xl=j(()=>{"use strict";ge();Ee();Ae();Yl=e=>Array.from(e.getBigInt64Array(),Number),xf=e=>{if(!e||e.length!==2)throw new Error("Tile requires 2 inputs.");if(e[0].dataType!==1&&e[0].dataType!==6&&e[0].dataType!==12)throw new Error("Tile only support float, int32, and uint32 data types");if(e[1].dataType!==7)throw new Error("Tile `repeats` input should be of int64 data type");if(e[1].dims.length!==1)throw new Error("Tile `repeats` input should be 1-D");if(Yl(e[1]).length!==e[0].dims.length)throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor")},Cf=(e,t)=>{let r=[];for(let n=0;n<e.length;++n)r.push(e[n]*t[n]);return r},If=e=>{let t=e[0].dims,r=Yl(e[1]),n=Cf(t,r),i=N.size(n),u=e[0].dataType,o=W("input",u,t.length),c=Y("output",u,n.length),p=m=>`
