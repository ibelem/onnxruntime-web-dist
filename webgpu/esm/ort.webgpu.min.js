  ...
  ${P.mainStart()}
    ...
    ${S?"inv_std_output[global_idx] = inv_std_dev":""};
        ...
        ${Ce.mainStart([a,1,1])}
          ...
          var elements_per_thread: u32 = ${Math.ceil(d/a)};
