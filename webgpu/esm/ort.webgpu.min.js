...
`)}},Zo=e=>new Yn(e),Xn=(e,t)=>{let r=e.length,a=[];for(let n=0;n<r;n++){let s=r-1-n,u=e[s]||1;(t[t.length-1-n]||1)>1&&u===1&&a.unshift(s)}return a},Re=e=>e<=4});var cd,Xo,pd,fd,at,Qo,Jo,Zt=F(()=>{"use strict";be();ke();we();cd=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},Xo=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,pd=(e,t)=>V.sortBasedOnPerm(e,Xo(e.length,t)),fd=(e,t,r,a)=>{let n=[];n.push(`fn perm(i: ${a.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`);for(let s=0;s<t;++s)n.push(r.indicesSet("a",e[s],`i[${s}]`));return n.push("return a;}"),n.join(`
`)},at=(e,t)=>{let r=e.dataType,a=e.dims.length,n=Xo(a,t),s=Re(a),u=pd(e.dims,n),l=s?u.length:u,o=s?a:e.dims,c=q("output",r,l),f=U("a",r,o),y=h=>`
  ...
  ${h.mainStart()}
    ...
    ${c.setByOffset("global_idx",f.getByIndices("aIndices"))}
       ...
       `;return{name:e,shaderCache:t,getShaderSource:$=>`
        ...
        }`,getRunData:()=>({outputs:[{dims:s,dataType:n}],dispatchGroup:{x:o},programUniforms:[{type:"uint32",data:c}]})}},ct=(e,t,r,a)=>{let n=e.inputs.length===1?r:Qn(e.inputs,r),s=n.axes;s.length===0&&!n.noopWithEmptyAxes&&(s=e.inputs[0].dims.map((w,v)=>v));let u=V.normalizeAxes(s,e.inputs[0].dims.length),l=u,o=e.inputs[0],c=Sd(l,e.inputs[0].dims.length);c.length>0&&(o=e.compute(at(e.inputs[0],c),{inputs:[0],outputs:[-1]})[0],l=bd(l.length,o.dims.length));let[f,y]=wd(o.dims,l),h=f;n.keepDims&&(h=vd(f,u)),e.compute(xd(t,{hint:n.cacheKey,inputDependencies:["type"]},[o],a,e.inputs[0].dataType,h,y),{inputs:[o]})},ei=(e,t)=>{ct(e,"ReduceMeanShared",t,"mean")},ti=(e,t)=>{ct(e,"ReduceL1Shared",t,"l1")},ri=(e,t)=>{ct(e,"ReduceL2Shared",t,"l2")},ni=(e,t)=>{ct(e,"ReduceLogSumExpShared",t,"logSumExp")},ai=(e,t)=>{ct(e,"ReduceMaxShared",t,"max")},oi=(e,t)=>{ct(e,"ReduceMinShared",t,"min")},ii=(e,t)=>{ct(e,"ReduceProdShared",t,"prod")},si=(e,t)=>{ct(e,"ReduceSumShared",t,"sum")},ui=(e,t)=>{ct(e,"ReduceSumSquareShared",t,"sumSquare")},li=(e,t)=>{ct(e,"ReduceLogSumShared",t,"logSum")}});var pt,Id,on,Qn,ft,Cd,_d,Ad,Ed,Td,Od,kd,Rd,Pd,Bd,mt,ci,pi,fi,mi,hi,gi,yi,bi,wi,vi,ot,an=F(()=>{"use strict";be();ke();we();di();pt=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},Id=e=>["","",`var value = ${e.getByOffset("inputOffset")};`,""],on=(e,t,r,a,n,s,u=!1,l=!1)=>{let o=[],c=r[0].dims,f=V.normalizeAxes(n,r[0].dims.length),y=!l&&f.length===0;c.forEach((z,W)=>{y||f.indexOf(W)>=0?u&&o.push(1):o.push(z)});let h=[],w=U("_A",r[0].dataType,c),v=q("output",s,o),$=a(w,v,f),C=`inputOffset = ${w.indicesToOffset("inputIndices")};`,_=`let ${C};`,I=`var ${C};`,k=$[1]===""?"":I,A=($[1]===""?_:C)+`
...
var bestIndex : i32 = 0;`,`if (${a.getByOffset("inputOffset")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`}},Ti=e=>{Ld(e.inputs),e.compute(Gd(e.inputs))}});var Fd,Ee,ki,Ri,Pi,Bi,Mi,Di,zi,Wi,Vi,qd,Ni,Ui,Hi,Li,un,Gi,ln,Fi,qi,ji,Ki,Yi,Zi,Xi,Qi,Ji,es,ts,rs,ns,as,os,is,ss,ta=F(()=>{"use strict";We();be();ke();we();Fd=(e,t,r,a,n,s)=>{let u=Math.ceil(t/4),l="";typeof n=="string"?l=`${n}(a)`:l=n("a");let o=U("inputData",r,[u],4),c=q("outputData",a,[u],4);return`
  ...
  }`},Ee=(e,t,r,a,n,s=e.dataType)=>({name:t,shaderCache:{hint:n,inputDependencies:["type"]},getShaderSource:u=>Fd(u,V.size(e.dims),e.dataType,s,r,a),getRunData:u=>({outputs:[{dims:e.dims,dataType:s}],dispatchGroup:{x:Math.ceil(V.size(u[0].dims)/64/4)},programUniforms:[{type:"uint32",data:Math.ceil(V.size(e.dims)/4)}]})}),ki=e=>{e.compute(Ee(e.inputs[0],"Abs","abs"))},Ri=e=>{e.compute(Ee(e.inputs[0],"Acos","acos"))},Pi=e=>{e.compute(Ee(e.inputs[0],"Acosh","acosh"))},Bi=e=>{e.compute(Ee(e.inputs[0],"Asin","asin"))},Mi=e=>{e.compute(Ee(e.inputs[0],"Asinh","asinh"))},Di=e=>{e.compute(Ee(e.inputs[0],"Atan","atan"))},zi=e=>{e.compute(Ee(e.inputs[0],"Atanh","atanh"))},Wi=e=>J(e),Vi=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(Ee(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},qd=e=>{let t=e.length>=2?e[1].getFloat32Array()[0]:rn,r=e.length>=3?e[2].getFloat32Array()[0]:nn;return J({min:t,max:r})},Ni=(e,t)=>{let r=e.inputs.length===1?t:qd(e.inputs),a=Ae(e.inputs[0].dataType);e.compute(Ee(e.inputs[0],"Clip",n=>`clamp(${n}, clip_min_, clip_max_)`,`
    const clip_min_: vec4<${a}> = vec4(${a}(${r.min}));
    const clip_max_: vec4<${a}> = vec4(${a}(${r.max}));
`,r.cacheKey),{inputs:[0]})},Ui=e=>{e.compute(Ee(e.inputs[0],"Ceil","ceil"))},Hi=e=>{e.compute(Ee(e.inputs[0],"Cos","cos"))},Li=e=>{e.compute(Ee(e.inputs[0],"Cosh","cosh"))},un=e=>J(e),Gi=(e,t)=>{e.compute(Ee(e.inputs[0],"Elu",r=>`elu_vf32(${r})`,`
...
fn erf_vf32(v: ${e}) -> ${e} {
...
}`,Fi=e=>{let t=Ae(e.inputs[0].dataType);e.compute(Ee(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,ln(`vec4<${t}>`,t)))},qi=e=>{e.compute(Ee(e.inputs[0],"Exp","exp"))},ji=e=>{e.compute(Ee(e.inputs[0],"Floor","floor"))},Ki=e=>{let t=Ae(e.inputs[0].dataType);e.compute(Ee(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,ln(`vec4<${t}>`,t)))},Yi=(e,t)=>{e.compute(Ee(e.inputs[0],"LeakyRelu",r=>`select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<f32>(0.0))`,`const leaky_relu_alpha_: f32 = f32(${t.alpha});`,t.cacheKey))},Zi=e=>{e.compute(Ee(e.inputs[0],"Not",t=>`!${t}`))},Xi=e=>{e.compute(Ee(e.inputs[0],"Neg",t=>`-${t}`))},Qi=e=>{e.compute(Ee(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},Ji=e=>{e.compute(Ee(e.inputs[0],"Relu",t=>`select(vec4<f32>(0.0), ${t}, ${t} > vec4<f32>(0.0))`))},es=e=>{e.compute(Ee(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},ts=e=>{e.compute(Ee(e.inputs[0],"Sin","sin"))},rs=e=>{e.compute(Ee(e.inputs[0],"Sinh","sinh"))},ns=e=>{e.compute(Ee(e.inputs[0],"Sqrt","sqrt"))},as=e=>{e.compute(Ee(e.inputs[0],"Tan","tan"))},os=e=>{e.compute(Ee(e.inputs[0],"Tanh","tanh"))},is=(e,t)=>(e.compute(Ee(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<f32>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_: vec4<f32> = vec4<f32>(${t.alpha});`,t.cacheKey)),0),ss=e=>{e.compute(Ee(e.inputs[0],"Log","log"))}});var Kd,Yd,us,ls=F(()=>{"use strict";be();we();ta();Kd=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Yd=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=U("input",e[0].dataType,e[0].dims,4),a=U("bias",e[0].dataType,[e[0].dims[2]],4),n=q("output",e[0].dataType,t,4),s=V.size(t)/4,u=Ae(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:o=>`
  ...
  ${o.mainStart()}
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},hs=e=>{ht(e,"Sub",(t,r)=>`${t}-${r}`)},gs=e=>{ht(e,"Greater",{scalar:(t,r)=>`u32(${t}>${r})`,vector:(t,r)=>`vec4<u32>(${t}>${r})`},void 0,void 0,9)},ys=e=>{ht(e,"Less",{scalar:(t,r)=>`u32(${t}<${r})`,vector:(t,r)=>`vec4<u32>(${t}<${r})`},void 0,void 0,9)},bs=e=>{ht(e,"GreaterOrEqual",{scalar:(t,r)=>`u32(${t}>=${r})`,vector:(t,r)=>`vec4<u32>(${t}>=${r})`},void 0,void 0,9)},ws=e=>{ht(e,"LessOrEqual",{scalar:(t,r)=>`u32(${t}<=${r})`,vector:(t,r)=>`vec4<u32>(${t}<=${r})`},void 0,void 0,9)}});var Jd,ec,tc,rc,$s,Ss,xs=F(()=>{"use strict";be();ke();we();Jd=e=>{if(!e||e.length<1)throw new Error("too few inputs");let t=e[0].dataType,r=e[0].dims.length;for(let a of e){if(a.dataType!==t)throw new Error("input tensors should be one type");if(a.dims.length!==r)throw new Error("input tensors should have the same shape")}},ec=(e,t)=>`
...
`});var nc,ac,wr,Is,oc,vr,ic,mn,$r=F(()=>{"use strict";be();we();Vt();pn();nc=(e,t)=>e?`
...
bIndices[${k-2}] = u32(row);
    ...
    `},mn=(e,t,r,a,n=!1)=>{let s=e[0].dims,u=e[1].dims,l=s.slice(0,-2),o=u.slice(0,-2),c=a?a.slice(0,-2):r.slice(0,-2),f=Re(c.length),y=f?c.length:c,h=Yo("batchDims",e[0].dataType,y,1),w=V.size(c),v=s[s.length-2],$=s[s.length-1],C=u[u.length-1],_=$%4===0&&C%4===0,I=v<=8?[4,1,1]:[4,4,1],k=[8,8,1],A=[Math.ceil(C/k[0]/I[0]),Math.ceil(v/k[1]/I[1]),Math.ceil(w/k[2]/I[2])],B=Ae(e[0].dataType),T=_?4:1,z=[...l,v,$/T],W=Re(z.length),K=W?z.length:z,ee=[...o,$,C/T],M=Re(ee.length),Z=M?ee.length:ee,xe=[w,v,C/T],re=U("a",e[0].dataType,K,T),ve=U("b",e[1].dataType,Z,T),j=q("result",e[0].dataType,xe.length,T),$e=[re,ve],Ce=[{type:"int32",data:v},{type:"int32",data:C},{type:"int32",data:$}];f&&Ce.push(...pe(c)),W&&Ce.push(...pe(z)),M&&Ce.push(...pe(ee));let _e=[];_e.push(W?"rank":"dims"),_e.push(M?"rank":"dims");let me=e.length>2,{activationFunction:it,applyActivation:Le}=At(t,j.type.value),qe=ic(T,me,Le,[h,re,ve,j],[l,o,c],n);if(me){let le=n?T:1;$e.push(U("bias",e[2].dataType,e[2].dims.length,le)),Ce.push(...pe(e[2].dims)),_e.push("rank")}Ce.push(...pe(xe));let G=le=>`
  ...
  ${_?wr(I,k,B,h):vr(I,k,B,h)}
    ...
    return ${Ne(u,c)}(0.0);`,A=`${y(l)}`,B=Ne(o,c),T=e?Ne(u,c):Ne(l,c),z=e?Ne(l,c):Ne(u,c),{activationFunction:W,applyActivation:K}=At(s,B);return`
    ${W}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${B}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${v?`vec4<${Z}>`:Z}) {
        ...
        ${sc(o,W,K,ee,u,t,M[0],M[1],M[2],Z)}
            ${v?wr(I,_,Z,void 0,!o,z):vr(I,_,Z,void 0,!o,z,!1,void 0,l)}`}}});var na,As=F(()=>{"use strict";be();we();oa();Vt();na=(e,t,r)=>{let a=e.length>2,n=a?"value += b[output_channel];":"",s=e[0].dims,u=e[1].dims,l=u[0]/t.group,o=t.format==="NHWC",c=aa(s,u,t.dilations,t.pads,t.strides,o),f=V.size(c),y=q("output",e[0].dataType,c),{activationFunction:h,applyActivation:w}=At(t,y.type.value),v=U("x",e[0].dataType,s),$=U("w",e[1].dataType,u),C=[v,$];a&&C.push(U("b",e[2].dataType,e[2].dims));let _=I=>`
  ...
  ${I.mainStart()}
  ...
  }`;return{name:"GroupedConv",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:r?r(c):c,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(f/64)}}),getShaderSource:_}}});var aa,Es,uc,Ts,ia,lc,dc,sa,oa=F(()=>{"use strict";be();ke();_s();$r();As();Vt();Zt();aa=(e,t,r,a,n,s)=>{let u=e[0],l=e.slice(s?1:2,s?3:4),o=l.length,c=t[0],y=t.slice(2).map((v,$)=>v+(v-1)*(r[$]-1)),w=l.map((v,$)=>v+a[$]+a[$+o]).map((v,$)=>Math.floor((v-y[$]+n[$])/n[$]));return w.splice(0,0,u),w.splice(s?3:1,0,c),w},Es=[2,3,1,0],uc=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support conv 1D and 2D");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],a=e[1].dims[1]*t.group;if(r!==a)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let n=e[0].dims.length-2;if(t.dilations.length!==n)throw new Error(`dilations should be ${n}D`);if(t.strides.length!==n)throw new Error(`strides should be ${n}D`);if(t.pads.length!==n*2)throw new Error(`pads should be ${n*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},Ts=(e,t)=>{let r=e.kernelShape.slice();for(let s=2;s<t[1].dims.length;++s)r[s-2]===0&&(r[s-2]=t[1].dims[s]);let a=e.pads.slice();Wt.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,r,a,e.format==="NHWC",e.autoPad);let n=Object.assign({},e);return Object.assign(n,{kernelShape:r,pads:a,cacheKey:e.cacheKey}),n},ia=e=>{let t=dn(e),r=e.format,a=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],n=e.dilations,s=e.group,u=e.kernel_shape,l=e.pads,o=e.strides,c=e.w_is_const();return J({autoPad:a,format:r,dilations:n,group:s,kernelShape:u,pads:l,strides:o,wIsConst:c,...t})},lc=(e,t,r)=>{let a=Ts(r,t);if(r.group!==1){e.compute(na(t,a));return}let n=r.format==="NHWC",s=t.length===3,u=t[0].dims[n?1:2],l=t[0].dims[n?2:3],o=t[0].dims[n?3:1],c=t[1].dims[2],f=t[1].dims[3],y=aa(t[0].dims,t[1].dims,r.dilations,a.pads,r.strides,n),h=y[n?1:2],w=y[n?2:3],v=y[n?3:1],$=n&&c===u&&f===l&&r.pads[0]===0&&r.pads[1]===0;if($||c===1&&f===1&&r.dilations[0]===1&&r.dilations[1]===1&&r.strides[0]===1&&r.strides[1]===1&&r.pads[0]===0&&r.pads[1]===0){let T=y[0],z,W,K,ee=[];if(n){let M=e.kernelCustomData.wT??e.compute(at(t[1],Es),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];if(r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=M),$){let Z=u*l*o;z=t[0].reshape([1,T,Z]),W=M.reshape([1,Z,v]),K=[1,T,v]}else z=t[0].reshape([T,u*l,o]),W=M.reshape([1,o,v]),K=[T,h*w,v];ee.push(z),ee.push(W)}else z=t[0].reshape([T,o,u*l]),W=t[1].reshape([1,v,o]),K=[T,v,h*w],ee.push(W),ee.push(z);s&&ee.push(t[2]),e.compute(mn(ee,a,y,K,n),{inputs:ee});return}let C=!0,_=e.kernelCustomData.wT??e.compute(at(t[1],Es),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=_);let I=[t[0],_];s&&I.push(t[2]);let k=n?h*w:v,A=n?v:h*w,B=c*f*o;e.compute(Cs(I,a,y,k,A,B,s,C),{inputs:I})},dc=(e,t)=>{let r=t.format==="NHWC",a=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&a.push(e.inputs[2]);let n=[0,t.pads[0],0,t.pads[1]],s=[1].concat(t.strides),u=[1].concat(t.dilations),l=[1].concat(t.kernelShape),o=Ts({...t,pads:n,strides:s,dilations:u,kernelShape:l},a);e.compute(na(a,o,c=>r?[c[0],c[2],c[3]]:[]))},sa=(e,t)=>{uc(e.inputs,t),e.inputs[0].dims.length===3?dc(e,t):lc(e,e.inputs,t)}});var cc,Os,ks=F(()=>{"use strict";_t();we();Vt();pn();ra();$r();cc=(e,t=!1,r,a=4)=>{let n=Ne(a,"f32"),s=I=>{switch(I){case 1:return"return w[getIndexFromCoords4D(coord, vec4<i32>(uniforms.w_shape))];";case 4:return`
    ...
    `,o=e?"outBackprop[1]":"outBackprop[2]",c=e?"outBackprop[2]":"outBackprop[3]",f=e?"row":"col",y=e?"col":"row",h=`
      ...
      return ${n}(0.0);
      `,{activationFunction:$,applyActivation:C}=At(r,n);return`
      ${$}
  ...
  fn mm_write(batch: i32, row : i32, colIn : i32, valueInput : ${n}) {
    ...
    if (row < uniforms.dimAOuter && col < uniforms.dimBOuter) {
      ...
      result[getIndexFromCoords4D(coords, vec4<i32>(uniforms.result_shape))/${a}] = value;
        ...
        ${Z}
        ${cc(o,u,t,A)}
        ${v?wr(I,_,"f32",void 0,!o,B):vr(I,_,"f32",void 0,!o,B,!1,void 0,l)}`}}});var pc,ua,Rs=F(()=>{"use strict";_t();be();we();pc=(e,t,r,a,n,s,u=!1,l)=>{let o=r.format==="NHWC",c=o?1:2,f=o?2:3,y=o?3:1,h=V.size(a),w=u?2:1,v=r.group,$=t[1].dims,C=$[0]/v,_=$[1],I=`
...
`)};
      ...
      }`;return{name:"Einsum",shaderCache:{hint:t.equation},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:I}},Ws=(e,t)=>{let r=new ca(e.inputs,t.equation);e.compute(Sc(e.inputs,r))},Vs=e=>{let t=e.equation.replace(/\s+/g,"");return J({equation:t})}});var xc,Us,Ic,Cc,Hs,Ls=F(()=>{"use strict";be();we();xc=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),a=r.length<t.length?0:r.length-t.length,n=t.length<r.length?0:t.length-r.length;for(;a<r.length&&n<t.length;++a,++n)if(r[a]!==t[n]&&r[a]!==1&&t[n]!==1)throw new Error("Expand requires shape to be broadcastable to input")},Us=(e,t)=>{let r=e.length-t.length,a=[];for(let n=0;n<r;++n)a.push(e[n]);for(let n=0;n<t.length;++n)a.push(t[n]===1?e[n+r]:t[n]);return a},Ic=(e,t)=>e.length>t.length?Us(e,t):Us(t,e),Cc=e=>{let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),a=Ic(t,r),n=V.size(a),s=e[0].dataType,u=Re(t.length),l=u?t.length:t,o=U("input",s,l),c=Re(a.length),f=c?a.length:a,y=q("output",s,f),h=v=>`
  ...
  ${v.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
    ...
    ${y.setByOffset("global_idx",o.getByIndices("inputIndices"))}
      ...
      }`;return{name:"Gather",shaderCache:{hint:t.cacheKey,inputDependencies:k},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:I}),getShaderSource:B}},Gs=e=>J({axis:e.axis}),Fs=(e,t)=>{let r=e.inputs;_c(r),e.compute(Ac(e.inputs,t))}});var Ec,Tc,js,Ks,Ys=F(()=>{"use strict";be();ke();we();Ec=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
...
`)}
  ...
  }`;e.compute({name:"InstanceNormalization",shaderCache:{hint:`${r.cacheKey}`},getRunData:()=>({outputs:[{dims:n,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)}}),getShaderSource:C},{inputs:[t[0],$]})},Js=e=>J({epsilon:e.epsilon,format:e.format}),eu=(e,t)=>{t.format==="NHWC"?Dc(e,e.inputs,t):e.compute(Bc(e.inputs,t))}});var zc,Wc,ru,nu,au=F(()=>{"use strict";We();be();ke();we();zc=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},Wc=(e,t,r)=>{let a=e[0].dims,n=e[1],s=e[2],u=a,l=V.normalizeAxis(t.axis,a.length),o=V.sizeToDimension(a,l),c=V.sizeFromDimension(a,l),f=V.size(n.dims),y=s?V.size(s.dims):0;if(f!==c||s&&y!==c)throw new Error(`Size of X.shape()[axis:] == ${c}.
  ...
  ${y.mainStart()}
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[biasOffsetIdx];
      ...
      `},Gc=(e,t,r,a)=>{let n=t.length,s="";for(let u=n-1;u>=0;--u)s+=`
          ...
          `},jc=(e,t,r,a,n)=>{switch(a.mode){case 0:return Lc(e,t,r,a.pads,n,a.value);case 1:return Gc(e,t,r,a.pads);case 2:return Fc(e,t,r,a.pads);case 3:return qc(e,t,r,a.pads);default:throw new Error("Invalid mode")}},Kc=(e,t,r,a)=>{let n=t[0].dims,s=V.padShape(n.slice(),r.pads),u=V.size(s),l=V.computeStrides(n),o=q("output",t[0].dataType,s),c=U("x",t[0].dataType,n),f=jc(o,n,l,r,a);return`
          ...
          }`},Yc=(e,t)=>{let r=V.padShape(e[0].dims.slice(),t.pads);return{name:"Pad",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(V.size(r)/64)}}),getShaderSource:a=>Kc(a,e,t,"f32")}},Zc=(e,t)=>{if(e.length>1){let r=e[1].getBigInt64Array(),a=e.length>=3&&e[2].data?e[2].getFloat32Array()[0]:0,n=e[0].dims.length,s=new Int32Array(2*n).fill(0);if(e.length>=4){let l=e[3].getBigInt64Array();for(let o=0;o<l.length;o++)s[Number(l[o])]=Number(r[o]),s[Number(l[o])+n]=Number(r[o+l.length])}else r.forEach((l,o)=>s[Number(o)]=Number(l));let u=[];return s.forEach(l=>u.push(l)),J({mode:t.mode,value:a,pads:u})}else return t},cu=(e,t)=>{Hc(e.inputs);let r=Zc(e.inputs,t);e.compute(Yc(e.inputs,r),{inputs:[0]})},pu=e=>{let t=e.mode,r=e.value,a=e.pads;return J({mode:t,value:r,pads:a})}});var gn,mu,hu,gu,yu,bu,wu,vu,$u,Su,xu,Iu,Cu,_u,Au,Eu=F(()=>{"use strict";be();ke();we();gn=e=>{if(!e||e.length!==1)throw new Error("Pool ops requires 1 input.");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("Pool ops supports 1-D or 2-D inputs only for now.")},mu=(e,t,r)=>{let a=t.format==="NHWC",n=e.dims.slice();a&&n.splice(1,0,n.pop());let s=Object.hasOwnProperty.call(t,"dilations"),u=t.kernelShape.slice(),l=t.strides.slice(),o=s?t.dilations.slice():[],c=t.pads.slice();Wt.adjustPoolAttributes(r,n,u,l,o,c);let f=Wt.computePoolOutputShape(r,n,l,o,u,c,t.autoPad),y=Object.assign({},t);s?Object.assign(y,{kernelShape:u,strides:l,pads:c,dilations:o,cacheKey:t.cacheKey}):Object.assign(y,{kernelShape:u,strides:l,pads:c,cacheKey:t.cacheKey});let h=f.slice();return h.push(h.splice(1,1)[0]),[y,a?h:f]},hu=(e,t,r,a,n,s,u,l)=>{let o=n.format==="NHWC",c=r,f=t.type.value,y=c.length,h=V.size(a),w=q("output",t.type.tensor,a);if(n.kernelShape.length<=2){let v=n.kernelShape[n.kernelShape.length-1],$=n.strides[n.strides.length-1],C=n.pads[n.pads.length/2-1],_=n.pads[n.pads.length-1],I=y-(o?2:1),k="",A="",B="";if(C+_!==0?k=`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},gu=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),yu=(e,t,r,a)=>{let[n,s]=mu(t,a,r),u=V.size(n.kernelShape),l=U("x",t.dataType,t.dims),o=l.type.value,c="value += x_val;",f="";return n.countIncludePad?f+=`value /= ${o}(${u});`:f+=`value /= ${o}(${u} - pad);`,{name:e,shaderCache:{hint:a.cacheKey},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(V.size(s)/64)}}),getShaderSource:y=>hu(y,l,t.dims,s,n,c,f,"0.0")}},bu=e=>{let t=e.count_include_pad!==0,r=gu(e);if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");return J({countIncludePad:t,...r})},wu=(e,t)=>{gn(e.inputs),e.compute(yu("AveragePool",e.inputs[0],!1,t))},vu={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[],cacheKey:""},$u=e=>{let t=e.format;return{format:t,...vu,cacheKey:t}},Su=(e,t)=>{gn(e.inputs),e.compute(yu("GlobalAveragePool",e.inputs[0],!0,t))},xu=(e,t,r,a)=>{let[n,s]=mu(t,a,r),u=`
      value = max(x_val, value);
    `,l="",o=U("x",t.dataType,t.dims);return{name:e,shaderCache:{hint:a.cacheKey},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(V.size(s)/64)}}),getShaderSource:c=>hu(c,o,t.dims,s,n,u,l,"-1e5")}},Iu=(e,t)=>{gn(e.inputs),e.compute(xu("MaxPool",e.inputs[0],!1,t))},Cu=e=>{let t=e.storage_order,r=e.dilations,a=gu(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(a.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");return J({storageOrder:t,dilations:r,...a})},_u=e=>{let t=e.format;return{format:t,...vu,cacheKey:t}},Au=(e,t)=>{gn(e.inputs),e.compute(xu("GlobalMaxPool",e.inputs[0],!0,t))}});var Qc,Jc,Tu,Ou=F(()=>{"use strict";vt();We();we();Qc=(e,t,r)=>{let a=e===t,n=e<t&&r<0,s=e>t&&r>0;if(a||n||s)throw new Error("Range these inputs' contents are invalid.")},Jc=(e,t,r,a)=>{let n=Math.abs(Math.ceil((t-e)/r)),s=[n],u=n,l=q("output",a,s),o=l.type.storage,c=f=>`
        ${f.declareVariables(l)}
        ${f.mainStart()}
        ${f.guardAgainstOutOfBoundsWorkgroupSizes(u)}
        output[global_idx] = ${o}(${e}) + ${o}(global_idx) * ${o}(${r});
      }`;return{name:"Range",shaderCache:{hint:[e,t,r].map(f=>f.toString()).join("_")},getShaderSource:c,getRunData:()=>({outputs:[{dims:s,dataType:a}],dispatchGroup:{x:Math.ceil(u/64)}})}},Tu=e=>{let t=0,r=0,a=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],a=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],a=e.inputs[2].getFloat32Array()[0]),Te.webgpu.validateInputContent&&Qc(t,r,a),e.compute(Jc(t,r,a,e.inputs[0].dataType),{inputs:[]})}});var ep,tp,rp,np,ap,op,ip,sp,up,lp,dp,cp,pp,fp,mp,ku,Ru,Pu=F(()=>{"use strict";be();ke();we();ep=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for linear mode")}else if(t.mode==="cubic"&&!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for cubic mode")}},tp=(e,t,r)=>{t.every(n=>n>=0&&n<r||(()=>{throw new Error("Resize requires axes input values to be positive and less than rank")}));let a=new Array(r).fill(1);return t.forEach((n,s)=>a[n]=e[s]),a},rp=(e,t,r,a,n,s)=>{let[u,l,o]=r>10?[1,2,3]:[-1,e.length>1?1:-1,-1],c=e[0].dims.length;if(u>0&&e.length>u&&e[u].dims.length>0)e[u].getFloat32Array().forEach(f=>s.push(f));else if(t.coordinateTransformMode==="tf_crop_and_resize")throw new Error("Resize requires RoI input to be specified when coordinateTransformMode is tfCropAndResize");if(l>0&&e.length>l&&e[l].dims.length>0){if(e[l].getFloat32Array().forEach(f=>a.push(f)),a.length!==0&&a.length!==c&&r>=18&&a.length!==t.axes.length)throw new Error("Resize requires scales input size to be same as input rank or axes size for opset 18 and up");ep(a,t),t.axes.length>0&&tp(a,t.axes,c).forEach((f,y)=>a[y]=f)}if(o>0&&e.length>o&&(e[o].getBigInt64Array().forEach(f=>n.push(Number(f))),n.length!==c||r>=18&&n.length===t.axes.length))throw new Error("Resize requires sizes input size to be same as input rank or axes size for opset 18 and up");if(t.axes.length>0){if(a.length!==t.axes.length)throw new Error('Resize requires "scales" input size to be of axes rank when axes attributes is specified');if(n.length!==t.axes.length)throw new Error('Resize requires "sizes" input size to be of rank axes rank when axes attributes is specified')}if(typeof a<"u"&&typeof n<"u"&&a.length>0&&n.length>c)throw new Error("Resize requires only of scales or sizes to be specified")},np=(e,t)=>`fn getOriginalCoordinateFromResizedCoordinate(xResized: ${t}, xScale: ${t}, lengthResized: ${t},
...
`);case"half_pixel":return"return ((xResized + 0.5) / xScale) - 0.5;";default:throw new Error(`Coordinate transform mode ${e} is not supported`)}})()+"}",ap=(e,t,r)=>`fn getNearestPixelFromOriginal(xOriginal: ${r}, isDownSample: bool) -> ${r} {`+(()=>{switch(e){case"round_prefer_ceil":return"if (fract(xOriginal) == 0.5) {             return ceil(xOriginal);           } else {             return round(xOriginal);           }";case"floor":return"return floor(xOriginal);";case"ceil":return"return ceil(xOriginal);";case"round_prefer_floor":return"if (fract(xOriginal) == 0.5) {                     return floor(xOriginal);                   } else {                     return round(xOriginal);                   }";case"simple":default:if(t<11)return"if (isDownSample)                     {                       return ceil(xOriginal);                     } else {                       return xOriginal;                     }";throw new Error(`Nearest mode ${e} is not supported`)}})()+"}",op=(e,t,r)=>{let a=new Array(r).fill(0).concat(new Array(r).fill(1)),n=e.length===0?a:e.slice();return t.length>0?(t.forEach((s,u)=>{a[s]=n[u],a[u+r]=n[t.length+u]}),a):n},ip=(e,t,r,a)=>{let n=[];if(r.length>0)if(a.length>0){if(e.forEach(s=>n.push(s)),Math.max(...a)>e.length)throw new Error("axes is out of bound");a.forEach((s,u)=>n[s]=r[u])}else r.forEach(s=>n.push(s));else{if(t.length===0)throw new Error("Resize requires either scales or sizes.");n=e.map((s,u)=>Math.round(s*t[u]))}return n},sp=(e,t,r)=>{let a=(()=>{switch(r.keepAspectRatioPolicy){case"not_larger":return r.axes.length>0?Math.min(...r.axes.map(s=>t[s]),Number.MAX_VALUE):Math.min(...t,Number.MAX_VALUE);case"not_smaller":return r.axes.length>0?Math.max(...r.axes.map(s=>t[s]),Number.MIN_VALUE):Math.max(...t,Number.MIN_VALUE);default:throw new Error(`Keep aspect ratio policy ${r.keepAspectRatioPolicy} is not supported`)}})();t.fill(1,0,t.length);let n=e.slice();return r.axes.length>0?(r.axes.forEach(s=>t[s]=a),r.axes.forEach(s=>n[s]=Math.round(e[s]*t[s]))):(t.fill(a,0,t.length),n.forEach((s,u)=>n[u]=Math.round(s*t[u]))),n},up=(e,t,r,a,n)=>`
  ...
  fn bicubicInterpolation(outputIndices: ${t.type.indices}) -> ${h} {
    ...
    `},fp=(e,t,r,a,n,s)=>{let u=e.dims,l=op(s,t.axes,u.length),o=ip(u,a,n,t.axes),c=a.slice();a.length===0&&(c=u.map((_,I)=>_===0?1:o[I]/_),t.keepAspectRatioPolicy!=="stretch"&&(o=sp(u,c,t)));let f=q("output",e.dataType,o),y=U("input",e.dataType,u),h=V.size(o),w=u.length===o.length&&u.every((_,I)=>_===o[I]),v=t.coordinateTransformMode==="tf_crop_and_resize",$=y.type.value,C=_=>`
      ...
      }`,k=[{dims:u,dataType:e[0].dataType}];return r>1&&k.push({dims:c,dataType:1}),r>2&&k.push({dims:c,dataType:1}),r>3&&k.push({dims:n,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:t.cacheKey},getShaderSource:I,getRunData:()=>({outputs:k,dispatchGroup:{x:Math.ceil(l/o/64)}})}},Bu=(e,t)=>{hp(e.inputs);let a=[0];e.outputCount>1&&a.push(-3),e.outputCount>2&&a.push(-3),e.outputCount>3&&a.push(3),e.compute(gp(e.inputs,t,e.outputCount,!1),{outputs:a})},Mu=e=>{let t=e.epsilon;return J({epsilon:t})}});var yp,yn,bp,zu,wp,vp,Wu,Vu,Nu=F(()=>{"use strict";We();be();ke();we();yp=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,a)=>{if(e[a+1].dataType!==6&&e[a+1].dataType!==7)throw new Error(`Input ${a} must be an array of int32 or int64`)})},yn=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(a=>r.push(Number(a)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(a=>r.push(Number(a)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},bp=(e,t)=>{if(e.length>1){let r=yn(e,1),a=yn(e,2),n=yn(e,3);return n.length===0&&(n=[...Array(e[0].dims.length).keys()]),J({starts:r,ends:a,axes:n})}else return t},zu=(e,t,r,a,n)=>{let s=e;return e<0&&(s+=r[a[t]]),n[t]<0?Math.max(0,Math.min(s,r[a[t]]-1)):Math.max(0,Math.min(s,r[a[t]]))},wp=(e,t,r,a,n)=>`fn calculateInputIndices(outputIndices: ${t.type.indices}) -> ${e.type.indices} {
          var inputIndices: ${e.type.indices};
          var carry = 0u;
...
`)}
      ...
      }`;return{name:"Slice",shaderCache:{hint:c?`${o.length}_${u.length}_${s.length}`:`${t.cacheKey} | ${e[4]?.dims??""}`,inputDependencies:[c?"rank":"dims"]},getShaderSource:k,getRunData:()=>({outputs:[w],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:_})}},Wu=(e,t)=>{yp(e.inputs,t);let r=bp(e.inputs,t);e.compute(vp(e.inputs,r),{inputs:[0]})},Vu=e=>{let t=e.starts,r=e.ends,a=e.axes;return J({starts:t,ends:r,axes:a})}});var $p,Sp,Uu,Hu,Lu=F(()=>{"use strict";be();ke();we();$p=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},Sp=(e,t)=>{let r=e.dims,a=V.size(r),n=64,s=t.axis;if(s<0&&(s=r.length+s),s<r.length-1)throw new Error("softmax only supports last axis for now.");let u=r[s],l=a/u,o=Ze(u),c=u/o,f=(C,_)=>_===4?`max(max(${C}.x, ${C}.y), max(${C}.z, ${C}.w))`:_===2?`max(${C}.x, ${C}.y)`:_===3?`max(max(${C}.x, ${C}.y), ${C}.z)`:C,y=U("x",e.dataType,e.dims,o),h=q("result",e.dataType,e.dims,o),w=y.type.value,v=Ae(e.dataType)==="f32"?`var threadMax = ${w}(-3.402823e+38f);`:`var threadMax = ${w}(-65504.0h);`,$=C=>`
      ...
      }`;return{name:"Softmax",shaderCache:{hint:`${o}`,inputDependencies:["type"]},getRunData:()=>({outputs:[{dims:r,dataType:e.dataType}],dispatchGroup:{x:l},programUniforms:[{type:"uint32",data:c}]}),getShaderSource:$}},Uu=(e,t)=>{$p(e.inputs),e.compute(Sp(e.inputs[0],t))},Hu=e=>J({axis:e.axis})});var xp,Ip,Cp,_p,Ap,Gu,Fu,qu=F(()=>{"use strict";be();ke();we();xp=e=>{if(!e||e.length<1)throw new Error("too few inputs")},Ip=(e,t)=>{let r=[],a=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(n=>r.push(Number(n))),a=r.length),J({numOutputs:a,axis:t.axis,splitSizes:r})},Cp=e=>`
...
`)}
  ...
  }`;return{name:"Split",shaderCache:{hint:t.cacheKey},getShaderSource:$,getRunData:()=>({outputs:y,dispatchGroup:{x:Math.ceil(a/64)}})}},Gu=(e,t)=>{xp(e.inputs);let r=e.inputs.length===1?t:Ip(e.inputs,t);e.compute(Ap(e.inputs,r),{inputs:[0]})},Fu=e=>{let t=e.axis,r=e.splitSizes,a=e.numOutputs<0?r.length:e.numOutputs;if(a!==r.length)throw new Error("numOutputs and splitSizes lengh must be equal");return J({axis:t,numOutputs:a,splitSizes:r})}});var ju,Ep,Tp,Op,Ku,Yu=F(()=>{"use strict";We();be();we();ju=e=>Array.from(e.getBigInt64Array(),Number),Ep=e=>{if(!e||e.length!==2)throw new Error("Tile requires 2 inputs.");if(e[0].dataType!==1&&e[0].dataType!==6&&e[0].dataType!==12)throw new Error("Tile only support float, int32, and uint32 data types");if(e[1].dataType!==7)throw new Error("Tile `repeats` input should be of int64 data type");if(e[1].dims.length!==1)throw new Error("Tile `repeats` input should be 1-D");if(ju(e[1]).length!==e[0].dims.length)throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor")},Tp=(e,t)=>{let r=[];for(let a=0;a<e.length;++a)r.push(e[a]*t[a]);return r},Op=e=>{let t=e[0].dims,r=ju(e[1]),a=Tp(t,r),n=V.size(a),s=e[0].dataType,u=U("input",s,t),l=q("output",s,a),o=c=>`
